...
export const metadata: Metadata = {
  ...
  description: 'Data protection policy for Thomas Williams, Notary Public, Ealing. Our commitment to protecting your personal information.',
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-8">
              Thomas Williams, operating as a notary public (registered with ICO: ZA499653), commits to the
              following data protection principles when processing personal information in business operations.
            </p>

            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">1. Fairness and Transparency</h2>
            ...
            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">2. Lawful Processing</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">3. Purpose Limitation</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">4. Data Minimisation</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">5. Data Accuracy</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">6. Individual Rights</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">7. Storage Limitation</h2>
            ...
            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">8. Data Security</h2>
            <p className="text-gray-600 mb-4">
              Protection employs three approaches:
            </p>
            <div className="space-y-4 mb-6">
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-[#064e3b] mb-2">Physical Security</h3>
                <p className="text-gray-600 text-sm">
                  Locked offices, secured cabinets, restricted access, confidential disposal
                </p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-[#064e3b] mb-2">Organisational Security</h3>
                <p className="text-gray-600 text-sm">
                  Personnel vetting, non-disclosure agreements, training, email restrictions
                </p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-[#064e3b] mb-2">Technical Security</h3>
                <p className="text-gray-600 text-sm">
            ...
            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">9. Accountability</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#064e3b] mt-10 mb-4">Governance Framework</h2>
