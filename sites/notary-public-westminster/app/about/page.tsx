...
export const metadata: Metadata = {
  title: 'About James Thornton | Notary Public Westminster',
  description: 'Learn about James Thornton, qualified Notary Public and Solicitor based in Westminster, London. Post-graduate Diploma in Notarial Practice.',
};
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Notary Public & Solicitor serving Westminster and surrounding London boroughs
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  I am a Notary Public based in Westminster, Mayfair W1. I hold a Post-graduate
                ...
                <h2 className="text-2xl font-bold text-[#0a1628] mt-10 mb-4">
                  My Approach
                </h2>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-8">
                <h3 className="text-xl font-bold text-[#0a1628] mb-4">Qualifications</h3>
                <ul className="space-y-3">
                  {qualifications.map((qual, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-[#d69e2e] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              ...
              {/* Areas Served */}
              <div className="bg-gradient-to-br from-[#0a1628] to-[#1a365d] rounded-xl p-6 text-white mb-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h3 className="text-xl font-bold text-[#0a1628] mb-4">Get in Touch</h3>
                <div className="space-y-3 text-gray-600">
                  <a href="tel:02076298800" className="flex items-center gap-3 hover:text-[#d69e2e] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                    020 7629 8800
                  </a>
                  <a href="tel:07912345678" className="flex items-center gap-3 hover:text-[#d69e2e] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                    </svg>
                    07912 345678
                  </a>
                  <a href="mailto:james@thorntonnotary.co.uk" className="flex items-center gap-3 hover:text-[#d69e2e] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                    </svg>
                    james@thorntonnotary.co.uk
                  </a>
                </div>
                <Link
                  href="/contact"
                  className="mt-6 block w-full bg-[#d69e2e] hover:bg-[#b7791f] text-white text-center px-6 py-3 rounded-lg font-semibold transition-colors"
                >
                  Contact Me
                </Link>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#0a1628] mb-6">Fees</h2>
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <div className="text-5xl font-bold text-[#d69e2e] mb-2">£80</div>
              ...
              <div className="border-t border-gray-100 pt-6 space-y-4 text-left">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#d69e2e] mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                  </svg>
              ...
              <Link
                href="/quote"
                className="mt-8 inline-block bg-[#0a1628] hover:bg-[#1a365d] text-white px-8 py-4 rounded-lg font-semibold transition-colors"
              >
                Get Instant Quote
              </Link>
            </div>
