...
export default function QuotePage() {
  ...
  if (showQuote) {
    return (
      <>
        {/* Hero */}
        <section className="bg-gradient-to-br from-[#134e4a] to-[#14b8a6] text-white py-16">
        ...
        <section className="py-16">
          <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              {/* Quote Result */}
              <div className="bg-gradient-to-br from-[#134e4a] to-[#14b8a6] p-8 text-white text-center">
              ...
              {/* Quote Breakdown */}
              <div className="p-8">
                <h3 className="font-semibold text-[#134e4a] mb-4">Quote Breakdown</h3>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="border-t pt-3 mt-3 flex justify-between font-semibold">
                    <span>Total</span>
                    <span className="text-[#ef4444]">£{quote}</span>
                  </div>
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  <Link
                    href="/contact"
                    className="flex-1 bg-[#ef4444] hover:bg-[#dc2626] text-white text-center px-6 py-3 rounded-lg font-semibold transition-colors"
                  >
                    Book Appointment
                  </Link>
                  <a
                    href="tel:02076269400"
                    className="flex-1 border-2 border-[#134e4a] text-[#134e4a] hover:bg-[#134e4a] hover:text-white text-center px-6 py-3 rounded-lg font-semibold transition-colors"
                  >
                    Call Now
                  </a>
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="font-semibold text-[#134e4a]">Business</span>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="font-semibold text-[#134e4a]">Individual</span>
                    </div>
                    <p className="text-sm text-gray-600">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <button
                        ...
                        className="w-10 h-10 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-[#ef4444] transition-colors"
                      >
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12h-15" />
                        </svg>
                      </button>
                      <span className="text-3xl font-bold text-[#134e4a] w-12 text-center">
                        {data.documentCount}
                      </span>
                      <button
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-start gap-3 p-4 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-gray-300 transition-colors">
                      <input
                        ...
                        className="mt-1 w-5 h-5 text-[#ef4444] rounded border-gray-300 focus:ring-[#ef4444]"
                      />
                      <div>
                        <span className="font-medium text-[#134e4a]">Apostille</span>
                        <p className="text-sm text-gray-600">
                    ...
                    <label className="flex items-start gap-3 p-4 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-gray-300 transition-colors">
                      ...
                      />
                      <div>
                        <span className="font-medium text-[#134e4a]">Embassy Legalisation</span>
                        <p className="text-sm text-gray-600">
            ...
            {step === 3 && (
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  You can visit our office in City of London, or we can come to you.
                </p>
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="font-semibold text-[#134e4a]">Visit our office</span>
                      <span className="ml-auto text-sm text-green-600 font-medium">No extra charge</span>
                    </div>
                    <p className="text-sm text-gray-600">
                      100 Bishopsgate, City of London, London EC2N 4AG
                    </p>
                  </button>
                  <button
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="font-semibold text-[#134e4a]">Home or office visit</span>
                      <span className="ml-auto text-sm text-[#ef4444] font-medium">+£{PRICING.visitFee}</span>
                    </div>
                    <p className="text-sm text-gray-600">
            ...
            {step === 4 && (
              <div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <span className="font-semibold text-[#134e4a]">Standard</span>
                      <span className="ml-auto text-sm text-green-600 font-medium">No extra charge</span>
                    </div>
                    <p className="text-sm text-gray-600">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <span className="font-semibold text-[#134e4a]">Urgent (Next Day)</span>
                      <span className="ml-auto text-sm text-[#ef4444] font-medium">+£{PRICING.urgentSurcharge}</span>
                    </div>
                    <p className="text-sm text-gray-600">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <span className="font-semibold text-[#134e4a]">Same Day</span>
                      <span className="ml-auto text-sm text-[#ef4444] font-medium">+£{PRICING.sameDaySurcharge}</span>
                    </div>
                    <p className="text-sm text-gray-600">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ef4444] focus:border-transparent outline-none transition-shadow"
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-[#ef4444]">£{quote}</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="mt-8 flex justify-between">
              {step > 1 ? (
                <button
                  onClick={prevStep}
                  className="px-6 py-3 text-gray-600 hover:text-[#134e4a] font-medium transition-colors"
                >
                  ← Back
                </button>
              ) : (
