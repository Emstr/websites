...
export const metadata: Metadata = {
  title: 'Business Services | Financial Adviser City of London',
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#134e4a]">Corporate Documentation</h2>
              </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#134e4a]">Commercial & Financial</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#134e4a]">Legal Declarations</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#134e4a]">Intellectual Property</h2>
              </div>
              <ul className="space-y-4">
      ...
      <section id="apostille" className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-[#ef4444] rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
