...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#134e4a] to-[#14b8a6] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Financial Adviser Services in City of London
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/quote"
                className="bg-[#ef4444] hover:bg-[#dc2626] px-8 py-4 rounded-lg text-lg font-semibold transition-colors text-center"
              >
                Instant Quote
              </Link>
              <Link
      ...
      {/* Pricing Banner */}
      <section className="bg-[#ef4444] text-white py-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                ...
                <span className="text-[#ef4444] font-medium inline-flex items-center gap-2">
                  Learn more
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-[#ef4444] font-semibold hover:gap-3 transition-all"
              >
            ...
            <div className="bg-gradient-to-br from-[#134e4a] to-[#14b8a6] rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-semibold mb-6">Areas Served</h3>
              <p className="text-gray-300 mb-6">
                I provide financial adviser services across City of London and surrounding London boroughs:
              </p>
