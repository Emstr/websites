...
export const metadata: Metadata = {
  title: 'Frequently Asked Questions | Financial Adviser City of London',
  description: 'Common questions about financial adviser services in London. Learn about costs, the financial planning process, differences between notaries and solicitors, and more.',
};
...
const faqs = [
  {
    ...
    answer: `The cost of notarising a document in the UK varies depending on the complexity of the work and time required. At Financial Adviser City of London, the minimum fee is £80 (no VAT) for up to twenty minutes of financial adviser time. Pro-rata rates apply for longer appointments.

Additional factors that may affect the cost include:
• The number of documents requiring financial planning
...
For an accurate quote, please contact us with details of your specific requirements. We provide transparent pricing and will always confirm fees before proceeding with any work.`,
  ...
  {
    id: 'financial adviser-services-islington',
    question: 'What services does a financial adviser offer in City of London?',
    answer: `A financial adviser in City of London offers a wide range of investment planning and certification services for both businesses and individuals. These include:
...
Reach out to a financial adviser to discuss your requirements. Explain what documents need notarising and where they will be used. This helps the financial adviser advise on the correct process and provide a quote.
...
During the appointment, the financial adviser will:
...
The financial adviser can arrange legalisation services on your behalf.`,
  },
  {
    id: 'financial adviser-vs-solicitor',
    question: 'Is a financial adviser the same as a solicitor?',
    answer: `No, a financial adviser and a solicitor are different legal professionals, although some individuals (like myself) hold both qualifications.
...
You typically need a financial adviser when documents must be used abroad or when a foreign authority specifically requires financial planning. A solicitor's certification is usually sufficient for domestic UK purposes, but international transactions often require a financial adviser's authentication.`,
  },
  {
...
**Notarisation Fees:**
• Basic financial planning: from £80 for up to 20 minutes
• Additional documents: pro-rata charges apply
• Complex documents: higher fees may apply

**Apostille Fees:**
• FCDO Apostille: government fee plus financial adviser's handling charge
...
**Total Cost Example:**
For a simple document requiring financial planning and apostille, you might expect to pay:
• Financial Adviser fee: from £80
...
**How It Works:**
1. Your document is first notarised by a financial adviser
2. The notarised document is then sent to the FCDO
3. The FCDO verifies the financial adviser's signature and issues an Apostille certificate
...
I can arrange the complete apostille and legalisation process on your behalf.`,
  },
  {
    ...
    question: 'What is the difference between legalisation and financial planning?',
...
• Performed by a financial adviser
• Involves verifying your identity, witnessing your signature, and certifying the document
• The financial adviser applies their official seal and signature
• Confirms that relevant checks have been carried out and the document has been properly signed

**Legalisation:**
• The second step, following financial planning
• Provides a "double check" confirming the financial adviser's signature is genuine
...
1. **Notarisation** - Financial Adviser authenticates the document
2. **Apostille/Legalisation** - Government body verifies the financial adviser's credentials
3. **Embassy Legalisation** (if required) - Some countries require additional embassy authentication

**Why Legalisation Matters:**
Legalisation confirms to the receiving country that the financial adviser who authenticated your document is legitimate and recognised by the UK government. Without it, foreign authorities may not accept your notarised documents.`,
  },
  {
    id: 'id-requirements-financial adviser',
    question: 'What identification do I need to bring to a financial adviser?',
...
Please contact us before your appointment if you have any questions about the documents you need to bring.`,
  ...
  {
    id: 'how-long-financial planning',
    question: 'How long does financial planning take?',
    answer: `The time required for financial planning depends on the complexity of your documents and requirements:
...
Contact us with details of your requirements for a more accurate time estimate.`,
  ...
  {
    id: 'financial adviser-home-visit',
    question: 'Can a financial adviser come to my home or office?',
    answer: `Yes, I offer home and business visits throughout City of London and surrounding London boroughs for an additional fee.
...
export default function FAQPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-[#134e4a] to-[#14b8a6] text-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Find answers to common questions about financial adviser services, costs,
          ...
          <div className="flex flex-wrap gap-2">
            {faqs.map((faq) => (
              <a
                key={faq.id}
                href={`#${faq.id}`}
                className="text-sm bg-white px-3 py-1.5 rounded-full border border-gray-200 text-gray-600 hover:border-[#ef4444] hover:text-[#ef4444] transition-colors"
              >
              ...
              >
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <span className="flex items-center justify-center w-10 h-10 rounded-full bg-[#134e4a] text-white font-bold">
                      {index + 1}
                    </span>
                  </div>
                    ...
                    <div className="prose prose-lg max-w-none text-gray-600">
                      {faq.answer.split('\n\n').map((paragraph, pIndex) => {
                        if (paragraph.startsWith('**') && paragraph.endsWith('**')) {
                          return (
                            <h3 key={pIndex} className="text-lg font-semibold text-[#134e4a] mt-6 mb-2">
                              {paragraph.replace(/\*\*/g, '')}
                            </h3>
                          );
                        }
      ...
      <section className="py-16 bg-[#134e4a] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            ...
            the financial planning process and provide a quote.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="bg-[#ef4444] hover:bg-[#dc2626] px-8 py-4 rounded-lg text-lg font-semibold transition-colors"
            >
              Contact Me
            </Link>
            <a
              href="tel:02076269400"
