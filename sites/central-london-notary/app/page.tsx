...
export default function Home() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-[#1e1b4b] to-[#312e81] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <div className="inline-block bg-[#fbbf24] text-[#1e1b4b] px-4 py-2 rounded-full text-sm font-semibold mb-6">
              Multilingual Services: Russian • Mandarin • Portuguese
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/quote"
                className="bg-[#fbbf24] hover:bg-[#f59e0b] text-[#1e1b4b] px-8 py-4 rounded-lg text-lg font-semibold transition-colors text-center"
              >
                Instant Quote
              </Link>
              <Link
      ...
      {/* Pricing Banner */}
      <section className="bg-[#fbbf24] text-[#1e1b4b] py-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-[#1e1b4b] mb-6">
                About Notary Public Central London
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Located in the heart of Holborn, we provide professional notary public services
                to businesses and individuals across Central London. Our prime location between
                the West End and the City makes us easily accessible.
              </p>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-[#1e1b4b] to-[#312e81] rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 mb-6">
                We serve clients throughout Central London, with our office conveniently located in Holborn:
              </p>
