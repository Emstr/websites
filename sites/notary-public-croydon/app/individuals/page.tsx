...
export const metadata: Metadata = {
  title: 'Individual Services | Notary Public Croydon',
...
export default function IndividualsPage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1f2937]">Document Certification</h2>
              </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1f2937]">Legal Documentation</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1f2937]">Family & Travel</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1f2937]">International & Administrative</h2>
              </div>
              <ul className="space-y-4">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-[#1f2937] to-[#374151] rounded-2xl p-8 lg:p-12 text-white">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex flex-col gap-4">
                <Link
                  href="/quote"
                  className="bg-[#06b6d4] hover:bg-[#0891b2] px-8 py-4 rounded-lg text-lg font-semibold transition-colors text-center"
                >
                  Get Instant Quote
                </Link>
                <a
                  href="tel:02086865500"
                  className="border-2 border-white hover:bg-white hover:text-[#1f2937] px-8 py-4 rounded-lg text-lg font-semibold transition-colors text-center"
                >
                  Call: 020 8686 5500
                </a>
              </div>
