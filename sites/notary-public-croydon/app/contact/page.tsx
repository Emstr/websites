...
export const metadata: Metadata = {
  title: 'Contact | Notary Public Croydon',
  description: 'Contact Olivia Brown, Notary Public in Croydon, London. Book an appointment or request a quote for notarial services.',
};
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl font-bold text-[#1f2937] mb-6">Send a Message</h2>
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    id="serviceType"
                    name="serviceType"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#06b6d4] focus:border-transparent outline-none transition-shadow bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#06b6d4] focus:border-transparent outline-none transition-shadow resize-none"
                  ></textarea>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#1f2937] mb-2">Phone</h3>
                      <div className="space-y-1">
                        <a href="tel:02086865500" className="block text-gray-600 hover:text-[#06b6d4] transition-colors">
                          020 8686 5500
                        </a>
                        <a href="tel:07945678901" className="block text-gray-600 hover:text-[#06b6d4] transition-colors">
                          07945 678901
                        </a>
                        <a href="tel:02078338828" className="block text-gray-600 hover:text-[#06b6d4] transition-colors">
                          020 8686 5501
                        </a>
                      </div>
                    </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:olivia@croydonnotary.co.uk" className="text-gray-600 hover:text-[#06b6d4] transition-colors">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#1f2937] mb-2">Office Address</h3>
                      <address className="text-gray-600 not-italic">
                        Brown Notary Services<br />
                        95 High Street<br />
                        Croydon<br />
                        Croydon<br />
                        Croydon CR0 1QD
                ...
                {/* Visits */}
                <div className="bg-gradient-to-br from-[#1f2937] to-[#374151] rounded-xl p-6 text-white">
                  <div className="flex items-start gap-4">
                    <div className="bg-[#06b6d4] rounded-lg p-3">
                      <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
