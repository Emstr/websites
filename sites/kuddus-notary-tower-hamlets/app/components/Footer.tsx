        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-100 mb-4">
              Professional notarial services by Kuddus Solicitors in Tower Hamlets and surrounding East London areas.
            </p>
            <div className="space-y-2 text-gray-100">
              <p>Kuddus Solicitors</p>
              <p>Tower Hamlets, East London</p>
              <p>Serving Whitechapel, Mile End, Bethnal Green, Bow, Poplar, Canary Wharf</p>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-300 text-sm">
              &copy; {new Date().getFullYear()} Kuddus Solicitors - Notary Public Tower Hamlets. All rights reserved.
            </p>
