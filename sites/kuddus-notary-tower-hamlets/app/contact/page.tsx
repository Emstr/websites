...
export const metadata: Metadata = {
  title: 'Contact | Notary Public Islington',
  description: 'Contact Esther Ogun, Notary Public in Islington, London. Book an appointment or request a quote for notarial services.',
};
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl font-bold text-[#16213e] mb-6">Send a Message</h2>
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    id="serviceType"
                    name="serviceType"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#e94560] focus:border-transparent outline-none transition-shadow bg-white"
                  >
            ...
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl font-bold text-[#16213e] mb-6">Contact Information</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#16213e] mb-2">Phone</h3>
                      <div className="space-y-1">
                        <a href="tel:02072782800" className="block text-gray-600 hover:text-[#e94560] transition-colors">
                          020 7278 2800
                        </a>
                        <a href="tel:07956317357" className="block text-gray-600 hover:text-[#e94560] transition-colors">
                          07956 317357
                        </a>
                        <a href="tel:02078338828" className="block text-gray-600 hover:text-[#e94560] transition-colors">
                          020 7833 8828
                        </a>
                      </div>
                    </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#16213e] mb-2">Email</h3>
                      <a href="mailto:esther@akinpalmer.com" className="text-gray-600 hover:text-[#e94560] transition-colors">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#16213e] mb-2">Office Address</h3>
                ...
                {/* Visits */}
                <div className="bg-gradient-to-br from-[#16213e] to-[#0f3460] rounded-xl p-6 text-white">
                  <div className="flex items-start gap-4">
