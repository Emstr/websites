...
export default function Home() {
  return (
    <>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-[#0f766e] to-[#14b8a6] rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-semibold mb-6">Areas Served</h3>
              <p className="text-gray-100 mb-6">
                We provide notary services across Tower Hamlets and surrounding East London areas:
              </p>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-[#0f766e] text-white">
