    ...
    <footer className="bg-primary text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold">Archstone Solicitors</h3>
            </div>
            <p className="text-gray-300 text-sm mb-4">
              Providing highest quality legal advice at reasonable prices for over 20 years.
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/practice-areas#immigration" className="text-gray-300 hover:text-gold transition-colors">
                  Immigration Law
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/practice-areas#personal-injury" className="text-gray-300 hover:text-gold transition-colors">
                  Personal Injury
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/fees" className="text-gray-300 hover:text-gold transition-colors">
                  Fee Information
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <div className="text-gray-300">
                  <a href="tel:02085348008" className="hover:text-gold transition-colors block">
                    020 8534 8008
                  </a>
                  <span className="text-xs">Fax: 020 8534 7007</span>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-gold mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="mailto:info@archstone.org.uk" className="text-gray-300 hover:text-gold transition-colors">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Archstone Solicitors. All rights reserved.</p>
          <p className="mt-2">
