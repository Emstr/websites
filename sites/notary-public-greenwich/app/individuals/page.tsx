...
export const metadata: Metadata = {
  title: 'Individual Services | Notary Public Greenwich',
...
export default function IndividualsPage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#0d4f4f]">Document Certification</h2>
              </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#0d4f4f]">Legal Documentation</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#0d4f4f]">Family & Travel</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#0d4f4f]">International & Administrative</h2>
              </div>
              <ul className="space-y-4">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-[#0d4f4f] to-[#134e4a] rounded-2xl p-8 lg:p-12 text-white">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex flex-col gap-4">
                ...
                <a
                  ...
                  className="border-2 border-white hover:bg-white hover:text-[#0d4f4f] px-8 py-4 rounded-lg text-lg font-semibold transition-colors text-center"
                >
                  Call: 020 8858 7200
                </a>
              </div>
