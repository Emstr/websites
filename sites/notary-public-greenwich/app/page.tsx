...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#0d4f4f] to-[#134e4a] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Notary Public Services in Greenwich
            </h1>
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#0d4f4f] mb-4">
              Our Services
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-[#0d4f4f] mb-3">
                  {service.title}
                </h3>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-[#0d4f4f] mb-6">
            ...
            <div className="bg-gradient-to-br from-[#0d4f4f] to-[#134e4a] rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-semibold mb-6">Areas Served</h3>
              <p className="text-gray-300 mb-6">
                I provide notary services across Greenwich and surrounding London boroughs:
              </p>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-[#0d4f4f] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="border-2 border-white hover:bg-white hover:text-[#0d4f4f] px-8 py-4 rounded-lg text-lg font-semibold transition-colors"
            >
              Call: 020 8858 7200
            </a>
          </div>
