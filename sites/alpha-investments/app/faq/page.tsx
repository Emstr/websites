...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about financial planning, investments, pensions, and our services. Get answers from Alpha Investments & Financial Planning.",
  openGraph: {
    title: "FAQ | Alpha Investments & Financial Planning",
    description:
  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Independent financial advisers (IFAs) like Alpha Investments are not tied to any product provider. This means we can recommend the best solutions from the entire market, rather than being limited to a specific company's products. Our advice is based solely on what's best for you.",
        },
        {
          question: "Are you regulated?",
          answer:
            "Yes, Alpha Investments & Financial Planning Ltd is authorised and regulated by the Financial Conduct Authority (FCA). This means we adhere to strict professional standards, and you're protected by the Financial Services Compensation Scheme (FSCS) and have access to the Financial Ombudsman Service if needed.",
        },
        {
      ...
      questions: [
        {
          ...
          answer:
            "We generally work with clients who have investable assets of 50,000 or more, or those making regular contributions. However, we're happy to discuss your situation as every client is different. For workplace pension advice and auto-enrolment services, different minimums may apply.",
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Yes, Inheritance Tax (IHT) planning is a key part of our wealth management service. We can help you structure your assets and make use of exemptions and reliefs to potentially reduce the IHT liability on your estate.",
        },
      ],
    },
    {
