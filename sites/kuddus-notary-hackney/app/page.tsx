        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              network, providing expert document authentication, legalisation, and apostille services across East London.
            </p>
      ...
      <section className="bg-accent text-white py-6">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-center">
            ...
            <p className="text-lg">#1 ranked for &quot;notary public Hackney London&quot;</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                ...
                notary public services across multiple London boroughs. Our Hackney office
                serves the East London community with professional, efficient notarial services.
              </p>
            ...
            <div className="bg-gradient-to-br from-primary to-secondary rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 mb-6">
                We provide notary services across Hackney and surrounding areas:
              </p>
