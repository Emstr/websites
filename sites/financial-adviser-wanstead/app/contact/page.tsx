...
export const metadata: Metadata = {
  title: 'Contact | Financial Adviser Wanstead',
  description: 'Contact William Thompson, Financial Adviser in Wanstead, London. Book an appointment or request a quote for financial advice.',
};
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <a href="tel:02089895300" className="block text-gray-600 hover:text-[#f97316] transition-colors">
                          020 8989 5300
                        </a>
                        <a href="tel:07978345678" className="block text-gray-600 hover:text-[#f97316] transition-colors">
                          07978 345678
                        </a>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:william@wansteadifa.co.uk" className="text-gray-600 hover:text-[#f97316] transition-colors">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#0f172a] mb-2">Office Address</h3>
                ...
                {/* Visits */}
                <div className="bg-gradient-to-br from-[#0f172a] to-[#1e293b] rounded-xl p-6 text-white">
                  <div className="flex items-start gap-4">
