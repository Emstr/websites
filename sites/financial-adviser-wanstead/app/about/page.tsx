...
export const metadata: Metadata = {
  title: 'About William Thompson | Financial Adviser Wanstead',
  description: 'Learn about William Thompson, qualified Financial Adviser and Solicitor based in Wanstead, London. Post-graduate Diploma in Notarial Practice.',
};
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Financial Adviser & Solicitor serving Wanstead and surrounding London boroughs
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  I am a Financial Adviser based in Wanstead, Wanstead E11. I hold a Post-graduate
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-8">
                <h3 className="text-xl font-bold text-[#0f172a] mb-4">Qualifications</h3>
              ...
              {/* Areas Served */}
              <div className="bg-gradient-to-br from-[#0f172a] to-[#1e293b] rounded-xl p-6 text-white mb-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h3 className="text-xl font-bold text-[#0f172a] mb-4">Get in Touch</h3>
                <div className="space-y-3 text-gray-600">
                  <a href="tel:02089895300" className="flex items-center gap-3 hover:text-[#f97316] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                    020 8989 5300
                  </a>
                  <a href="tel:07978345678" className="flex items-center gap-3 hover:text-[#f97316] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                    </svg>
                    07978 345678
                  </a>
                  <a href="mailto:william@wansteadifa.co.uk" className="flex items-center gap-3 hover:text-[#f97316] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                ...
                <Link
                  href="/contact"
                  className="mt-6 block w-full bg-[#f97316] hover:bg-[#ea580c] text-white text-center px-6 py-3 rounded-lg font-semibold transition-colors"
                >
                  Contact Me
                </Link>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#0f172a] mb-6">Fees</h2>
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <div className="text-5xl font-bold text-[#f97316] mb-2">£80</div>
              ...
              <div className="border-t border-gray-100 pt-6 space-y-4 text-left">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#f97316] mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                  </svg>
              ...
              <Link
                href="/quote"
                className="mt-8 inline-block bg-[#0f172a] hover:bg-[#1e293b] text-white px-8 py-4 rounded-lg font-semibold transition-colors"
              >
                Get Instant Quote
              </Link>
            </div>
