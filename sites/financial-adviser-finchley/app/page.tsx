...
export default function Home() {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Financial Adviser Services in Finchley
            </h1>
      ...
      {/* Pricing Banner */}
      <section className="bg-[#22c55e] text-white py-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                ...
                <span className="text-[#22c55e] font-medium inline-flex items-center gap-2">
                  Learn more
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-[#0c4a6e] to-[#0284c7] rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 mb-6">
                I provide financial adviser services across Finchley and surrounding London boroughs:
              </p>
