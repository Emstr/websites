...
export const metadata: Metadata = {
  ...
  description: 'Terms of business and complaints procedure for Emma Richardson, Notary Public, Barnet.',
};
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl font-bold text-[#1e3a5f] mt-6 mb-4">Fees & Charges</h2>
            ...
            <h2 className="text-2xl font-bold text-[#1e3a5f] mt-10 mb-4">Notary Responsibilities</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#1e3a5f] mt-10 mb-4">Legal Advice Limitations</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#1e3a5f] mt-10 mb-4">Payment Terms</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#1e3a5f] mt-10 mb-4">Liability</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#1e3a5f] mt-10 mb-4">Regulatory Authority</h2>
            <p className="text-gray-600 mb-6">
            ...
            <div id="complaints" className="scroll-mt-24">
              <h2 className="text-2xl font-bold text-[#1e3a5f] mt-10 mb-4">Complaints Procedure</h2>
              <p className="text-gray-600 mb-4">
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#1e3a5f]">
                  <h3 className="font-semibold text-[#1e3a5f] mb-2">Step 1: Contact the Notary</h3>
                  ...
                  <p className="text-gray-600 mt-2">
                    Email: <a href="mailto:emma@barnetnotary.co.uk" className="text-[#f97316] hover:underline">emma@barnetnotary.co.uk</a><br />
                    Phone: <a href="tel:02084415200" className="text-[#f97316] hover:underline">020 8441 5200</a>
                  </p>
                </div>

                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#2563eb]">
                  <h3 className="font-semibold text-[#1e3a5f] mb-2">Step 2: The Notaries Society</h3>
                  <p className="text-gray-600">
                ...
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#f97316]">
                  <h3 className="font-semibold text-[#1e3a5f] mb-2">Step 3: Legal Ombudsman</h3>
                  <p className="text-gray-600">
