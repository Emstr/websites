...
export const metadata: Metadata = {
  title: 'Business Services | Notary Public Barnet',
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1e3a5f]">Corporate Documentation</h2>
              </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1e3a5f]">Commercial & Financial</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1e3a5f]">Legal Declarations</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1e3a5f]">Intellectual Property</h2>
              </div>
              <ul className="space-y-4">
