...
export default function QuotePage() {
  ...
  if (showQuote) {
    return (
      <>
        {/* Hero */}
        <section className="bg-gradient-to-br from-[#1e3a5f] to-[#2563eb] text-white py-16">
        ...
        <section className="py-16">
          <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              {/* Quote Result */}
              <div className="bg-gradient-to-br from-[#1e3a5f] to-[#2563eb] p-8 text-white text-center">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            {step === 3 && (
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  You can visit our office in Barnet, or we can come to you.
                </p>
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600">
                      45 High Street, Barnet, London EN5 5UJ
                    </p>
                  </button>
                  <button
