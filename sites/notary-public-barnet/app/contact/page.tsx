...
export const metadata: Metadata = {
  title: 'Contact | Notary Public Barnet',
  description: 'Contact Emma Richardson, Notary Public in Barnet, London. Book an appointment or request a quote for notarial services.',
};
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <a href="tel:02084415200" className="block text-gray-600 hover:text-[#f97316] transition-colors">
                          020 8441 5200
                        </a>
                        <a href="tel:07901234567" className="block text-gray-600 hover:text-[#f97316] transition-colors">
                          07901 234567
                        </a>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:emma@barnetnotary.co.uk" className="text-gray-600 hover:text-[#f97316] transition-colors">
                ...
                {/* Visits */}
                <div className="bg-gradient-to-br from-[#1e3a5f] to-[#2563eb] rounded-xl p-6 text-white">
                  <div className="flex items-start gap-4">
