...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#1e3a5f] to-[#2563eb] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Notary Public Services in Barnet
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-[#1e3a5f] to-[#2563eb] rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 mb-6">
                I provide notary services across Barnet and surrounding London boroughs:
              </p>
