...
export const metadata: Metadata = {
  title: 'Individual Services | Notary Public Wandsworth',
...
export default function IndividualsPage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1a472a]">Document Certification</h2>
              </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1a472a]">Legal Documentation</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1a472a]">Family & Travel</h2>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#1a472a]">International & Administrative</h2>
              </div>
              <ul className="space-y-4">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-[#1a472a] to-[#166534] rounded-2xl p-8 lg:p-12 text-white">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex flex-col gap-4">
                ...
                <a
                  ...
                  className="border-2 border-white hover:bg-white hover:text-[#1a472a] px-8 py-4 rounded-lg text-lg font-semibold transition-colors text-center"
                >
                  Call: 020 7228 9100
                </a>
              </div>
