...
export const metadata: Metadata = {
  title: 'About Priya Sharma | Notary Public Brent',
  description: 'Learn about Priya Sharma, qualified Notary Public and Solicitor based in Brent, London. Post-graduate Diploma in Notarial Practice.',
};
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Notary Public & Solicitor serving Brent and surrounding London boroughs
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="prose prose-lg max-w-none">
                ...
                <h2 className="text-2xl font-bold text-[#312e81] mt-10 mb-4">
                  My Approach
                </h2>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-8">
                <h3 className="text-xl font-bold text-[#312e81] mb-4">Qualifications</h3>
              ...
              {/* Areas Served */}
              <div className="bg-gradient-to-br from-[#312e81] to-[#4338ca] rounded-xl p-6 text-white mb-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h3 className="text-xl font-bold text-[#312e81] mb-4">Get in Touch</h3>
                <div className="space-y-3 text-gray-600">
                  <a href="tel:02089034500" className="flex items-center gap-3 hover:text-[#f43f5e] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                    020 8903 4500
                  </a>
                  <a href="tel:07923456789" className="flex items-center gap-3 hover:text-[#f43f5e] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                    </svg>
                    07923 456789
                  </a>
                  <a href="mailto:priya@brentnotary.co.uk" className="flex items-center gap-3 hover:text-[#f43f5e] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                    </svg>
                    priya@brentnotary.co.uk
                  </a>
                </div>
                <Link
                  href="/contact"
                  className="mt-6 block w-full bg-[#f43f5e] hover:bg-[#e11d48] text-white text-center px-6 py-3 rounded-lg font-semibold transition-colors"
                >
                  Contact Me
                </Link>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#312e81] mb-6">Fees</h2>
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <div className="text-5xl font-bold text-[#f43f5e] mb-2">£80</div>
              ...
              <div className="border-t border-gray-100 pt-6 space-y-4 text-left">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#f43f5e] mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                  </svg>
              ...
              <Link
                href="/quote"
                className="mt-8 inline-block bg-[#312e81] hover:bg-[#4338ca] text-white px-8 py-4 rounded-lg font-semibold transition-colors"
              >
                Get Instant Quote
              </Link>
            </div>
