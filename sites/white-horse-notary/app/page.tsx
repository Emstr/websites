        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              White Horse Notary Public Services in Westminster
            </h1>
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Professional notarial services for businesses and individuals in Westminster and Central London.
              Document authentication, legalisation, and apostille services with an efficient and friendly approach.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                I am a Notary Public based in Westminster, Central London. I hold a Post-graduate
                Diploma in Notarial Practice and am dedicated to providing professional notarial
                services throughout Westminster and the surrounding areas.
              </p>
            ...
            <div className="bg-gradient-to-br from-[#0c4a6e] to-[#0284c7] rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 mb-6">
                I provide notary services across Westminster and surrounding Central London areas:
              </p>
