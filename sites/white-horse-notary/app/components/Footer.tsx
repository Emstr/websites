      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-lg font-semibold mb-4">White Horse Notary Public</h3>
            <p className="text-gray-300 mb-4">
              Professional notarial services in Westminster and surrounding Central London areas.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="tel:02038177502" className="hover:text-white transition-colors">
                  020 3817 7502
                </a>
              </li>
              <li>
                <a href="mailto:info@whitehorsenotarypublic.com" className="hover:text-white transition-colors">
                  info@whitehorsenotarypublic.com
                </a>
              </li>
            </ul>
          </div>
