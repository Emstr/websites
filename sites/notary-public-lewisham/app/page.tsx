...
export default function Home() {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Notary Public Services in Lewisham
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/quote"
                className="bg-[#84cc16] hover:bg-[#65a30d] px-8 py-4 rounded-lg text-lg font-semibold transition-colors text-center"
              >
                Instant Quote
              </Link>
              <Link
      ...
      {/* Pricing Banner */}
      <section className="bg-[#84cc16] text-white py-6">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                <div className="text-[#84cc16] mb-4 group-hover:scale-110 transition-transform">
                  {service.icon}
                </div>
                ...
                <span className="text-[#84cc16] font-medium inline-flex items-center gap-2">
                  Learn more
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-[#84cc16] font-semibold hover:gap-3 transition-all"
              >
            ...
            <div className="bg-gradient-to-br from-[#334155] to-[#475569] rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 mb-6">
                I provide notary services across Lewisham and surrounding London boroughs:
              </p>
