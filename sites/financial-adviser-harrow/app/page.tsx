...
export default function Home() {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Financial Adviser Services in Harrow
            </h1>
      ...
      {/* Pricing Banner */}
      <section className="bg-[#fbbf24] text-white py-6">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                <div className="text-[#fbbf24] mb-4 group-hover:scale-110 transition-transform">
                  {service.icon}
                </div>
                ...
                <span className="text-[#fbbf24] font-medium inline-flex items-center gap-2">
                  Learn more
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-[#fbbf24] font-semibold hover:gap-3 transition-all"
              >
            ...
            <div className="bg-gradient-to-br from-[#4c1d95] to-[#7c3aed] rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 mb-6">
                I provide financial adviser services across Harrow and surrounding London boroughs:
              </p>
