...
export const metadata: Metadata = {
  title: 'Frequently Asked Questions | Financial Adviser Harrow',
...
const faqs = [
  {
    ...
    answer: `The cost of notarising a document in the UK varies depending on the complexity of the work and time required. At Financial Adviser Harrow, the minimum fee is £80 (no VAT) for up to twenty minutes of financial adviser time. Pro-rata rates apply for longer appointments.
...
For an accurate quote, please contact us with details of your specific requirements. We provide transparent pricing and will always confirm fees before proceeding with any work.`,
  },
  {
    ...
    question: 'What services does a financial adviser offer in Harrow?',
    answer: `A financial adviser in Harrow offers a wide range of investment planning and certification services for both businesses and individuals. These include:
...
Contact us with details of your requirements for a more accurate time estimate.`,
  },
  {
    ...
    answer: `Yes, I offer home and business visits throughout Harrow and surrounding London boroughs for an additional fee.
...
export default function FAQPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-[#4c1d95] to-[#7c3aed] text-white py-20">
          ...
          <div className="flex flex-wrap gap-2">
            {faqs.map((faq) => (
              <a
                key={faq.id}
                href={`#${faq.id}`}
                className="text-sm bg-white px-3 py-1.5 rounded-full border border-gray-200 text-gray-600 hover:border-[#fbbf24] hover:text-[#fbbf24] transition-colors"
              >
              ...
              >
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <span className="flex items-center justify-center w-10 h-10 rounded-full bg-[#4c1d95] text-white font-bold">
                      {index + 1}
                    </span>
                  </div>
                    ...
                    <div className="prose prose-lg max-w-none text-gray-600">
                      {faq.answer.split('\n\n').map((paragraph, pIndex) => {
                        if (paragraph.startsWith('**') && paragraph.endsWith('**')) {
                          return (
                            <h3 key={pIndex} className="text-lg font-semibold text-[#4c1d95] mt-6 mb-2">
                              {paragraph.replace(/\*\*/g, '')}
                            </h3>
                          );
                        }
      ...
      <section className="py-16 bg-[#4c1d95] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="bg-[#fbbf24] hover:bg-[#f59e0b] px-8 py-4 rounded-lg text-lg font-semibold transition-colors"
            >
              Contact Me
            </Link>
            <a
              href="tel:02084276500"
