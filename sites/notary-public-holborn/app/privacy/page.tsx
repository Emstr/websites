...
export const metadata: Metadata = {
  ...
  description: 'Privacy notice for Notary Public Holborn. How we collect, use, and protect your personal data.',
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-8">
              <strong>Notary Public Holborn</strong> is committed to protecting your privacy
              and handling your personal data responsibly.
            </p>

            <h2 className="text-2xl font-bold text-[#1a1a2e] mt-10 mb-4">Personal Data We Collect</h2>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-6">
              ...
              <li>Language preferences for multilingual services</li>
            </ul>

            <h2 className="text-2xl font-bold text-[#1a1a2e] mt-10 mb-4">How We Use Your Information</h2>
            ...
            <h2 className="text-2xl font-bold text-[#1a1a2e] mt-10 mb-4">Your Rights</h2>
            ...
            <h2 className="text-2xl font-bold text-[#1a1a2e] mt-10 mb-4">Contact Us</h2>
            <p className="text-gray-600 mb-4">
