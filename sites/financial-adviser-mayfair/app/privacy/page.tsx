...
export const metadata: Metadata = {
  ...
  description: 'Privacy notice for Charlotte Davies, Financial Adviser, Mayfair. How we collect, use, and protect your personal data.',
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-8">
              <strong>ESTHER OGUN, NOTARY PUBLIC</strong> of 33 Brook Street, London W1K 4HB
              is registered with the Information Commissioner&apos;s Office under registration number <strong>ZA499653</strong>.
            </p>

            <h2 className="text-2xl font-bold text-[#1e1b4b] mt-10 mb-4">Personal Data We Collect</h2>
            ...
            <h2 className="text-2xl font-bold text-[#1e1b4b] mt-10 mb-4">How We Use Your Information</h2>
            ...
            <h2 className="text-2xl font-bold text-[#1e1b4b] mt-10 mb-4">Cookies</h2>
            ...
            <h2 className="text-2xl font-bold text-[#1e1b4b] mt-10 mb-4">Your Rights</h2>
            ...
            <h2 className="text-2xl font-bold text-[#1e1b4b] mt-10 mb-4">Contact Us</h2>
            <p className="text-gray-600 mb-4">
