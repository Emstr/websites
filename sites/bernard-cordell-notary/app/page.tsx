        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 mb-8 leading-relaxed">
              Independent notary public serving Belsize Park and North London. Professional document authentication,
              legalisation, and apostille services for businesses and individuals.
            </p>
      ...
      <section className="bg-[#fbbf24] text-[#7f1d1d] py-6">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-center">
            <p className="text-lg">
              <span className="font-bold">Competitive fees</span> - Contact for pricing
            </p>
            <span className="hidden md:inline">•</span>
            <p className="text-lg">Flexible appointments available</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Bernard Cordell is an independent Notary Public based in Belsize Park, North London.
                With extensive experience in notarial practice, Bernard provides professional
                and reliable document authentication services.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Committed to delivering efficient and accessible notary services to both
                businesses and individuals throughout North London.
              </p>
              <Link
                href="/about"
            ...
            <div className="bg-gradient-to-br from-[#7f1d1d] to-[#991b1b] rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-200 mb-6">
                Providing notary services across Belsize Park and surrounding North London areas:
              </p>
