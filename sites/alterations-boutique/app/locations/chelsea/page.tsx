...
export const metadata: Metadata = {
  title: 'Chelsea Location',
  description: 'Alterations Boutique Chelsea - 33 Elystan Street, London SW3 3NT. Expert alterations in elegant Chelsea.',
};
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              Serving the elegant Chelsea neighborhood with expert alterations
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-8 bg-burgundy/5 rounded-lg p-6 border border-burgundy/20">
                <h3 className="font-semibold text-burgundy mb-3">Convenient Evening Hours</h3>
                <p className="text-gray-600 text-sm">
                  Open until 9pm Tuesday through Friday, making it easy to visit us after work or during your evening in Chelsea.
                </p>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-3xl font-bold text-burgundy mb-8">
                About Our Chelsea Store
              </h2>

              <div className="space-y-6">
                <p className="text-gray-600 leading-relaxed">
                  Located on Elystan Street in the heart of Chelsea, our store serves one of London's most elegant and fashionable neighborhoods. We're proud to be the alterations service of choice for Chelsea residents and visitors.
                </p>
                ...
                <div className="bg-silver-light/10 rounded-lg p-6 border border-silver-light/30">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-gray-700">Close to Sloane Square and South Kensington</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">Easy access via Sloane Square tube (Circle & District Lines)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">Walking distance to King's Road shops and restaurants</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">In the heart of Chelsea's designer shopping district</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">Trusted by Chelsea's fashion-conscious residents</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">Metered parking available on nearby streets</span>
                    </li>
                  </ul>
                </div>
