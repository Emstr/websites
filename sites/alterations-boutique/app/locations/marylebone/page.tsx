...
export const metadata: Metadata = {
  title: 'Marylebone Location',
  description: 'Alterations Boutique Marylebone - Our flagship location at 14 New Quebec Street, London W1H 7RS. Expert alterations since 1983.',
};
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              Our flagship location in the heart of Marylebone, serving London's West End since 1983
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-8 bg-burgundy/5 rounded-lg p-6 border border-burgundy/20">
                <h3 className="font-semibold text-burgundy mb-3">Extended Evening Hours</h3>
                <p className="text-gray-600 text-sm">
                  We're open until 9pm Tuesday through Friday to accommodate your busy schedule. Perfect for after-work fittings and consultations.
                </p>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-3xl font-bold text-burgundy mb-8">
                About Our Marylebone Store
              </h2>

              <div className="space-y-6">
                <p className="text-gray-600 leading-relaxed">
                  Our Marylebone location has been serving the local community since 1983, making it our flagship and longest-standing store. Located in the heart of this prestigious West End neighborhood, we're ideally positioned to serve residents and workers throughout central London.
                </p>
                ...
                <div className="bg-silver-light/10 rounded-lg p-6 border border-silver-light/30">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-gray-700">Just minutes from Marble Arch and Oxford Street</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">Easy access via Marble Arch tube (Central Line)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">Close to Baker Street and Edgware Road stations</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">Surrounded by designer boutiques and high-end retailers</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">Extended evening hours for your convenience</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-burgundy flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-gray-700">On-street parking available nearby</span>
                    </li>
                  </ul>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                34 High Street, London SW19 5BY
              </p>
            </Link>
          </div>
        </div>
