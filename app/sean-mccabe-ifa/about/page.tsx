...
export const metadata: Metadata = {
  title: "About Us | Independent Financial Advisers Since 2006",
  description:
    "Learn about Sean McCabe Financial - a family-run independent financial advisory firm serving Stoke-on-Trent and Staffordshire since 2006. 20 years experience, whole-of-market advice, FCA regulated.",
  openGraph: {
    title: "About Us | Sean McCabe Financial",
    description:
      "Family-run independent financial advisers providing whole-of-market advice from Stoke-on-Trent since 2006. Nearly 20 years of trusted guidance.",
  },
};
        ...
        <div className="container-width relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6">
              Your Trusted Financial Partners Since 2006
            </h1>
            <p className="text-xl text-gray-200 leading-relaxed">
              Nearly 20 years of independent financial advice from a family-run firm
              in Stoke-on-Trent, Staffordshire. Whole-of-market expertise you can trust.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">
                A Family Firm Since 2006
              </h2>
              <div className="gold-line mb-6"></div>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Sean McCabe Financial was founded in 2006 with a clear
                mission: to provide honest, independent financial advice that puts
                clients first. Over nearly two decades, we have grown into one of
                Stoke-on-Trent&apos;s most trusted financial advisory practices,
            ...
            <div>
              <div className="relative h-80 rounded-sm overflow-hidden shadow-xl mb-8">
                <Image
                  ...
                  alt="Sean McCabe Financial - Family-run since 2006"
                  fill
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                ...
                built over nearly 20 years on doing the right thing for our clients,
                every time.
              </p>
            </div>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">
              Based in Alsager, Stoke-on-Trent
            </h2>
            <div className="gold-line-center mb-6"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Alsager office has been our home since 2006. Conveniently
              located for clients across Stoke-on-Trent, Crewe, and wider Staffordshire.
            </p>
          </div>
            ...
            <div className="bg-gray-50 p-8 lg:p-12 rounded-sm border-t-4 border-accent">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Family-run firm since 2006
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-accent" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  Serving Stoke-on-Trent &amp; Staffordshire
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Sean McCabe Financial is authorised and regulated by the
              Financial Conduct Authority (FCA Reference: 494478). This means we
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how Sean McCabe Financial
            Consultants can help you achieve your financial goals.
          </p>
