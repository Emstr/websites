...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Sean McCabe (Financial Adviser) Limited trading as Sean McCabe Financial. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Sean McCabe (Financial Adviser) Limited trading as Sean McCabe Financial is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              office is at 19-21 Crewe Road, Alsager, Stoke-on-Trent, ST7 2EW.
            </p>
            <p className="text-gray-600 mb-6">
