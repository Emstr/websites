...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive whole-of-market financial advice including pensions, investments, mortgages, protection and estate planning from Sean McCabe Financial in Stoke-on-Trent.",
  openGraph: {
    title: "Financial Services | Sean McCabe Financial",
    description:
      "Whole-of-market independent financial advice from FCA regulated advisers. Pensions, investments, mortgages, protection and estate planning in Stoke-on-Trent.",
  },
};
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              in Stoke-on-Trent and Staffordshire since 2006.
            </p>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  ...
                  <Link href="/sean-mccabe-ifa/contact" className="btn-accent">
                    Discuss Your Needs
                  </Link>
                </div>
                <div
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01270878755" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 01270 878755
            </a>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Sean McCabe (Financial Adviser) Limited trading as
              Sean McCabe Financial is authorised and regulated by the Financial
