...
export const metadata: Metadata = {
  ...
  description:
    "Contact City Financial Planning for independent financial advice. Visit our Bath office or call 01225 314999 for a free consultation.",
  openGraph: {
    title: "Contact Us | City Financial Planning",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01225 314999 or visit our Bath office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Bath office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Bath</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to City Financial Planning contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/city-financial-bath/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Bath, Somerset</h3>
                  </div>
                </div>
                <address className="not-italic text-gray-700 mb-4">
                  <strong>City Financial Planning</strong>
                  <br />
                  Bath, Somerset
                </address>
                ...
                <p className="text-sm text-gray-500">
                  Family-run firm serving clients across Bath and Somerset
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01225 314999</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">admin@cityfinancialplanning.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width py-8">
          ...
          <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden">
            <iframe
              ...
              title="City Financial Planning - Bath, Somerset"
            ></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> City Financial Planning is
              authorised and regulated by the Financial Conduct Authority (FCA
              Reference: 440633). Initial consultations are provided free of charge
