...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for IFA Centre. Understand our client agreement, services, fees, and regulatory information as Chartered Financial Planners.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              IFA Centre is a firm of Chartered Financial Planners, authorised and
              regulated by the Financial Conduct Authority (FCA). We maintain
              offices in Glasgow and Paisley, serving clients across Central
              Scotland and beyond.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Financial planning and cash flow modelling</li>
              ...
              <li>Wealth management for individuals and families</li>
              <li>Retirement planning and pension drawdown</li>
            </ul>
            <p className="text-gray-600 mb-6">
              As independent Chartered Financial Planners, we are not restricted in
              the range of products we can recommend. We will assess your needs and
            ...
            <p className="text-gray-600 mb-6">
              ...
              which affords you the highest level of protection under the FCA
              rules. This means you have access to the Financial Ombudsman Service
              and may be eligible for compensation under the Financial Services
              Compensation Scheme (FSCS) if we are unable to meet our obligations.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              ...
              days of receiving the contract (30 days for protection policies). We
              will provide specific cancellation information with each product
            ...
            <p className="text-gray-600 mb-6">
              These Terms of Business are governed by Scots law. Any disputes will
              be subject to the jurisdiction of the Scottish courts, without
              prejudice to your right to refer complaints to the Financial
              Ombudsman Service.
            </p>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              IFA Centre
              <br />
              Glasgow &amp; Paisley, Central Scotland
              <br />
              Phone: 0141 848 5454
              <br />
              Email: hello@ifacentre.net
