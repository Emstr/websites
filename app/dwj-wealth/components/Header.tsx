...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/dwj-wealth" },
    { name: "Services", href: "/dwj-wealth/services" },
    { name: "About", href: "/dwj-wealth/about" },
    { name: "FAQ", href: "/dwj-wealth/faq" },
    { name: "Contact", href: "/dwj-wealth/contact" },
  ];
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Swansea, Wales</span>
            </div>
          </div>
        </div>
      </div>
