...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for DWJ Wealth Management Ltd. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              DWJ Wealth Management Ltd (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              DWJ Wealth Management Ltd (Company No. 09104954) is the data controller
              for personal information collected through our services and website. Our
              contact details are:
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Property details (where relevant to equity release advice)</li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                providers, equity release providers) to implement our recommendations
              </li>
