...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for DWJ Wealth Management Ltd (Company No. 09104954). Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              office is at Argyle House, 10 West Street, Gorseinon, Swansea SA4 4AA.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Tailored wealth management for private and corporate clients</li>
              <li>Private client financial planning, including pensions and investments</li>
              <li>Corporate client advice, including workplace pensions and employee benefits</li>
              <li>Equity release, including lifetime mortgages and home reversion plans</li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              solutions tailored to your individual circumstances.
            </p>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <li>
                  Equity release will reduce the value of your estate and may
