...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for DM Pension & Investment Solutions Ltd t/a Face2Face Advice. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              DM Pension & Investment Solutions Ltd t/a Face2Face Advice is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              office is in Glasgow, Lanarkshire.
            </p>
            <p className="text-gray-600 mb-6">
