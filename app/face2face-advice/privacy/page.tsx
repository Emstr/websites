...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for DM Pension & Investment Solutions Ltd t/a Face2Face Advice. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              DM Pension & Investment Solutions Ltd t/a Face2Face Advice
            ...
            <p className="text-gray-600 mb-6">
              DM Pension & Investment Solutions Ltd t/a Face2Face Advice is the
