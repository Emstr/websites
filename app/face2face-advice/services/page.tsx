...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive whole-of-market financial advice including pensions, investments, mortgages, protection and estate planning from Face2Face Advice in Glasgow.",
  openGraph: {
    title: "Financial Services | Face2Face Advice",
    description:
      "Whole-of-market independent financial advice from FCA regulated advisers. Pensions, investments, mortgages, protection and estate planning in Glasgow.",
  },
};
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              in Glasgow and Lanarkshire since 1994.
            </p>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  ...
                  <Link href="/face2face-advice/contact" className="btn-accent">
                    Discuss Your Needs
                  </Link>
                </div>
                <div
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01698815006" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 01698 815 006
            </a>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> DM Pension & Investment Solutions Ltd trading as
              Face2Face Advice is authorised and regulated by the Financial
