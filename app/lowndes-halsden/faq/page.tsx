...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about financial planning, investments, pensions, mortgages and our services. Get answers from Lowndes Halsden, Cardiff.",
  openGraph: {
    title: "FAQ | Lowndes Halsden",
    description:
      "Common questions about financial advice, investments, pensions, mortgages and working with an independent financial adviser in Cardiff.",
  },
};
  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Independent financial advisers (IFAs) like Lowndes Halsden are not tied to any product provider. This means we can recommend the best solutions from the entire market, rather than being limited to a specific company's products. Our advice is based solely on what's best for you.",
        },
        {
          question: "Are you regulated?",
          answer:
            "Yes, Lowndes Halsden is authorised and regulated by the Financial Conduct Authority (FCA). This means we adhere to strict professional standards, and you're protected by the Financial Services Compensation Scheme (FSCS) and have access to the Financial Ombudsman Service if needed.",
        },
        {
          question: "Do you offer a free initial consultation?",
          answer:
            "Yes, we offer a complimentary initial consultation with no obligation. This meeting allows us to understand your situation and goals, while you can get to know us and decide if we're the right fit for your needs. Just ask — there's no pressure to proceed with any paid services.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "We work with clients across a range of investment levels. We're happy to discuss your situation as every client is different. For workplace pension advice and corporate financial planning, different arrangements may apply. Just ask and we'll let you know how we can help.",
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Yes, we advise on all types of pension schemes including workplace pensions, SIPPs, and defined benefit (final salary) schemes. For businesses across Wales, we also provide auto-enrolment solutions and corporate pension advice.",
        },
        {
      ...
      questions: [
        {
          ...
          answer:
            "Absolutely. We specialise in helping first-time buyers navigate the mortgage process. We search the whole market to find you the best deal, help with affordability assessments, and guide you through every step from application to completion. We can also advise on government schemes like Help to Buy.",
        },
        {
          question: "Should I remortgage?",
          answer:
            "It's often worth reviewing your mortgage, especially when your current deal is coming to an end. We can compare your existing mortgage against the whole market to see if you could save money or release equity. There's no obligation — just ask and we'll run the numbers for you.",
        },
        {
          question: "Do you charge for mortgage advice?",
          answer:
            "We'll always be upfront about our fees before any work begins. In many cases, we receive a commission from the lender, meaning there is no direct fee to you. We'll explain our charging structure clearly at the outset so there are no surprises.",
        },
      ],
    },
    {
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              and how we can help you achieve your financial goals. And remember — if
              your question isn&apos;t here, just ask.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-width">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              ...
              for, please don&apos;t hesitate to get in touch. Just ask — our team will
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            our expert advisers at our Cardiff office.
          </p>
          <Link href="/lowndes-halsden/contact" className="btn-accent">
