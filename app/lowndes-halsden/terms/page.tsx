...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Lowndes Halsden. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Authority (FCA). Our office is based in Cardiff, Wales.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Mortgage advice (residential, buy-to-let, remortgage)</li>
              <li>Protection planning (life assurance, critical illness, income protection)</li>
              <li>Wealth management</li>
              <li>Corporate financial planning and workplace pension solutions</li>
            </ul>
            <p className="text-gray-600 mb-6">
