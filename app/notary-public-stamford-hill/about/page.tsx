...
export const metadata: Metadata = {
  title: 'About',
  description: 'Learn about Notary Public Stamford Hill. Professional notarial services in Stamford Hill, London N16.',
};

const areas = [
  { name: 'Stamford Hill', primary: true },
  { name: 'Stoke Newington', primary: false },
  { name: 'Tottenham', primary: false },
  { name: 'Haringey', primary: false },
  { name: 'Hackney', primary: false },
  { name: 'Seven Sisters', primary: false },
  { name: 'Finsbury Park', primary: false },
];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Professional notary public services in Stamford Hill, London
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Notary Public Stamford Hill provides professional notarial services to businesses
                  and individuals across North London and beyond.
                </p>

                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Our convenient Stamford Hill location offers excellent transport links, making us
                  easily accessible for clients from Stoke Newington, Tottenham, Hackney,
                  and surrounding areas.
                </p>

                <h2 className="text-2xl font-bold text-[#2c3e50] mt-10 mb-4">
                  Our Approach
                </h2>
            ...
            <div className="lg:col-span-1">
              {/* Areas Served */}
              <div className="bg-gradient-to-br from-[#2c3e50] to-[#1a252f] rounded-xl p-6 text-white mb-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="space-y-3 text-gray-600">
                  <a href="tel:02088005000" className="flex items-center gap-3 hover:text-[#27ae60] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                    020 8800 5000
                  </a>
                  <a href="mailto:info@notarypublicstamfordhill.co.uk" className="flex items-center gap-3 hover:text-[#27ae60] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                    </svg>
                    info@notarypublicstamfordhill.co.uk
                  </a>
                </div>
                <Link
                  href="/contact"
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#2c3e50] mb-6">Our Fees</h2>
            <div className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <div className="border-t border-gray-100 pt-6 space-y-4 text-left">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#27ae60] mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
