...
const services = [
  {
    ...
    href: '/notary-public-holborn/services#business',
    icon: (
  ...
  },
  {
    ...
    href: '/notary-public-holborn/services#individual',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/notary-public-holborn/services#apostille',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
...
export default function Home() {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Notary Public Services in Holborn
            </h1>
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Professional notarial services for businesses and individuals in Central London.
              Multilingual support available in Russian, Mandarin, and Portuguese.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/notary-public-holborn/about"
                className="border-2 border-white hover:bg-white hover:text-[#1a1a2e] px-8 py-4 rounded-lg text-lg font-semibold transition-colors text-center"
              >
                Learn More
              </Link>
            </div>
      ...
      {/* Multilingual Banner */}
      <section className="bg-[#e94560] text-white py-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              {languages.map((lang, index) => (
                <span key={lang.name} className="flex items-center gap-1">
                  <span>{lang.name}</span>
                  <span className="text-white/80">({lang.native})</span>
                  {index < languages.length - 1 && <span className="hidden md:inline mx-2">|</span>}
                </span>
              ))}
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                <div className="text-[#e94560] mb-4 group-hover:scale-110 transition-transform">
                  {service.icon}
                </div>
                ...
                <span className="text-[#e94560] font-medium inline-flex items-center gap-2">
                  Learn more
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-[#1a1a2e] mb-6">
                Central London&apos;s Multilingual Notary
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Based in the heart of Holborn, we provide professional notarial services
                to businesses and individuals across Central London. Our multilingual
                team can assist clients in Russian, Mandarin, and Portuguese.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Our prime location in Holborn offers excellent transport links, making us
                easily accessible from Chancery Lane, Farringdon, King&apos;s Cross,
            ...
            <div className="bg-gradient-to-br from-[#1a1a2e] to-[#16213e] rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 mb-6">
                We provide notary services across Central London and surrounding areas:
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              We understand the importance of clear communication. Our team provides
              notarial services in multiple languages.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {languages.map((lang) => (
              <div key={lang.name} className="bg-[#1a1a2e] rounded-xl p-6 text-center">
                <div className="text-4xl mb-4">{lang.native}</div>
                <h3 className="text-xl font-semibold text-[#e94560] mb-2">{lang.name}</h3>
                <p className="text-gray-300 text-sm">
                  Full notarial services available in {lang.name} for clients who prefer
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="border-2 border-white hover:bg-white hover:text-[#1a1a2e] px-8 py-4 rounded-lg text-lg font-semibold transition-colors"
            >
              Call: 020 7242 5000
            </a>
          </div>
