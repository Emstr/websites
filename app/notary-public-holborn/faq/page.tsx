...
export const metadata: Metadata = {
  ...
  description: 'Common questions about notary public services in Holborn, Central London. Learn about costs, the notarisation process, multilingual support, and more.',
};
...
For an accurate quote, please use our instant quote calculator or contact us with details of your specific requirements.`,
  ...
  {
    id: 'multilingual-services',
    question: 'What languages do you offer services in?',
    answer: `We offer notarial services in multiple languages to serve our diverse client base:
...
Our multilingual team can assist with the entire notarisation process in your preferred language, from initial consultation to the completion of your documents. This is particularly helpful for clients who need documents notarised for use in Russia, China, Brazil, Portugal, and other countries where these languages are spoken.

There is no additional charge for multilingual services.`,
  },
  {
...
**1. Contact Us**
Reach out to discuss your requirements. Explain what documents need notarising and where they will be used. Let us know if you prefer to communicate in Russian, Mandarin, or Portuguese.
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              ...
              multilingual support, and the notarisation process.
            </p>
          </div>
        </div>
      </section>
              ...
              <article key={faq.id} id={faq.id} className="scroll-mt-24">
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <span className="flex items-center justify-center w-10 h-10 rounded-full bg-[#1a1a2e] text-white font-bold">
                      {index + 1}
                    </span>
                  </div>
                    ...
                    <div className="prose prose-lg max-w-none text-gray-600">
                      {faq.answer.split('\n\n').map((paragraph, pIndex) => {
                        if (paragraph.startsWith('**') && paragraph.endsWith('**')) {
                          return (
                            <h3 key={pIndex} className="text-lg font-semibold text-[#1a1a2e] mt-6 mb-2">
                              {paragraph.replace(/\*\*/g, '')}
                            </h3>
                          );
                        }
      ...
      <section className="py-16 bg-[#1a1a2e] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            ...
            the notarisation process and provide a quote. Multilingual support available.
          </p>
