...
export const metadata: Metadata = {
  ...
  description: 'Professional notary public services in Holborn, Central London. Multilingual support in Russian, Mandarin, and Portuguese. Business and individual document authentication, apostille and legalisation services.',
};
...
export default function ServicesPage() {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              ...
              to personal certifications, we provide professional authentication services with multilingual support.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#e94560] text-white py-4">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-center gap-4 text-center">
            <span className="font-semibold">Services available in:</span>
      ...
      <section id="business" className="py-20 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#1a1a2e]">Business Services</h2>
          </div>
      ...
      <section id="individual" className="py-20 bg-gray-50 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#1a1a2e]">Individual Services</h2>
          </div>
      ...
      <section id="apostille" className="py-20 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-[#e94560] rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              ...
              with the entire process. Our multilingual team can help with documents destined for
              Russia, China, Brazil, Portugal, and many other countries.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#1a1a2e] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            ...
            that require authentication for use in the UK or abroad. Multilingual assistance available.
          </p>
