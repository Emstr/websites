...
export const metadata: Metadata = {
  title: "About Us | Independent Financial Advisers Since 1977",
  description:
    "Learn about HSP Financial Planning - an established independent financial advisory firm serving Leicestershire since 1977. Nearly 50 years experience, 100+ years combined team expertise, FCA regulated.",
  openGraph: {
    title: "About Us | HSP Financial Planning",
    description:
      "Independent financial advisers providing expert advice from Whetstone, Leicestershire since 1977. Nearly 50 years of trusted guidance.",
  },
};
        ...
        <div className="container-width relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6">
              Your Trusted Financial Partners Since 1977
            </h1>
            <p className="text-xl text-gray-200 leading-relaxed">
              Nearly 50 years of independent financial advice from an established
              firm in Whetstone, Leicestershire. Over 100 years of combined team
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                HSP Financial Planning was founded in 1977 with a clear
                mission: to provide honest, independent financial advice that puts
                clients first. Over nearly five decades, we have grown into one of
                Leicestershire&apos;s most trusted financial advisory practices,
                while maintaining the personal values that have been at the heart
                of everything we do.
              </p>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Our growth has been built on a foundation of trust, expertise, and
                genuine care for our clients&apos; financial wellbeing. With over
                100 years of combined team experience, we specialise in pension
                planning, investment advice, inheritance tax planning, family
                protection, and corporate advice, offering a breadth of knowledge
                that ensures every client receives the best possible guidance.
              </p>
              <p className="text-gray-600 leading-relaxed">
                As independent financial advisers, we are not tied to any product
                provider. This means we can genuinely recommend the best solutions
                from across the market, whether you need advice on retirement
                planning, growing your wealth, protecting your family, or planning
            ...
            <div>
              <div className="relative h-80 rounded-sm overflow-hidden shadow-xl mb-8">
                <div className="absolute inset-0 bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <p className="text-xl text-gray-300">Planning Tomorrow Today</p>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center p-6 bg-gray-50 rounded-sm shadow-sm">
                  ...
                  <p className="text-gray-600 mt-2 font-medium">Years Combined</p>
                </div>
                <div className="text-center p-6 bg-gray-50 rounded-sm shadow-sm">
                  <div className="stat-number">100%</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                ...
                recommend the best solutions for you from the market. Your interests
                always come first.
              </p>
            </div>
            ...
            <div className="card-premium p-8">
              ...
              <h3 className="text-xl font-bold text-primary mb-3">Community Values</h3>
              <p className="text-gray-600">
                Deeply rooted in the Leicestershire community since 1977, we treat
                every client with the personal attention they deserve. We take time to
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                Our team brings together over 100 years of combined experience in
                financial services, with specialist knowledge in pensions, investments,
                IHT planning, protection, and corporate advice.
              </p>
            </div>
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                ...
                built over nearly 50 years on doing the right thing for our clients,
                every time.
              </p>
            </div>
          </div>
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Whetstone office has been our home since 1977. Conveniently
              located for clients across Leicestershire and the East Midlands.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-gray-50 p-8 lg:p-12 rounded-sm border-t-4 border-accent">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Our established office has been serving clients for nearly five
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Serving Leicestershire &amp; the East Midlands
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              HSP Financial Planning Ltd is authorised and regulated by the
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how HSP Financial
