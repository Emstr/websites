...
export const metadata: Metadata = {
  ...
  description:
    "Contact HSP Financial Planning for independent financial advice. Visit our Leicester office or call 0116 275 0225 for a free consultation.",
  openGraph: {
    title: "Contact Us | HSP Financial Planning",
    description:
      "Book a free consultation with our experienced financial advisers. Call 0116 275 0225 or visit our Leicester office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Leicester office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Whetstone, Leicestershire</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to HSP Financial Planning contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/hsp-financial/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Whetstone, Leicestershire</h3>
                  </div>
                </div>
                ...
                <p className="text-sm text-gray-500">
                  Established firm serving clients across Leicester and Leicestershire
                  since 1977. We also offer telephone and video consultations.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">0116 275 0225</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">services@hsp-ifa.com</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
      ...
      <section className="bg-gray-100">
        <div className="container-width py-8">
          ...
          <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2420.0!2d-1.1780!3d52.5540!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTLCsDMzJzE0LjQiTiAxwrAxMCc0MC44Ilc!5e0!3m2!1sen!2suk!4v1"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> HSP Financial Planning is
              authorised and regulated by the Financial Conduct Authority. Initial consultations are provided free of charge
