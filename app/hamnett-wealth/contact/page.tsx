...
export const metadata: Metadata = {
  ...
  description:
    "Contact Hamnett Wealth Management for expert financial advice from Chartered Financial Planners. Sheffield, South Yorkshire. Call 0114 235 3500 for a free consultation.",
  openGraph: {
    title: "Contact Us | Hamnett Wealth Management",
    description:
      "Book a free consultation with our Chartered Financial Planners in Sheffield. Call 0114 235 3500.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Chartered Financial Planners in Sheffield, or reach out to
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Sheffield Office</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Hamnett Wealth Management contacting me regarding
                    my enquiry. I understand my data will be processed in accordance
                    with the{" "}
                    <a href="/hamnett-wealth/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Sheffield</h3>
                  </div>
                </div>
                <address className="not-italic text-gray-700 mb-4">
                  <strong>Hamnett Wealth Management</strong>
                  <br />
                  Sheffield
                  <br />
                  South Yorkshire
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  ...
                  Chartered Financial Planners &bull; Established 1989
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">0114 235 3500</p>
                  ...
                  <a
                    href="mailto:advice@hamnettwealth.com"
                    className="flex items-center gap-3 text-gray-700 hover:text-accent transition-colors"
                  >
                    <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center">
                      <svg
                    ...
                    <div>
                      <p className="font-semibold">advice@hamnettwealth.com</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
      ...
      <section className="bg-gray-100">
        <div className="container-width py-8">
          ...
          <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2379.8!2d-1.4701!3d53.3811!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTPCsDIyJzUyLjAiTiAxwrAyOCcxMi40Ilc!5e0!3m2!1sen!2suk!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Hamnett Wealth Management Sheffield Office Location"
            ></iframe>
          </div>
        </div>
      </section>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              is a firm of Chartered Financial Planners. Initial consultations are provided
              free of charge and without obligation. We will always explain our fees
