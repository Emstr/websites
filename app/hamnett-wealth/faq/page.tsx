...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about financial planning, investments, pensions, Chartered status, and our services. Get answers from Hamnett Wealth Management.",
  openGraph: {
    title: "FAQ | Hamnett Wealth Management",
    description:
      "Common questions about financial advice, Chartered Financial Planners, investments, pensions, and working with an independent financial adviser in Sheffield.",
  },
};
      ...
      questions: [
        {
          ...
          answer:
            "Chartered Financial Planner is the gold standard qualification in financial planning, awarded by the Chartered Insurance Institute (CII). It represents the highest level of professional achievement in our industry. To hold Chartered status, a firm must demonstrate that its advisers hold advanced level qualifications, commit to ongoing professional development, and adhere to a strict code of ethical conduct. Not all financial advisers hold this distinction — it sets us apart from the majority of firms.",
        },
        {
          question: "What does a financial adviser do?",
          answer:
            "A financial adviser helps you make informed decisions about your money. We analyse your current financial situation, understand your goals, and create personalised strategies for wealth management, investments, pensions, tax planning, estate planning, and protection. We also provide ongoing support and adjust your plan as your circumstances change.",
        },
        {
          question: "Why should I use an independent financial adviser?",
          answer:
            "Independent financial advisers (IFAs) like Hamnett Wealth Management are not tied to any product provider. This means we can recommend the best solutions from the entire market, rather than being limited to a specific company's products. Our advice is based solely on what's best for you.",
        },
        {
          question: "Are you regulated?",
          answer:
            "Yes, Hamnett Wealth Management is authorised and regulated by the Financial Conduct Authority (FCA). We are also Chartered Financial Planners. This means we adhere to the strictest professional standards, and you're protected by the Financial Services Compensation Scheme (FSCS) and have access to the Financial Ombudsman Service if needed.",
        },
        {
          question: "Do you offer a free initial consultation?",
          answer:
            "Yes, we offer a complimentary initial consultation with no obligation. This meeting allows us to understand your situation and goals, while you can get to know our Chartered team and decide if we're the right fit for your needs. There's no pressure to proceed with any paid services.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "We generally work with clients who have investable assets of £50,000 or more, or those making regular contributions. However, we're happy to discuss your situation as every client is different.",
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Yes, Inheritance Tax (IHT) planning is a key part of our estate planning service. We can help you structure your assets and make use of exemptions and reliefs to potentially reduce the IHT liability on your estate, protecting your wealth for future generations.",
        },
      ],
    },
    {
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              Chartered status, services, and how we can help you achieve your
              financial goals.
            </p>
          </div>
        </div>
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            our Chartered Financial Planners in Sheffield.
          </p>
          <Link href="/hamnett-wealth/contact" className="btn-accent">
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              is a firm of Chartered Financial Planners. The information on this page is
              for general guidance only and does not constitute financial advice. Individual
