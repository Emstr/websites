...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Hamnett Wealth Management. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Conduct Authority (FCA). We are a firm of Chartered Financial Planners,
              holding the highest professional qualification in financial planning.
              Our office is located in Sheffield, South Yorkshire.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li><strong>Research and analysis:</strong> Our Chartered team analyses your situation and researches suitable options from the market</li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              reviews, portfolio monitoring, and access to your Chartered adviser
              throughout the year.
            </p>
