              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select id="service" name="service" className="form-input">
                    ...
                    <option value="ifa">Independent Financial Advice</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Keeley & Co contacting me regarding my enquiry. I
                    understand my data will be processed in accordance with the{" "}
                    <a href="/keeley-financial-advisers/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
