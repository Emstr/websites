...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Keeley & Co. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Authority (FCA). Our office is at 6 St Pauls Terrace, Northwood St,
              Birmingham B3 1TH. We have been providing independent financial advice
              since 1928.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Independent financial advice</li>
              <li>Life planning</li>
