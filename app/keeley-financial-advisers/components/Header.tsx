...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/keeley-financial-advisers" },
    { name: "Services", href: "/keeley-financial-advisers/services" },
    { name: "About", href: "/keeley-financial-advisers/about" },
    { name: "FAQ", href: "/keeley-financial-advisers/faq" },
    { name: "Contact", href: "/keeley-financial-advisers/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Jewellery Quarter, Birmingham</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/keeley-financial-advisers" className="flex items-center gap-3">
