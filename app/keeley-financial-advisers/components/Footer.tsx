        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/keeley-financial-advisers/services" className="footer-link">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/keeley-financial-advisers/about" className="footer-link">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/keeley-financial-advisers/contact" className="footer-link">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/keeley-financial-advisers/faq" className="footer-link">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/keeley-financial-advisers/privacy" className="footer-link">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/keeley-financial-advisers/terms" className="footer-link">
                  Terms of Business
                </Link>
              </li>
            </ul>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>
              &copy; {currentYear} Keeley & Co. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link href="/keeley-financial-advisers/privacy" className="hover:text-accent transition-colors">
                Privacy Policy
              </Link>
              <Link href="/keeley-financial-advisers/terms" className="hover:text-accent transition-colors">
                Terms of Business
              </Link>
            </div>
          </div>
