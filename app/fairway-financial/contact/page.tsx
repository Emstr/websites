...
export const metadata: Metadata = {
  ...
  description:
    "Contact Fairway Financial Planning for independent financial advice. Visit our Birmingham office or call 07946 540727 for a free consultation.",
  openGraph: {
    title: "Contact Us | Fairway Financial Planning",
    description:
      "Book a free consultation with our experienced financial advisers. Call 07946 540727 or visit our Birmingham office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Birmingham office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Edgbaston, Birmingham</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Fairway Financial Planning contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/fairway-financial/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Birmingham, West Midlands</h3>
                  </div>
                </div>
                ...
                <p className="text-sm text-gray-500">
                  Family-run firm serving clients across Birmingham and West Midlands
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">07946 540727</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">chris@fairwayfinancial.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              Reference: 998733). Initial consultations are provided free of charge
