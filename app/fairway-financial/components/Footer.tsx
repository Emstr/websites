        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              Birmingham and West Midlands since 1995. Over 30 years of trusted
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <span>FCA Regulated (Ref: 998733)</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/fairway-financial/services" className="footer-link">
                  Pensions
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/fairway-financial/about" className="footer-link">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/fairway-financial/contact" className="footer-link">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/fairway-financial/faq" className="footer-link">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/fairway-financial/privacy" className="footer-link">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/fairway-financial/terms" className="footer-link">
                  Terms of Business
                </Link>
              </li>
            </ul>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                ...
                >
                  ...
                  chris@fairwayfinancial.co.uk
                </a>
              </div>
              <div className="pt-2 text-sm text-gray-400">
                <p>Family-run since 1995</p>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="bg-primary/50 rounded-sm p-4 text-sm text-gray-300">
            <p className="mb-2">
              <strong className="text-white">Important Information:</strong> Fairway Financial Consultants is authorised and regulated by the Financial Conduct
              Authority (FCA Reference: 998733).
            </p>
            <p>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>
              &copy; {currentYear} Fairway Financial Planning. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link href="/fairway-financial/privacy" className="hover:text-accent transition-colors">
                Privacy Policy
              </Link>
              <Link href="/fairway-financial/terms" className="hover:text-accent transition-colors">
                Terms of Business
              </Link>
            </div>
          </div>
