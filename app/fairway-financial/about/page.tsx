...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Fairway Financial Planning - a family-run independent financial advisory firm serving Birmingham and West Midlands since 1995. 30+ years experience, whole-of-market advice, FCA regulated.",
  openGraph: {
    title: "About Us | Fairway Financial Planning",
    description:
      "Family-run independent financial advisers providing whole-of-market advice from Birmingham since 1995. Over 30 years of trusted guidance.",
  },
};
        ...
        <div className="container-width relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              in Birmingham, West Midlands. Whole-of-market expertise you can trust.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">
                A Family Firm Since 1995
              </h2>
              <div className="gold-line mb-6"></div>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Fairway Financial Planning was founded in 1995 with a clear
                ...
                Birmingham&apos;s most trusted financial advisory practices,
            ...
            <div>
              <div className="relative h-80 rounded-sm overflow-hidden shadow-xl mb-8">
                <Image
                  ...
                  alt="Fairway Financial Planning - Family-run since 1995"
                  fill
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Birmingham office has been our home since 1995. Conveniently
              located for clients across Birmingham and wider West Midlands.
            </p>
          </div>
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Fairway Financial Planning is authorised and regulated by the
              Financial Conduct Authority (FCA Reference: 998733). This means we
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how Fairway Financial
