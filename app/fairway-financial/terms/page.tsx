...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Fairway Financial Planning Limited. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Fairway Financial Planning Limited is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              office is in Birmingham, West Midlands.
            </p>
            <p className="text-gray-600 mb-6">
