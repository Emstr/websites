...
export const metadata: Metadata = {
  ...
  description:
    "Contact Independent Financial Solutions for independent financial advice. Visit our Preston office or call 01772 860 760 for a free consultation.",
  openGraph: {
    title: "Contact Us | Independent Financial Solutions",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01772 860 760 or visit our Preston office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Preston office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Preston</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Independent Financial Solutions contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/ifs-preston/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Preston, Lancashire</h3>
                  </div>
                </div>
                <address className="not-italic text-gray-700 mb-4">
                  <strong>Independent Financial Solutions</strong>
                  <br />
                  Preston, Lancashire
                </address>
                ...
                <p className="text-sm text-gray-500">
                  Family-run firm serving clients across Preston and Lancashire
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01772 860 760</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">info@ifs-sp.com</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width py-8">
          ...
          <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden">
            <iframe
              ...
              title="Independent Financial Solutions - Preston, Lancashire"
            ></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Independent Financial Solutions is
