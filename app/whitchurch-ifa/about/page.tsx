...
export const metadata: Metadata = {
  title: "About Us | Independent Financial Adviser in Cardiff",
  description: "Learn about Whitchurch IFA - established independent financial adviser in Cardiff. FCA regulated, providing personal financial planning and wealth management.",
  openGraph: {
    title: "About Us | Whitchurch IFA",
    description: "Established independent financial adviser providing personal financial planning in Cardiff.",
  },
};
      ...
      <section className="hero-gradient py-20 lg:py-28">
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">Directly authorised independent financial adviser in Whitchurch, Cardiff. Personal, honest financial guidance for individuals and families across South Wales.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container-width">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">Personal Financial Advice in Cardiff</h2>
              <div className="gold-line mb-6"></div>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">Whitchurch IFA was established to provide genuine, personal financial advice to individuals and families across Cardiff and South Wales. We believe that everyone deserves access to quality financial guidance, delivered with honesty and transparency.</p>
            ...
            <div className="bg-gray-50 p-8 lg:p-12 rounded-sm">
              <div className="grid grid-cols-2 gap-8">
                ...
                <div className="text-center p-6 bg-white rounded-sm shadow-sm"><div className="stat-number">150+</div><p className="text-gray-600 mt-2 font-medium">Satisfied Clients</p></div>
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="gold-line-center mb-6"></div>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">Whitchurch IFA is authorised and regulated by the Financial Conduct Authority (FCA). This means we adhere to the highest standards of professional conduct and our clients benefit from the protections provided by the Financial Services Compensation Scheme (FSCS).</p>
          </div>
        </div>
      </section>
