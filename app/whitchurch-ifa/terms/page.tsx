...
export const metadata: Metadata = {
  ...
  description: "Terms of Business for Whitchurch IFA. Understand our client agreement, services, and regulatory information.",
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">Whitchurch IFA is authorised and regulated by the Financial Conduct Authority (FCA). You can check our regulatory status on the FCA Register at register.fca.org.uk.</p>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">Whitchurch IFA<br />Cardiff<br />Phone: 029 2000 9479<br />Email: info@whitchurchifa.co.uk</address>
          </div>
        </div>
      </section>
    </>
