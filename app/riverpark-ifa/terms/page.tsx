...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Riverpark Investment & Financial Consultants Limited. Understand our client agreement, services, and regulatory information. FCA Ref: 455480.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Reference Number is 455480. Our Company Registration Number is
              SC220303. Our office is at Suite 3 (1-6), 4 Rogart Street, Glasgow
              G40 2AA. Our registered address is 145 St Vincent Street, Glasgow
              G2 5JF.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Pensions, including retirement income strategies</li>
              <li>Investments and savings planning</li>
              <li>Life assurance and protection planning</li>
              <li>Mortgages for residential and buy-to-let properties</li>
              <li>Estate management and Inheritance Tax planning</li>
              <li>Corporate financial advice and workplace pension solutions</li>
            </ul>
            <p className="text-gray-600 mb-6">
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Riverpark Investment & Financial Consultants Limited
              <br />
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Riverpark Investment & Financial Consultants Limited
              <br />
              Suite 3 (1-6), 4 Rogart Street, Glasgow G40 2AA
              <br />
              ...
              Email: enquiries@riverparkifa.com
              <br />
              FCA Reference Number: 455480
              <br />
              Company Registration Number: SC220303
            </address>
          </div>
        </div>
      </section>
