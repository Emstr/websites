...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/riverpark-ifa" },
    { name: "Services", href: "/riverpark-ifa/services" },
    { name: "About", href: "/riverpark-ifa/about" },
    { name: "FAQ", href: "/riverpark-ifa/faq" },
    { name: "Contact", href: "/riverpark-ifa/contact" },
  ];
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Glasgow</span>
            </div>
          </div>
        </div>
      </div>
