...
export const metadata: Metadata = {
  title: "Financial Services | Pensions, Investments, Mortgages & More",
  description:
    "Comprehensive financial planning services including pensions, investments & savings, life assurance, mortgages, estate management and corporate advice. Independent advisers in Glasgow.",
  openGraph: {
    title: "Financial Services | Riverpark IFA Glasgow",
    description:
      "Expert financial advice from FCA regulated advisers. Pensions, investments, life assurance, mortgages, estate management and corporate advice in Glasgow.",
  },
};
  ...
  const services = [
    {
      ...
      description:
        "Whether you're just starting to save for retirement or approaching pension age, our expert advisers can help you make the most of your pension savings. With over 30 years of experience each, we provide clear, jargon-free pension advice tailored to your circumstances.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our investment planning service is designed to help you build and grow your wealth in line with your financial goals and risk tolerance. We take a comprehensive approach, considering your entire financial picture before recommending suitable investment and savings strategies.",
      features: [
    ...
    },
    {
      ...
      description:
        "Life assurance and protection planning ensures your loved ones are financially secure, whatever life brings. We help you understand your protection needs and find the right cover at the right price from across the whole market.",
      features: [
    ...
    },
    {
      id: "mortgages",
      title: "Mortgages",
      subtitle: "Find Your Perfect Home Loan",
      description:
        "Whether you're a first-time buyer, moving home, or looking to remortgage, our experienced advisers will search the whole market to find the mortgage that's right for you. We make the process straightforward and stress-free.",
      features: [
    ...
    },
    {
      ...
      subtitle: "Protect and Pass On Your Wealth",
      description:
        "Effective estate management ensures your wealth is protected and passed on to the right people in the most tax-efficient way. Our advisers work with you to develop strategies that safeguard your legacy for future generations.",
      features: [
        "Inheritance Tax planning and mitigation",
        "Will planning guidance and trusts",
    ...
    },
    {
      ...
      description:
        "We help businesses of all sizes with their financial planning needs. From workplace pension schemes to group protection policies, we provide expert advice to help you attract and retain talent while meeting your obligations.",
      features: [
        "Workplace pension scheme setup and management",
        "Auto-enrolment compliance and administration",
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              circumstances across Glasgow and Scotland.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              As independent financial advisers with over 30 years of individual
              experience, we have access to the whole of the market, allowing us
              to find the best solutions for your needs. All our advice is
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:08007836783" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
