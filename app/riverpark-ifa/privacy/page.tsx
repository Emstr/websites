...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Riverpark Investment & Financial Consultants Limited. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Riverpark Investment & Financial Consultants Limited (&quot;we&quot;, &quot;us&quot;,
            ...
            <p className="text-gray-600 mb-6">
              Riverpark Investment & Financial Consultants Limited is the data
              controller for personal information collected through our services and
