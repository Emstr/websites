...
export const metadata: Metadata = {
  title: "About Us | Independent Financial Advisers in Derby",
  description:
    "Learn about Derbyshire IFA - an independent financial advisory firm serving Derby and Derbyshire. Whole-of-market advice, FCA regulated.",
  openGraph: {
    title: "About Us | Derbyshire IFA",
    description:
      "Independent financial advisers providing whole-of-market advice in Derby and Derbyshire. Trusted guidance from Derbyshire IFA.",
  },
};
        ...
        <div className="container-width relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6">
              Your Trusted Financial Partners in Derbyshire
            </h1>
            <p className="text-xl text-gray-200 leading-relaxed">
              Independent financial advice from a trusted firm
              in Derby, Derbyshire. Whole-of-market expertise you can rely on.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">
                About Derbyshire IFA
              </h2>
              <div className="gold-line mb-6"></div>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Derbyshire IFA was established with a clear
                mission: to provide honest, independent financial advice that puts
                clients first. We have grown into one of
                Derbyshire&apos;s most trusted financial advisory practices,
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center p-6 bg-gray-50 rounded-sm shadow-sm">
                  ...
                  <p className="text-gray-600 mt-2 font-medium">FCA Reference</p>
                </div>
                <div className="text-center p-6 bg-gray-50 rounded-sm shadow-sm">
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Derbyshire office is conveniently
              located for clients across Derby and wider Derbyshire.
            </p>
          </div>
            ...
            <div className="bg-gray-50 p-8 lg:p-12 rounded-sm border-t-4 border-accent">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Experienced independent advisers
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-accent" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Derbyshire Independent Financial Advisers LLP is authorised and regulated by the
              Financial Conduct Authority (FCA Reference: 624915). This means we
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how Derbyshire IFA
