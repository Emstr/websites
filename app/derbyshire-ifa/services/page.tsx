...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive whole-of-market financial advice including pensions, investments, mortgages, protection and estate planning from Derbyshire IFA in Derby.",
  openGraph: {
    title: "Financial Services | Derbyshire IFA",
    description:
      "Whole-of-market independent financial advice from FCA regulated advisers. Pensions, investments, mortgages, protection and estate planning in Derby.",
  },
};
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01283703007" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 01283 703007
            </a>
          </div>
        </div>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              Conduct Authority (FCA Reference: 624915). The value of investments can go down as well as up, and
