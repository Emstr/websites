...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Derbyshire Independent Financial Advisers LLP. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Derbyshire Independent Financial Advisers LLP is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              office is in 24 The Green, Findern, Derby, Derbyshire, DE65 6AA.
            </p>
            <p className="text-gray-600 mb-6">
