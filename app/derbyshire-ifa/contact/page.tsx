...
export const metadata: Metadata = {
  ...
  description:
    "Contact Derbyshire IFA for independent financial advice. Visit our Derby office or call 01283 703007 for a free consultation.",
  openGraph: {
    title: "Contact Us | Derbyshire IFA",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01283 703007 or visit our Derby office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Derby office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Derby</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Derbyshire IFA contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/derbyshire-ifa/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Derby, Derbyshire</h3>
                  </div>
                </div>
                ...
                <p className="text-sm text-gray-500">
                  Independent financial advisers serving clients across Derby and Derbyshire.
                  We also offer telephone and video consultations.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01283 703007</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">enquiries@derbyshireifa.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Derbyshire Independent Financial Advisers LLP is
              authorised and regulated by the Financial Conduct Authority (FCA
              Reference: 624915). Initial consultations are provided free of charge
