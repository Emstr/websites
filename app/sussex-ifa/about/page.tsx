...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Sussex Independent Financial Advisers - a family-run independent financial advisory firm serving Hailsham and East Sussex since 1994. 30+ years experience, whole-of-market advice, FCA regulated.",
  openGraph: {
    title: "About Us | Sussex Independent Financial Advisers",
    description:
      "Family-run independent financial advisers providing whole-of-market advice from Hailsham since 1994. Over 30 years of trusted guidance.",
  },
};
        ...
        <div className="container-width relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              in Hailsham, East Sussex. Whole-of-market expertise you can trust.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Sussex Independent Financial Advisers was founded in 1994 with a clear
                ...
                Hailsham&apos;s most trusted financial advisory practices,
            ...
            <div>
              <div className="relative h-80 rounded-sm overflow-hidden shadow-xl mb-8">
                <Image
                  ...
                  alt="Sussex Independent Financial Advisers - Family-run since 1994"
                  fill
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Hailsham office has been our home since 1994. Conveniently
              located for clients across Hailsham and wider East Sussex.
            </p>
          </div>
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Sussex Independent Financial Advisers is authorised and regulated by the
              Financial Conduct Authority (FCA Reference: 207490). This means we
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how Sussex IFA
