...
export const metadata: Metadata = {
  ...
  description:
    "Contact Sussex Independent Financial Advisers for independent financial advice. Visit our Hailsham office or call 01323 441788 for a free consultation.",
  openGraph: {
    title: "Contact Us | Sussex Independent Financial Advisers",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01323 441788 or visit our Hailsham office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Hailsham office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Hailsham</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Sussex Independent Financial Advisers contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/sussex-ifa/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Hailsham, East Sussex</h3>
                  </div>
                </div>
                ...
                <p className="text-sm text-gray-500">
                  Family-run firm serving clients across Hailsham and East Sussex
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01323 441788</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">reception@sussexifa.com</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              Reference: 207490). Initial consultations are provided free of charge
