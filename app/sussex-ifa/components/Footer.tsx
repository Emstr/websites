        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              Hailsham and East Sussex since 1994. Over 30 years of trusted
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <span>FCA Regulated (Ref: 207490)</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/sussex-ifa/services" className="footer-link">
                  Pensions
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/sussex-ifa/about" className="footer-link">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/sussex-ifa/contact" className="footer-link">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/sussex-ifa/faq" className="footer-link">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/sussex-ifa/privacy" className="footer-link">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/sussex-ifa/terms" className="footer-link">
                  Terms of Business
                </Link>
              </li>
            </ul>
        ...
        <div className="container-width py-6">
          <div className="bg-primary/50 rounded-sm p-4 text-sm text-gray-300">
            <p className="mb-2">
              ...
              Authority (FCA Reference: 207490).
            </p>
            <p>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>
              &copy; {currentYear} Sussex Independent Financial Advisers. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link href="/sussex-ifa/privacy" className="hover:text-accent transition-colors">
                Privacy Policy
              </Link>
              <Link href="/sussex-ifa/terms" className="hover:text-accent transition-colors">
                Terms of Business
              </Link>
            </div>
          </div>
