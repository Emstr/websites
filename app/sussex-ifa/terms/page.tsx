...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Sussex Independent Financial Advisers Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Sussex Independent Financial Advisers Ltd is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              office is in Hailsham, East Sussex.
            </p>
            <p className="text-gray-600 mb-6">
