...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive whole-of-market financial advice including pensions, investments, mortgages, protection and estate planning from Sussex Independent Financial Advisers in Hailsham.",
  openGraph: {
    title: "Financial Services | Sussex Independent Financial Advisers",
    description:
      "Whole-of-market independent financial advice from FCA regulated advisers. Pensions, investments, mortgages, protection and estate planning in Hailsham.",
  },
};
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              in Hailsham and East Sussex since 1994.
            </p>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  ...
                  <Link href="/sussex-ifa/contact" className="btn-accent">
                    Discuss Your Needs
                  </Link>
                </div>
                <div
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01323441788" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 01323 441788
            </a>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Sussex Independent Financial Advisers Ltd trading as
              Sussex Independent Financial Advisers is authorised and regulated by the Financial
