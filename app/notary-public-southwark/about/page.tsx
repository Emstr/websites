...
export const metadata: Metadata = {
  title: 'About',
  description: 'Learn about Notary Public Southwark, part of Kuddus Solicitors. Professional notarial services in Southwark, London.',
};

const areas = [
  { name: 'Southwark', primary: true },
  { name: 'Borough', primary: false },
  { name: 'Elephant & Castle', primary: false },
  { name: 'London Bridge', primary: false },
  { name: 'Bermondsey', primary: false },
  { name: 'Peckham', primary: false },
  { name: 'Camberwell', primary: false },
];
...
export default function AboutPage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-gradient-to-br from-[#4a3728] to-[#2d221a] text-white py-20">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Notary Public Southwark is part of Kuddus Solicitors, providing professional
                  notarial services to businesses and individuals across South London and beyond.
                </p>

                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Our convenient Southwark location offers excellent transport links, making us
                  easily accessible for clients from London Bridge, Borough, Elephant & Castle,
                  and surrounding areas.
                </p>

                <h2 className="text-2xl font-bold text-[#4a3728] mt-10 mb-4">
                  Our Approach
                </h2>
            ...
            <div className="lg:col-span-1">
              {/* Areas Served */}
              <div className="bg-gradient-to-br from-[#4a3728] to-[#2d221a] rounded-xl p-6 text-white mb-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h3 className="text-xl font-bold text-[#4a3728] mb-4">Get in Touch</h3>
                <div className="space-y-3 text-gray-600">
                  <a href="tel:02072475476" className="flex items-center gap-3 hover:text-[#c9a227] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                    020 7247 5476
                  </a>
                  <a href="mailto:reception@kuddussolicitors.com" className="flex items-center gap-3 hover:text-[#c9a227] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#4a3728] mb-6">Our Fees</h2>
            <div className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <div className="border-t border-gray-100 pt-6 space-y-4 text-left">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#c9a227] mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              ...
              <Link
                ...
                className="mt-8 inline-block bg-[#4a3728] hover:bg-[#2d221a] text-white px-8 py-4 rounded-lg font-semibold transition-colors"
              >
                Get Instant Quote
              </Link>
            </div>
