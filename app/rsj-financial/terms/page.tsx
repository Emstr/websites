...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for RSJ Financial Planning. Understand our client agreement, services, fees, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Conduct Authority (FCA). We operate from two offices in Liverpool,
              Merseyside, and have been providing independent financial advice since
              1986.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Mortgage advice (first-time buyer, remortgage, buy-to-let)</li>
              <li>Protection planning (life assurance, critical illness, income protection)</li>
              <li>Tax-efficient investing (ISAs, pensions)</li>
            </ul>
            <p className="text-gray-600 mb-6">
