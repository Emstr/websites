...
export const metadata: Metadata = {
  title: "Financial Services | Pensions, Investments, Mortgages & Protection",
  description:
    "Comprehensive financial planning services in Liverpool including pensions, investments, mortgages, protection, and tax planning. Independent advice from FCA regulated advisers.",
  openGraph: {
    title: "Financial Services | RSJ Financial Planning",
    description:
      "Expert financial advice from FCA regulated advisers in Liverpool. Pensions, investments, mortgages, protection, and tax planning.",
  },
};
  ...
  const services = [
    {
      ...
      subtitle: "Your Complete Financial Roadmap",
      description:
        "Our comprehensive financial planning service brings together every aspect of your financial life into one cohesive strategy. Whether you are saving for a specific goal, planning for retirement, or simply want to make the most of your money, we create a personalised plan that evolves with you.",
      features: [
        "Full financial health assessment and cash flow modelling",
        "Goal-based planning for short, medium, and long-term objectives",
        "Regular reviews and plan adjustments as life changes",
        "Estate and succession planning",
        "Coordination with your accountant and solicitor",
        "Ongoing support and guidance throughout your financial journey",
      ],
      icon: (
    ...
    },
    {
      ...
      description:
        "Whether you are just starting to save for retirement or approaching pension age, our expert advisers can help you make the most of your pension savings. With nearly 40 years of experience, we provide clear, jargon-free advice on all aspects of pension planning.",
      features: [
    ...
    },
    {
      id: "mortgages",
      title: "Mortgages",
      subtitle: "Find the Right Home Loan",
      description:
        "Whether you are a first-time buyer, moving home, remortgaging, or looking at buy-to-let, our whole-of-market mortgage advice ensures you get the best deal. We handle the complexity so you can focus on finding your perfect home.",
      features: [
        "First-time buyer guidance and affordability advice",
        "Remortgage and product transfer advice",
        "Buy-to-let and portfolio landlord mortgages",
        "Specialist lending (self-employed, adverse credit)",
    ...
    },
    {
      ...
      description:
        "Protection planning ensures your loved ones are financially secure, whatever life brings. We help you understand your protection needs and find the right cover at the right price, giving you peace of mind for the years ahead.",
      features: [
    ...
    },
    {
      ...
      description:
        "Effective tax planning can make a significant difference to your wealth over time. Our advisers work with you to develop strategies that legally minimise your tax burden while maximising your returns.",
      features: [
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              From pensions and investments to mortgages and protection, we
              provide expert financial advice tailored to your unique
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01513632027" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 0151 363 2027
            </a>
          </div>
        </div>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              authorised and regulated by the Financial Conduct Authority. The value of
