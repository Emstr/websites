...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/bartlett-wealth" },
    { name: "Services", href: "/bartlett-wealth/services" },
    { name: "About", href: "/bartlett-wealth/about" },
    { name: "FAQ", href: "/bartlett-wealth/faq" },
    { name: "Contact", href: "/bartlett-wealth/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Est. 1940</span>
              <span className="hidden sm:block">|</span>
              <span className="hidden sm:block">Leeds &bull; London &bull; Manchester</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/bartlett-wealth" className="flex items-center gap-3">
