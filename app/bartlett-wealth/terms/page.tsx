...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Bartlett Wealth Management Limited. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Bartlett Wealth Management Limited is authorised and regulated
              by the Financial Conduct Authority (FCA No. 114800). We are part of
              the Bartlett Group, a third-generation family business established in
              1940. Our registered office is at Broadway Hall, Horsforth, Leeds LS18
              4RS. We also maintain offices in London and Manchester.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Retirement planning and pension consolidation</li>
              <li>Investment advice (whole of market)</li>
              ...
              <li>Employee benefits and workplace pensions</li>
            </ul>
            <p className="text-gray-600 mb-6">
