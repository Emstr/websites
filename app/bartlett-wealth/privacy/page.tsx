...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Bartlett Wealth Management Limited. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Bartlett Wealth Management Limited (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;), part of
              the Bartlett Group, is committed to protecting your privacy and handling
              your personal data responsibly. This Privacy Policy explains how we
              collect, use, store, and protect your personal information in accordance
            ...
            <p className="text-gray-600 mb-6">
              ...
              (FCA No. 114800), we are also subject to additional data protection
            ...
            <p className="text-gray-600 mb-6">
              Bartlett Wealth Management Limited is the data controller for
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Bartlett Wealth Management Limited
              <br />
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Other companies within the Bartlett Group where necessary</li>
