...
export const metadata: Metadata = {
  ...
  description:
    "Contact Cornerstone Financial Planning for independent financial advice. Visit our Witney office or call 01993 213 429 for a free consultation.",
  openGraph: {
    title: "Contact Us | Cornerstone Financial Planning",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01993 213 429 or visit our Witney office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Witney office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Witney</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Cornerstone Financial Planning contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/cornerstone-ifa/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Witney, Oxfordshire</h3>
                  </div>
                </div>
                ...
                <p className="text-sm text-gray-500">
                  Family-run firm serving clients across Witney and Oxfordshire
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01993 213 429</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">simon@cornerstoneifa.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              Reference: 624799). Initial consultations are provided free of charge
