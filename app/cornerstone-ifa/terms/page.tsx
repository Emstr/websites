...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Cornerstone Financial Planning. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
