...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/cornerstone-ifa" },
    { name: "Services", href: "/cornerstone-ifa/services" },
    { name: "About", href: "/cornerstone-ifa/about" },
    { name: "FAQ", href: "/cornerstone-ifa/faq" },
    { name: "Contact", href: "/cornerstone-ifa/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              <span className="flex items-center gap-1">
                ...
                FCA Regulated (Ref: 624799)
              </span>
              <span className="hidden sm:block">|</span>
              <span className="hidden sm:block">Est. 1992 | Oxfordshire</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/cornerstone-ifa" className="flex items-center gap-3">
