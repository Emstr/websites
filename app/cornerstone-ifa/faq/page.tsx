...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about financial planning, investments, pensions, mortgages and our services. Get answers from Cornerstone Financial Planning.",
  openGraph: {
    title: "FAQ | Cornerstone Financial Planning",
    description:
  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Independent financial advisers (IFAs) like Cornerstone Financial Planning are not tied to any product provider. This means we can recommend the best solutions from the entire market, rather than being limited to a specific company's products. Our whole-of-market access ensures our advice is based solely on what's best for you.",
        },
        {
          question: "Are you regulated?",
          answer:
            "Yes, Cornerstone Financial Planning is authorised and regulated by the Financial Conduct Authority (FCA). This means we adhere to strict professional standards, and you're protected by the Financial Services Compensation Scheme (FSCS) and have access to the Financial Ombudsman Service if needed.",
        },
        {
        ...
        {
          question: "How long has Cornerstone Financial Planning been operating?",
          answer:
            "We were founded in 1994, giving us over 30 years of experience in providing independent financial advice to clients across Witney and Oxfordshire. As a family-run firm, our long heritage demonstrates our stability and commitment to client service.",
        },
      ],
    },
    {
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              and how Cornerstone Financial Planning can help you achieve your financial goals.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            our experienced advisers at our Witney office or by phone.
          </p>
          <Link href="/cornerstone-ifa/contact" className="btn-accent">
