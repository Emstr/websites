...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Harold Stephens Financial Planning. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Harold Stephens Financial Planning is authorised and regulated
              by the Financial Conduct Authority (FCA). We are based in Bristol
              and serve clients across the South West of England, specialising
              in later life financial planning.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <p className="text-gray-600 mb-4">
              We specialise in later life financial planning and provide advice on
              the following areas:
            </p>
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Later life planning and retirement financial strategy</li>
              <li>Retirement income planning, including drawdown and annuities</li>
              <li>Equity release (lifetime mortgages and home reversion plans)</li>
              <li>Care fee planning and funding strategies</li>
              <li>Pension planning, consolidation, and transfers</li>
              <li>Investment management for retirees</li>
              <li>Inheritance tax planning and mitigation</li>
              <li>Estate planning and wealth transfer</li>
            </ul>
            <p className="text-gray-600 mb-6">
              We will assess your needs and objectives and recommend suitable
              solutions. For equity release, we will consider alternatives to
              releasing equity from your home and only recommend equity release
              where it is suitable for your circumstances.
            </p>
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                financial circumstances, objectives, and concerns. This meeting is
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>A percentage of the amount invested/transferred/released</li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              reviews, portfolio monitoring, and access to your adviser throughout
              the year.
            </p>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6">
              <p className="text-gray-700 font-medium mb-2">Equity Release Risk Warning:</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                <li>
                  Equity release is a lifetime mortgage or home reversion plan
                </li>
                <li>
                ...
                <li>
                  ...
                  and rolled up over time, meaning the total amount owed increases
                </li>
                <li>
                  A home reversion plan involves selling all or part of your home
                  at below market value
                </li>
                <li>
                  You should consider all options before deciding on equity release,
                  including downsizing or other borrowing
                </li>
              </ul>
            </div>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Harold Stephens Financial Planning
              <br />
              Bristol
              <br />
              South West England
