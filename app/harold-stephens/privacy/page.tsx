...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Harold Stephens Financial Planning. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Harold Stephens Financial Planning (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              Harold Stephens Financial Planning is the data controller for
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Health information (where relevant to protection or care fee advice)</li>
              <li>Family circumstances and dependants</li>
              <li>Property details and valuations (for equity release advice)</li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                To provide financial advice and services tailored to your later life needs
              </li>
              <li>To assess your suitability for financial products including equity release</li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                providers, equity release lenders) to implement our recommendations
              </li>
              ...
              <li>
                Professional advisers (solicitors, accountants) where necessary
              </li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              the advice relates to pensions, equity release, or other long-term products.
            </p>
