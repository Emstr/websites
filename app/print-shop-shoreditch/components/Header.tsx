...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/print-shop-shoreditch" },
    { name: "Services", href: "/print-shop-shoreditch/services" },
    { name: "About", href: "/print-shop-shoreditch/about" },
    { name: "FAQ", href: "/print-shop-shoreditch/faq" },
    { name: "Contact", href: "/print-shop-shoreditch/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Shoreditch, EC2</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/print-shop-shoreditch" className="flex items-center gap-3">
          ...
          <div className="hidden lg:block">
            <Link
              href="/print-shop-shoreditch/contact"
