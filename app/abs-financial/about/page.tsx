...
export const metadata: Metadata = {
  ...
  description:
    "Learn about ABS Financial Planning - a family-run independent financial advisory firm serving Southampton and Hampshire since 1994. 30+ years experience, whole-of-market advice, FCA regulated.",
  openGraph: {
    title: "About Us | ABS Financial Planning",
    description:
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                ABS Financial Planning was founded in 1994 with a clear
            ...
            <div>
              <div className="relative h-80 rounded-sm overflow-hidden shadow-xl mb-8">
                <Image
                  ...
                  alt="ABS Financial Planning - Family-run since 1994"
                  fill
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              ABS Financial Planning is authorised and regulated by the
              Financial Conduct Authority (FCA Reference: 150285). This means we
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how ABS Financial Planning
