        ...
        <div className="container-width relative z-10">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link
                href="/abs-financial/contact"
                className="btn-accent text-lg"
              >
                Schedule Consultation
              </Link>
              <Link
                href="/abs-financial/services"
        ...
        <div className="container-width">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-4">
              ...
              <p className="text-xs text-gray-500 mt-1">Ref: 150285</p>
            </div>
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                For over 30 years, ABS Financial Planning has been providing
            ...
            <div className="relative h-80 rounded-sm overflow-hidden shadow-xl">
              <Image
                ...
                alt="ABS Financial Planning - Trusted since 1994"
                fill
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-premium p-8">
              ...
              <Link href="/abs-financial/services" className="text-accent font-semibold hover:text-accent-700 inline-flex items-center gap-2">
                Learn More
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
          ...
          <div className="text-center mt-12">
            <Link href="/abs-financial/services" className="btn-primary">
              View All Services
            </Link>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Founded in 1994, ABS Financial Planning has been providing
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      (Ref: 150285), providing you with complete peace of mind and FSCS protection.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="testimonial-card">
              <p className="text-gray-600 mb-6 italic">
                &quot;ABS Financial have managed our pensions and investments
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="location-card">
              ...
              <address className="not-italic text-gray-700 mb-4">
                <strong>ABS Financial Planning</strong>
                <br />
              ...
              <div className="space-y-3 mb-6">
                ...
                >
                  ...
                  <span className="font-semibold">023 8033 3099</span>
                </a>
                <a
                ...
                >
                  ...
                  <span className="font-semibold">advice@absfinancial.co.uk</span>
                </a>
              </div>
              <Link
                href="/abs-financial/contact"
            ...
            <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden shadow-lg">
              <iframe
                ...
                title="ABS Financial Planning - Southampton, Hampshire"
              ></iframe>
            </div>
          </div>
        </div>
        ...
        <div className="container-width">
          <div className="bg-white rounded-sm shadow-2xl p-8 lg:p-16 text-center border-t-4 border-accent">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/abs-financial/contact" className="btn-accent">
        ...
        <div className="container-width">
          <div className="fca-notice">
            <div className="flex items-start gap-4">
              ...
              />
              <p>
                <strong>Important Notice:</strong> ABS Financial Planning is
                authorised and regulated by the Financial Conduct Authority (FCA
                Reference: 150285). The value of investments can go down as well as
