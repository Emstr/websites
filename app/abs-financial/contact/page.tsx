...
export const metadata: Metadata = {
  ...
  description:
    "Contact ABS Financial Planning for independent financial advice. Visit our Southampton office or call 023 8033 3099 for a free consultation.",
  openGraph: {
    title: "Contact Us | ABS Financial Planning",
    description:
      "Book a free consultation with our experienced financial advisers. Call 023 8033 3099 or visit our Southampton office.",
  },
};
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to ABS Financial Planning contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/abs-financial/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">023 8033 3099</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">advice@absfinancial.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              Reference: 150285). Initial consultations are provided free of charge
