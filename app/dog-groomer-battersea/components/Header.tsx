...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/dog-groomer-battersea" },
    { name: "Services", href: "/dog-groomer-battersea/services" },
    { name: "About", href: "/dog-groomer-battersea/about" },
    { name: "FAQ", href: "/dog-groomer-battersea/faq" },
    { name: "Contact", href: "/dog-groomer-battersea/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Battersea, SW11</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/dog-groomer-battersea" className="flex items-center gap-3">
          ...
          <div className="hidden lg:block">
            <Link
              href="/dog-groomer-battersea/contact"
