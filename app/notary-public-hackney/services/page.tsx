...
export const metadata: Metadata = {
  ...
  description: 'Professional notary public services in Hackney, London. Business and individual document authentication, apostille and legalisation services.',
};
...
export default function ServicesPage() {
  return (
    <>
      ...
      <section id="business" className="py-20 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#2d4a3e]">Business Services</h2>
          </div>

          <div className="grid md:grid-cols-2 gap-4">
            {businessServices.map((service, index) => (
              <div key={index} className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                <svg className="w-5 h-5 text-[#d4af37] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
      ...
      <section id="individual" className="py-20 bg-gray-50 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#2d4a3e]">Individual Services</h2>
          </div>
      ...
      {/* CTA */}
      <section className="py-16 bg-[#2d4a3e] text-white">
