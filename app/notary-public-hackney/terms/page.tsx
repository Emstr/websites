...
export const metadata: Metadata = {
  ...
  description: 'Terms of business and complaints procedure for Notary Public Hackney.',
};
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl font-bold text-[#2d4a3e] mt-6 mb-4">Fees & Charges</h2>
            ...
            <h2 className="text-2xl font-bold text-[#2d4a3e] mt-10 mb-4">Notary Responsibilities</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#2d4a3e] mt-10 mb-4">Legal Advice Limitations</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#2d4a3e] mt-10 mb-4">Payment Terms</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#2d4a3e] mt-10 mb-4">Regulatory Authority</h2>
            <p className="text-gray-600 mb-6">
            ...
            <div id="complaints" className="scroll-mt-24">
              <h2 className="text-2xl font-bold text-[#2d4a3e] mt-10 mb-4">Complaints Procedure</h2>
              <p className="text-gray-600 mb-4">
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#2d4a3e]">
                  <h3 className="font-semibold text-[#2d4a3e] mb-2">Step 1: Contact Us</h3>
                  ...
                  <p className="text-gray-600 mt-2">
                    Email: <a href="mailto:reception@kuddussolicitors.com" className="text-[#d4af37] hover:underline">reception@kuddussolicitors.com</a><br />
                    Phone: <a href="tel:02072475476" className="text-[#d4af37] hover:underline">020 7247 5476</a>
                  </p>
                </div>

                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#1a2e26]">
                  <h3 className="font-semibold text-[#2d4a3e] mb-2">Step 2: The Notaries Society</h3>
                  <p className="text-gray-600">
                ...
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#d4af37]">
                  <h3 className="font-semibold text-[#2d4a3e] mb-2">Step 3: Legal Ombudsman</h3>
                  <p className="text-gray-600">
