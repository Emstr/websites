...
export const metadata: Metadata = {
  ...
  description: 'Privacy notice for Notary Public Hackney. How we collect, use, and protect your personal data.',
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-8">
              <strong>Notary Public Hackney</strong> (part of Kuddus Solicitors) is committed to protecting your privacy
              and handling your personal data responsibly.
            </p>

            <h2 className="text-2xl font-bold text-[#2d4a3e] mt-10 mb-4">Personal Data We Collect</h2>
            ...
            <h2 className="text-2xl font-bold text-[#2d4a3e] mt-10 mb-4">How We Use Your Information</h2>
            ...
            <h2 className="text-2xl font-bold text-[#2d4a3e] mt-10 mb-4">Your Rights</h2>
            ...
            <h2 className="text-2xl font-bold text-[#2d4a3e] mt-10 mb-4">Contact Us</h2>
            <p className="text-gray-600 mb-4">
            ...
            <address className="text-gray-600 not-italic mb-6">
              Notary Public Hackney<br />
              Kuddus Solicitors<br />
              Hackney, London E8<br />
