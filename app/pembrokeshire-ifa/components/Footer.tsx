        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Independent financial advice from an established practice serving
              Pembroke, Pembrokeshire and across Wales. Trusted guidance for your
              financial future.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/pembrokeshire-ifa/services" className="footer-link">
                  Pensions
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/pembrokeshire-ifa/about" className="footer-link">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/pembrokeshire-ifa/contact" className="footer-link">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/pembrokeshire-ifa/faq" className="footer-link">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/pembrokeshire-ifa/privacy" className="footer-link">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/pembrokeshire-ifa/terms" className="footer-link">
                  Terms of Business
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2 text-sm text-gray-400">
                <p>Established practice</p>
                <p>Serving clients across Wales</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="bg-primary/50 rounded-sm p-4 text-sm text-gray-300">
            <p className="mb-2">
              <strong className="text-white">Important Information:</strong> Pembrokeshire
              Financial Services is authorised and regulated by the Financial Conduct
              Authority.
            </p>
            <p>
        ...
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            ...
            <div className="flex items-center gap-6">
              <Link href="/pembrokeshire-ifa/privacy" className="hover:text-accent transition-colors">
                Privacy Policy
              </Link>
              <Link href="/pembrokeshire-ifa/terms" className="hover:text-accent transition-colors">
                Terms of Business
              </Link>
            </div>
          </div>
