...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Pembrokeshire Financial Services. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Pembrokeshire Financial Services is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              office is in Pembroke, Pembrokeshire.
            </p>
            <p className="text-gray-600 mb-6">
