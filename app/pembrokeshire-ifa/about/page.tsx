...
export const metadata: Metadata = {
  title: "About Us | Independent Financial Advisers in Pembrokeshire",
  description:
    "Learn about Pembrokeshire Financial Services - an established independent financial advisory practice serving Pembroke and across Wales. Whole-of-market advice, FCA regulated.",
  openGraph: {
    title: "About Us | Pembrokeshire Financial Services",
    description:
      "Established independent financial advisers providing whole-of-market advice from Pembroke, Pembrokeshire. Trusted guidance across Wales.",
  },
};
        ...
        <div className="container-width relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              An established independent financial advisory practice based in
              Pembroke, Pembrokeshire. Whole-of-market expertise you can trust.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">
                An Established Practice in Wales
              </h2>
              <div className="gold-line mb-6"></div>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Pembrokeshire Financial Services was established with a clear
                mission: to provide honest, independent financial advice that puts
                clients first. Over the years, we have grown into one of
                Pembrokeshire&apos;s most trusted financial advisory practices,
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                financial planning, offering a breadth of knowledge that ensures
                every client receives the best possible guidance for their
                circumstances.
              </p>
            ...
            <div>
              <div className="relative h-80 rounded-sm overflow-hidden shadow-xl mb-8">
                <div className="w-full h-full bg-gradient-to-br from-primary via-secondary to-primary flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-24 h-24 bg-accent/20 rounded-full flex items-center justify-center mx-auto mb-4">
                      <span className="text-accent font-bold text-4xl font-serif">P</span>
                    </div>
                    <p className="text-white/80 text-lg font-serif">Pembrokeshire Financial Services</p>
                    <p className="text-accent text-sm mt-2">Pembroke, Wales</p>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center p-6 bg-gray-50 rounded-sm shadow-sm">
                  ...
                  <p className="text-gray-600 mt-2 font-medium">Wales Covered</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                We treat every client as an individual. We take time to understand your
                personal circumstances, goals, and concerns before making any
                recommendations.
              </p>
            </div>
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                Our team brings together extensive experience in financial services,
                with specialist knowledge in pensions, investments, mortgages,
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                ...
                built on doing the right thing for our clients, every time.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">
              Based in Pembroke, Pembrokeshire
            </h2>
            <div className="gold-line-center mb-6"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Pembroke office is conveniently located for clients across
              Pembrokeshire and wider Wales.
            </p>
          </div>
            ...
            <div className="bg-gray-50 p-8 lg:p-12 rounded-sm border-t-4 border-accent">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-primary">Pembroke, Pembrokeshire</h3>
                </div>
              </div>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Our established office serves clients across Pembrokeshire and
                all of Wales. We offer a welcoming, professional environment for
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Serving Pembrokeshire &amp; all of Wales
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              ...
              Financial Conduct Authority. This means we adhere to the highest
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how Pembrokeshire
            Financial Services can help you achieve your financial goals.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/pembrokeshire-ifa/contact" className="btn-accent">
