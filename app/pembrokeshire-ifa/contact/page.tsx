...
export const metadata: Metadata = {
  ...
  description:
    "Contact Pembrokeshire Financial Services for independent financial advice. Visit our Pembroke office or call 01646 687767 for a free consultation.",
  openGraph: {
    title: "Contact Us | Pembrokeshire Financial Services",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01646 687767 or visit our Pembroke office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Pembroke office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Pembroke</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Pembrokeshire Financial Services contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/pembrokeshire-ifa/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Pembroke, Pembrokeshire</h3>
                  </div>
                </div>
                <address className="not-italic text-gray-700 mb-4">
                  <strong>Pembrokeshire Financial Services</strong>
                  <br />
                ...
                <p className="text-sm text-gray-500">
                  Family-run firm serving clients across Pembroke and Pembrokeshire
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01646 687767</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">info@pfs-ifa.com</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width py-8">
          ...
          <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden">
            <iframe
              ...
              title="Pembrokeshire Financial Services - Pembroke, Pembrokeshire"
            ></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Pembrokeshire Financial Services is
              authorised and regulated by the Financial Conduct Authority (FCA
              Reference: FCA Regulated). Initial consultations are provided free of charge
