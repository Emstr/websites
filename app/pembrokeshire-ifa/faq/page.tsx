...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about financial planning, investments, pensions, mortgages and our services. Get answers from Pembrokeshire Financial Services.",
  openGraph: {
    title: "FAQ | Pembrokeshire Financial Services",
    description:
  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Independent financial advisers (IFAs) like Pembrokeshire Financial Services are not tied to any product provider. This means we can recommend the best solutions from the entire market, rather than being limited to a specific company's products. Our whole-of-market access ensures our advice is based solely on what's best for you.",
        },
        {
          question: "Are you regulated?",
          answer:
            "Yes, Pembrokeshire Financial Services is authorised and regulated by the Financial Conduct Authority (FCA). This means we adhere to strict professional standards, and you're protected by the Financial Services Compensation Scheme (FSCS) and have access to the Financial Ombudsman Service if needed.",
        },
        {
        ...
        {
          question: "How long has Pembrokeshire Financial Services been operating?",
          answer:
            "We were founded in 1994, giving us over 30 years of experience in providing independent financial advice to clients across Pembroke and Pembrokeshire. As a family-run firm, our long heritage demonstrates our stability and commitment to client service.",
        },
      ],
    },
    {
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              and how Pembrokeshire Financial Services can help you achieve your financial goals.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            our experienced advisers at our Pembroke office or by phone.
          </p>
          <Link href="/pembrokeshire-ifa/contact" className="btn-accent">
