...
export const metadata: Metadata = {
  title: "FAQ | Financial Planning & Tax Planning Questions Answered",
  description:
    "Frequently asked questions about financial planning, tax planning, investments, pensions, and our services. Get answers from The Abram Partnership in Cardiff.",
  openGraph: {
    title: "FAQ | The Abram Partnership",
    description:
      "Common questions about financial advice, tax planning, investments, pensions, and working with an independent financial adviser in Cardiff.",
  },
};
  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Independent financial advisers (IFAs) like The Abram Partnership are not tied to any product provider. This means we can recommend the best solutions from the entire market, rather than being limited to a specific company's products. Our advice is based solely on what's best for you.",
        },
        {
          question: "Are you regulated?",
          answer:
            "Yes, The Abram Partnership is authorised and regulated by the Financial Conduct Authority (FCA). This means we adhere to strict professional standards, and you're protected by the Financial Services Compensation Scheme (FSCS) and have access to the Financial Ombudsman Service if needed.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "The Abram Partnership was established in 1992 in Cardiff. We have over 30 years of experience providing independent financial advice and specialist tax planning services to clients across Cardiff and Wales.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          question: "What makes your tax planning service special?",
          answer:
            "Tax planning is our core specialism. With over 30 years of experience, we have developed deep expertise in tax-efficient financial strategies. We stay ahead of all legislative changes and use a comprehensive approach covering ISAs, pensions, VCTs, EIS, Capital Gains Tax, and Inheritance Tax to ensure your finances are optimally structured.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Yes, Inheritance Tax (IHT) planning is a key part of our service. We can help you structure your assets and make use of exemptions and reliefs to potentially reduce the IHT liability on your estate. This is closely linked to our estate planning service.",
        },
        {
          question: "Can you help with tax planning for my business?",
          answer:
            "Absolutely. We provide specialist tax planning advice for business owners, including extraction strategies, pension contributions, and business-related tax reliefs. Our 30+ years of experience in Cardiff means we understand the needs of Welsh businesses particularly well.",
        },
      ],
    },
    {
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              Find answers to common questions about financial planning, tax
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            one of our expert advisers at our Cardiff office.
          </p>
          <Link href="/abram-partnership/contact" className="btn-accent">
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> The Abram Partnership is
