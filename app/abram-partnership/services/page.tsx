...
export const metadata: Metadata = {
  title: "Financial Services | Tax Planning, Pensions, Investments & More",
  description:
    "Comprehensive financial planning services from The Abram Partnership. Tax planning specialists, pensions, investments, mortgages, protection, estate planning and wealth management in Cardiff.",
  openGraph: {
    title: "Financial Services | The Abram Partnership",
    description:
      "Expert financial advice from FCA regulated advisers. Tax planning specialists with 30+ years experience in Cardiff, Wales.",
  },
};
  ...
  const services = [
    {
      id: "tax-planning",
      title: "Tax Planning",
      subtitle: "Our Core Specialism",
      description:
        "Tax planning is at the heart of what we do. With over 30 years of specialist experience, we develop strategies that legally minimise your tax burden while maximising your returns. Our Cardiff-based team stays ahead of every change in tax legislation to ensure your finances are always optimally structured.",
      features: [
        "ISA planning and bed & ISA strategies",
        "Capital Gains Tax planning and mitigation",
        "Inheritance Tax strategies and estate structuring",
        "VCT and EIS investment advice",
        "Income tax planning for higher and additional rate payers",
        "Business owner tax planning and extraction strategies",
        "Pension tax relief optimisation",
        "Tax-efficient investment portfolio construction",
      ],
      icon: (
    ...
    },
    {
      id: "mortgages",
      title: "Mortgages",
      subtitle: "Find Your Best Deal",
      description:
        "As independent mortgage advisers, we search the whole of the market to find the most suitable mortgage for your circumstances. Whether you are a first-time buyer, moving home, remortgaging, or investing in buy-to-let, we can help.",
      features: [
        ...
        "Large and complex mortgage applications",
      ],
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description:
        "Estate planning is about ensuring your wealth passes to the right people in the most tax-efficient way. We work with you to develop strategies that protect your assets and minimise inheritance tax liability.",
      features: [
        "Inheritance Tax planning and mitigation",
        "Trust planning and administration",
        "Will and estate review coordination",
    ...
    },
    {
      ...
      description:
        "Our wealth management service brings together all aspects of your financial life into one cohesive strategy. Ideal for individuals and families seeking comprehensive, ongoing financial oversight.",
      features: [
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              From our specialist tax planning to pensions, investments, and
              estate management, we provide expert financial advice tailored to
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Expert Financial Advice Since 1992
            </h2>
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            how our 30+ years of experience can help you achieve them.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/abram-partnership/contact" className="btn-accent">
              Book Free Consultation
            </Link>
            <a href="tel:02920693700" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 029 2069 3700
            </a>
          </div>
        </div>
