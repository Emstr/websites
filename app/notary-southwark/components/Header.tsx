...
export default function Header() {
  ...
  return (
    <header className="bg-[#34495e] text-white sticky top-0 z-50">
            ...
            <div className="space-y-1">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="block px-3 py-2 text-base font-medium text-gray-200 hover:text-white hover:bg-[#2c3e50] rounded-md"
