...
export const metadata: Metadata = {
  ...
  description: 'Terms of business and complaints procedure for Notary Southwark.',
};
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl font-bold text-[#34495e] mt-6 mb-4">Fees & Charges</h2>
            ...
            <h2 className="text-2xl font-bold text-[#34495e] mt-10 mb-4">Notary Responsibilities</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#34495e] mt-10 mb-4">Legal Advice Limitations</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#34495e] mt-10 mb-4">Payment Terms</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#34495e] mt-10 mb-4">Regulatory Authority</h2>
            <p className="text-gray-600 mb-6">
            ...
            <div id="complaints" className="scroll-mt-24">
              <h2 className="text-2xl font-bold text-[#34495e] mt-10 mb-4">Complaints Procedure</h2>
              <p className="text-gray-600 mb-4">
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#34495e]">
                  <h3 className="font-semibold text-[#34495e] mb-2">Step 1: Contact Us</h3>
                ...
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#2c3e50]">
                  <h3 className="font-semibold text-[#34495e] mb-2">Step 2: The Notaries Society</h3>
                  <p className="text-gray-600">
                ...
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#e74c3c]">
                  <h3 className="font-semibold text-[#34495e] mb-2">Step 3: Legal Ombudsman</h3>
                  <p className="text-gray-600">
