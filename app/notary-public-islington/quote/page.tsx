...
export default function QuotePage() {
  ...
  if (showQuote) {
    return (
      <>
        {/* Hero */}
        <section className="bg-gradient-to-br from-[#16213e] to-[#0f3460] text-white py-16">
        ...
        <section className="py-16">
          <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              {/* Quote Result */}
              <div className="bg-gradient-to-br from-[#16213e] to-[#0f3460] p-8 text-white text-center">
              ...
              {/* Quote Breakdown */}
              <div className="p-8">
                <h3 className="font-semibold text-[#16213e] mb-4">Quote Breakdown</h3>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="border-t pt-3 mt-3 flex justify-between font-semibold">
                    <span>Total</span>
                    <span className="text-[#e94560]">£{quote}</span>
                  </div>
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  <Link
                    href="/contact"
                    className="flex-1 bg-[#e94560] hover:bg-[#d63d56] text-white text-center px-6 py-3 rounded-lg font-semibold transition-colors"
                  >
                    Book Appointment
                  </Link>
                  <a
                    href="tel:02072782800"
                    className="flex-1 border-2 border-[#16213e] text-[#16213e] hover:bg-[#16213e] hover:text-white text-center px-6 py-3 rounded-lg font-semibold transition-colors"
                  >
                    Call Now
                  </a>
                </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            {step === 1 && (
              <div>
                <h2 className="text-2xl font-bold text-[#16213e] mb-2">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <svg className="w-6 h-6 text-[#16213e]" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z" />
                      </svg>
                      <span className="font-semibold text-[#16213e]">Business</span>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="font-semibold text-[#16213e]">Individual</span>
                    </div>
                    <p className="text-sm text-gray-600">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <button
                        ...
                        className="w-10 h-10 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-[#e94560] transition-colors"
                      >
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12h-15" />
                        </svg>
                      </button>
                      <span className="text-3xl font-bold text-[#16213e] w-12 text-center">
                        {data.documentCount}
                      </span>
                      <button
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-start gap-3 p-4 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-gray-300 transition-colors">
                      <input
                        ...
                        className="mt-1 w-5 h-5 text-[#e94560] rounded border-gray-300 focus:ring-[#e94560]"
                      />
                      <div>
                        <span className="font-medium text-[#16213e]">Apostille</span>
                        <p className="text-sm text-gray-600">
                    ...
                    <label className="flex items-start gap-3 p-4 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-gray-300 transition-colors">
                      ...
                      />
                      <div>
                        <span className="font-medium text-[#16213e]">Embassy Legalisation</span>
                        <p className="text-sm text-gray-600">
            ...
            {step === 3 && (
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  You can visit our office in Islington, or we can come to you.
                </p>
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="font-semibold text-[#16213e]">Visit our office</span>
                      <span className="ml-auto text-sm text-green-600 font-medium">No extra charge</span>
                    </div>
                    <p className="text-sm text-gray-600">
                      12 Angel Gate, 326 City Road, Islington, London EC1V 2PT
                    </p>
                  </button>
                  <button
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="font-semibold text-[#16213e]">Home or office visit</span>
                      <span className="ml-auto text-sm text-[#e94560] font-medium">+£{PRICING.visitFee}</span>
                    </div>
                    <p className="text-sm text-gray-600">
            ...
            {step === 4 && (
              <div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <span className="font-semibold text-[#16213e]">Standard</span>
                      <span className="ml-auto text-sm text-green-600 font-medium">No extra charge</span>
                    </div>
                    <p className="text-sm text-gray-600">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <span className="font-semibold text-[#16213e]">Urgent (Next Day)</span>
                      <span className="ml-auto text-sm text-[#e94560] font-medium">+£{PRICING.urgentSurcharge}</span>
                    </div>
                    <p className="text-sm text-gray-600">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <span className="font-semibold text-[#16213e]">Same Day</span>
                      <span className="ml-auto text-sm text-[#e94560] font-medium">+£{PRICING.sameDaySurcharge}</span>
                    </div>
                    <p className="text-sm text-gray-600">
              ...
              <div>
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-[#e94560]">£{quote}</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="mt-8 flex justify-between">
              {step > 1 ? (
                <button
                  onClick={prevStep}
                  className="px-6 py-3 text-gray-600 hover:text-[#16213e] font-medium transition-colors"
                >
                  ← Back
                </button>
              ) : (
