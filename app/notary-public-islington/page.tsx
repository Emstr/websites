...
const services = [
  {
    ...
    href: '/notary-public-islington/businesses',
    icon: (
  ...
  },
  {
    ...
    href: '/notary-public-islington/individuals',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/notary-public-islington/businesses#apostille',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#16213e] to-[#0f3460] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Notary Public Services in Islington
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/notary-public-islington/about"
                className="border-2 border-white hover:bg-white hover:text-[#16213e] px-8 py-4 rounded-lg text-lg font-semibold transition-colors text-center"
              >
                Learn More
              </Link>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#16213e] mb-4">
              Our Services
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-[#16213e] mb-3">
                  {service.title}
                </h3>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-[#16213e] mb-6">
                About Esther Ogun
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                I am a Notary Public based in Islington, London EC1. I hold a Post-graduate
            ...
            <div className="bg-gradient-to-br from-[#16213e] to-[#0f3460] rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-semibold mb-6">Areas Served</h3>
              <p className="text-gray-300 mb-6">
                I provide notary services across Islington and surrounding London boroughs:
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="border-2 border-white hover:bg-white hover:text-[#16213e] px-8 py-4 rounded-lg text-lg font-semibold transition-colors"
            >
              Call: 020 7278 2800
            </a>
          </div>
