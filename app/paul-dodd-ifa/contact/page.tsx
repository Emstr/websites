...
export const metadata: Metadata = {
  title: "Contact Us | Book a Pension & Financial Consultation",
  description:
    "Contact Paul Dodd Asset Management for expert pension and financial advice. Visit our Leeds office or arrange a London meeting. Call 0113 2300449 for a free consultation.",
  openGraph: {
    title: "Contact Us | Paul Dodd Asset Management",
    description:
      "Book a free consultation with our expert pension and wealth management advisers. Call 0113 2300449.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Leeds office or arrange a meeting in London. We&apos;re here to
              help with your pension, investment and financial planning needs.
            </p>
          </div>
        </div>
      </section>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="leeds">Leeds Office - 18 Wynmore Avenue</option>
                    <option value="london">London Meeting (by appointment)</option>
                ...
                <div>
                  ...
                  <select id="service" name="service" className="form-input">
                    ...
                    <option value="tax">Taxation Planning</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Paul Dodd Asset Management Limited contacting
                    me regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/paul-dodd-ifa/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
            ...
            <div>
              ...
              <div className="location-card mb-8">
                ...
                <address className="not-italic text-gray-700 mb-4">
                  <strong>Paul Dodd Asset Management Limited</strong>
                  <br />
                  18 Wynmore Avenue
                  <br />
                  Leeds
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Kensington, London</h3>
                  </div>
                </div>
                <p className="text-gray-600 mb-4">
                  We regularly visit London to meet with our Kensington-based
                  clients. Please get in touch to arrange a convenient appointment.
                </p>
                <p className="text-sm text-gray-500">
                  In-person London meetings and video consultations available by arrangement.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">0113 2300449</p>
                      <p className="text-sm text-gray-500">
                  ...
                  <a
                    href="mailto:info@pauldodd.co.uk"
                    className="flex items-center gap-3 text-gray-700 hover:text-accent transition-colors"
                  >
                    <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center">
                      <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <p className="font-semibold">info@pauldodd.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
      ...
      <section className="bg-gray-100">
        <div className="container-width py-8">
          <h2 className="text-2xl font-bold text-primary mb-6 text-center">
            Find Our Leeds Office
          </h2>
          <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2355.5!2d-1.6362!3d53.8321!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTPCsDQ5JzU1LjYiTiAxwrAzOCcxMC4zIlc!5e0!3m2!1sen!2suk!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Paul Dodd Asset Management Leeds Office Location"
            ></iframe>
          </div>
        </div>
      </section>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              Limited is authorised and regulated by the Financial Conduct Authority. Initial
