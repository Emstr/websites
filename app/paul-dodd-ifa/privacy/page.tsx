...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Paul Dodd Asset Management Limited. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Paul Dodd Asset Management Limited (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              Paul Dodd Asset Management Limited is the data controller for
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Health information (where relevant to annuity or protection advice)</li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                including pension, investment and annuity advice
              </li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>
                ...
                of special category data (such as health information for enhanced
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                providers, annuity providers) to implement our recommendations
              </li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              the advice relates to pensions, annuities or other long-term products.
            </p>
