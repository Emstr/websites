...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Paul Dodd Asset Management Limited. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Paul Dodd Asset Management Limited is authorised and regulated
              by the Financial Conduct Authority (FCA). Our registered office is at
              18 Wynmore Avenue, Leeds LS16 9DE.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Pension planning, including retirement income strategies, drawdown and transfers</li>
              <li>Annuity advice, including enhanced and impaired life annuities</li>
              <li>Wealth management for individuals and families</li>
              <li>Investment planning and portfolio management</li>
              <li>Taxation planning, including ISAs, CGT and IHT strategies</li>
            </ul>
            <p className="text-gray-600 mb-6">
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>
                ...
                and research suitable options from the market, with particular
                focus on pension and annuity optimisation where relevant
              </li>
              <li>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <li>
                  Transferring out of a defined benefit pension scheme may not be
                  in your best interests
                </li>
                <li>
                  Annuity rates are not guaranteed until the point of purchase and
                  may vary
                </li>
              </ul>
            </div>
