...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Chris Lunt Independent Financial Adviser. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Chris Lunt Independent Financial Adviser is authorised and regulated
              by the Financial Conduct Authority (FCA). Our office is based in
              Lydiate, Liverpool, Merseyside, and we serve clients across Liverpool,
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Independent financial advice across all areas</li>
            </ul>
            <p className="text-gray-600 mb-6">
              As an independent financial adviser, Chris is not restricted in the range
              of products he can recommend. He will assess your needs and objectives
            ...
            <p className="text-gray-600 mb-4">
              Chris&apos;s advice process is personal and hands-on at every stage:
            </p>
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                <strong>Initial meeting with Chris:</strong> Chris personally
                gathers information about your financial circumstances, objectives,
                and attitude to risk
              </li>
              <li>
                <strong>Research and analysis:</strong> Chris analyses your situation
                and researches suitable options from the whole market
              </li>
              <li>
                <strong>Recommendations:</strong> Chris provides a written suitability
                report explaining his recommendations and why they are suitable for
                you
              </li>
              <li>
                <strong>Implementation:</strong> With your authority, Chris implements
                the agreed recommendations
              </li>
              <li>
                <strong>Ongoing service:</strong> Chris provides regular personal
            ...
            <p className="text-gray-600 mb-6">
              Chris will always explain his fees clearly before undertaking any work.
              Charges may include:
            </p>
            ...
            <p className="text-gray-600 mb-6">
              For clients who opt for ongoing review service, we charge an annual
              fee, typically a percentage of assets under advice. This covers regular
              personal reviews with Chris, portfolio monitoring, and direct access to
            ...
            <p className="text-gray-600 mb-6">
              ...
              your investment/policy. Chris will confirm the payment method before
              commencing work.
            </p>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Chris Lunt Independent Financial Adviser
              <br />
              Lydiate, Liverpool
              <br />
              Merseyside
