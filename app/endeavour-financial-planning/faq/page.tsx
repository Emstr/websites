...
export const metadata: Metadata = {
  ...
  description: "Frequently asked questions about financial planning, investments, pensions, and our services. Get answers from Endeavour Financial Planning.",
  openGraph: { title: "FAQ | Endeavour Financial Planning", description: "Common questions about financial advice, investments, pensions, and working with an independent financial adviser." },
};
...
export default function FAQPage() {
  const faqs = [
    { category: "About Our Services", questions: [
      ...
      { question: "Are you regulated?", answer: "Yes, Endeavour Financial Planning is authorised and regulated by the Financial Conduct Authority (FCA). You're protected by the Financial Services Compensation Scheme (FSCS) and have access to the Financial Ombudsman Service." },
        ...
        <div className="container-width">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/endeavour-financial-planning/contact" className="btn-accent">Contact Us</Link>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p><strong>Important Notice:</strong> Endeavour Financial Planning is authorised and regulated by the Financial Conduct Authority. The information on this page is for general guidance only.</p>
          </div>
        </div>
      </section>
    </>
