...
export const metadata: Metadata = {
  ...
  description: "Terms of Business for Endeavour Financial Planning. Understand our client agreement, services, and regulatory information.",
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">Endeavour Financial Planning is authorised and regulated by the Financial Conduct Authority (FCA). You can check our regulatory status on the FCA Register at register.fca.org.uk.</p>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">Endeavour Financial Planning<br />Wirral<br />Phone: 0151 346 2218<br />Email: info@endeavourfp.co.uk</address>
          </div>
        </div>
      </section>
    </>
