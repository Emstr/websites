...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for Endeavour Financial Planning. Learn how we collect, use, and protect your personal information.",
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">Endeavour Financial Planning (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is committed to protecting your privacy and handling your personal data responsibly. This Privacy Policy explains how we collect, use, store, and protect your personal information in accordance with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018.</p>

            <h2 className="text-2xl font-bold text-primary mb-4 mt-10">2. Data Controller</h2>
            <p className="text-gray-600 mb-6">Endeavour Financial Planning is the data controller for personal information collected through our services and website.</p>
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">Endeavour Financial Planning<br />Wirral<br />Email: info@endeavourfp.co.uk<br />Phone: 0151 346 2218</address>
