...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/recruitment-city" },
    { name: "Services", href: "/recruitment-city/services" },
    { name: "About", href: "/recruitment-city/about" },
    { name: "FAQ", href: "/recruitment-city/faq" },
    { name: "Contact", href: "/recruitment-city/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">City of London</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/recruitment-city" className="flex items-center gap-3">
