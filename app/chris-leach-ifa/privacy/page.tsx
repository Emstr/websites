...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Chris Leach and Associates Limited. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Chris Leach and Associates Limited (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              ...
              (FCA Reference Number: 563997), we are also subject to additional data
            ...
            <p className="text-gray-600 mb-6">
              Chris Leach and Associates Limited is the data controller for
