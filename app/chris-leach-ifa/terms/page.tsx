...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Chris Leach and Associates Limited. Understand our client agreement, services, and regulatory information. FCA Ref: 563997.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Financial Conduct Authority (FCA). Our FCA Reference Number is 563997
              and our Company Number is 1752622. Our registered office is at Telynfa,
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Pension planning, including transfers and drawdown</li>
              <li>Tax-efficient investing (ISAs, pension contributions)</li>
              <li>Financial reviews and ongoing planning</li>
            </ul>
            <p className="text-gray-600 mb-6">
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Chris Leach and Associates Limited
              <br />
              Telynfa, Main Road, Gwaelod-y-Garth
              <br />
              Cardiff CF15 9HJ
              <br />
              Phone: 029 2081 4070
