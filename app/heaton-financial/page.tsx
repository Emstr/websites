        ...
        <div className="container-width relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
              ...
              planning in Exeter and Devon.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link
                href="/heaton-financial/contact"
                className="btn-accent text-lg"
              >
                Schedule Consultation
              </Link>
              <Link
                href="/heaton-financial/services"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                For over 30 years, Heaton Financial has been providing
                independent financial advice to families and businesses in Exeter
                and across Devon. As a family-run firm, we understand that trust is
            ...
            <div className="relative h-80 rounded-sm overflow-hidden shadow-xl">
              <Image
                ...
                alt="Heaton Financial - Trusted since 1994"
                fill
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-premium p-8">
              ...
              <Link href="/heaton-financial/services" className="text-accent font-semibold hover:text-accent-700 inline-flex items-center gap-2">
                Learn More
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
          ...
          <div className="text-center mt-12">
            <Link href="/heaton-financial/services" className="btn-primary">
              View All Services
            </Link>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Founded in 1994, Heaton Financial has been providing
                whole-of-market independent financial advice to clients across
                Exeter and Devon for over three decades. As a family-run
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Over 30 years serving the Exeter community as a family business,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="testimonial-card">
              <p className="text-gray-600 mb-6 italic">
                &quot;Heaton Financial have managed our pensions and investments
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Retired Teacher, Exeter</p>
                </div>
              </div>
            </div>
            ...
            <div className="testimonial-card">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">NHS Professional, Devon</p>
                </div>
              </div>
            </div>
            ...
            <div className="testimonial-card">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Business Owner, Devon</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <div className="gold-line-center mb-6"></div>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our Exeter office provides a welcoming environment for
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="location-card">
              ...
              <address className="not-italic text-gray-700 mb-4">
                <strong>Heaton Financial</strong>
                <br />
                Exeter, Devon
              </address>
              <div className="space-y-3 mb-6">
                <a
                  href="tel:01392258252"
                ...
                >
                  ...
                  <span className="font-semibold">01392 258252</span>
                </a>
                <a
                  href="mailto:info@heatonfinancial.co.uk"
                  className="flex items-center gap-2 text-gray-700 hover:text-accent transition-colors"
                >
                  <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span className="font-semibold">info@heatonfinancial.co.uk</span>
                </a>
              </div>
              <Link
                href="/heaton-financial/contact"
            ...
            <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden shadow-lg">
              <iframe
                ...
                title="Heaton Financial - Exeter, Devon"
              ></iframe>
            </div>
          </div>
        </div>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <div className="flex items-start gap-4">
              ...
              />
              <p>
                <strong>Important Notice:</strong> Heaton Financial is
