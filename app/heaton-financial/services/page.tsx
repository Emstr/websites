...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive whole-of-market financial advice including pensions, investments, mortgages, protection and estate planning from Heaton Financial in Exeter.",
  openGraph: {
    title: "Financial Services | Heaton Financial",
    description:
      "Whole-of-market independent financial advice from FCA regulated advisers. Pensions, investments, mortgages, protection and estate planning in Exeter.",
  },
};
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              in Exeter and Devon since 1994.
            </p>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  ...
                  <Link href="/heaton-financial/contact" className="btn-accent">
                    Discuss Your Needs
                  </Link>
                </div>
                <div
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01392258252" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 01392 258252
            </a>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Heaton Financial Independent Financial Advisers Ltd trading as
              Heaton Financial is authorised and regulated by the Financial
