...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/heaton-financial" },
    { name: "Services", href: "/heaton-financial/services" },
    { name: "About", href: "/heaton-financial/about" },
    { name: "FAQ", href: "/heaton-financial/faq" },
    { name: "Contact", href: "/heaton-financial/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              <span className="flex items-center gap-1">
                ...
                FCA Regulated (Ref: FCA Regulated)
              </span>
              <span className="hidden sm:block">|</span>
              <span className="hidden sm:block">Est. 1994 | Exeter</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/heaton-financial" className="flex items-center gap-3">
