...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/castlegate-financial" },
    { name: "Services", href: "/castlegate-financial/services" },
    { name: "About", href: "/castlegate-financial/about" },
    { name: "FAQ", href: "/castlegate-financial/faq" },
    { name: "Contact", href: "/castlegate-financial/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">7 East Midlands Offices</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/castlegate-financial" className="flex items-center gap-3">
