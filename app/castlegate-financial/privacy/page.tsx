...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Castlegate Financial Management Ltd. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Castlegate Financial Management Ltd (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              ...
              (FCA No. 169777), we are also subject to additional data protection
            ...
            <p className="text-gray-600 mb-6">
              Castlegate Financial Management Ltd is the data controller for
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Duncan & Toplis Group companies where necessary for service delivery</li>
