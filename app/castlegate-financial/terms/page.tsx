...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Castlegate Financial Management Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Castlegate Financial Management Ltd is authorised and regulated by
              the Financial Conduct Authority (FCA No. 169777). Our registered
              office is at 8 Castlegate, Grantham, Lincolnshire NG31 6SE.
              Registered in England & Wales (Company No. 2077374). We are part of
              the Duncan & Toplis Group.
            </p>
            <p className="text-gray-600 mb-6">
              We also maintain offices in Nottingham, Leicester, Lincoln, Skegness,
              Stamford, and Newark. You can check our regulatory status on the FCA
              Register at register.fca.org.uk or by contacting the FCA on 0800 111
              6768.
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Pension planning and retirement advice</li>
              <li>Investment planning and wealth management</li>
              <li>Protection (life assurance, critical illness, income protection)</li>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Castlegate Financial Management Ltd
              <br />
              8 Castlegate, Grantham, Lincs NG31 6SE
              <br />
              Phone: 01476 855 585
              <br />
              Email: info@casfin.co.uk
              <br />
              FCA No. 169777 | Company No. 2077374
            </address>
          </div>
        </div>
      </section>
