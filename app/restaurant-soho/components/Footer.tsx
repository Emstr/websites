        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Modern British cuisine in the heart of Soho. Seasonal menus, craft
              cocktails and unforgettable dining experiences on Dean Street.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/restaurant-soho/services" className="footer-link">
                  A La Carte Dining
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/restaurant-soho/about" className="footer-link">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/restaurant-soho/contact" className="footer-link">
                  Contact & Reservations
                </Link>
              </li>
              <li>
                <Link href="/restaurant-soho/faq" className="footer-link">
                  FAQ
                </Link>
              </li>
              <li>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>
              &copy; {currentYear} Soho Kitchen & Bar. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <span>Modern British, Soho Soul</span>
            </div>
          </div>
        </div>
      </div>
