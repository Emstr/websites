...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Aveton Gifford Associates Limited. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Aveton Gifford Associates Limited is a firm of Chartered Financial
              Planners, authorised and regulated by the Financial Conduct Authority
              (FCA). We are registered in Scotland under Company Number SC268741,
              incorporated in 2004.
            </p>
            <p className="text-gray-600 mb-6">
              Our head office is at 36 Cammo Road, Edinburgh EH4 8AP. We also
              maintain an office at Gartcolt Cottages, Gartgill Road, Coatbridge
              ML5 2EQ.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Tax mitigation and tax-efficient investing</li>
              <li>Retirement planning and cash flow modelling</li>
              <li>Whole-of-market reviews of existing arrangements</li>
            </ul>
            <p className="text-gray-600 mb-6">
              ...
              objectives and recommend suitable solutions from the whole of the market.
            </p>
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li><strong>Research and analysis:</strong> We analyse your situation and research suitable options from across the whole market</li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              reviews, portfolio monitoring, and access to your Chartered Financial
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Aveton Gifford Associates Limited
              <br />
              36 Cammo Road, Edinburgh EH4 8AP
              <br />
              Gartcolt Cottages, Gartgill Road, Coatbridge ML5 2EQ
              <br />
              Edinburgh: 0131 339 6508 | Coatbridge: 01236 872751
              <br />
              Email: enquiries@avetongiffordassociates.co.uk
              <br />
              Company registered in Scotland No. SC268741
            </address>
          </div>
        </div>
      </section>
