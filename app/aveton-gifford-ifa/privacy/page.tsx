...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Aveton Gifford Associates Limited. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Aveton Gifford Associates Limited (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              As a firm of Chartered Financial Planners authorised and regulated by the
              Financial Conduct Authority (FCA), we are also subject to additional data
            ...
            <p className="text-gray-600 mb-6">
              Aveton Gifford Associates Limited is the data controller for personal
