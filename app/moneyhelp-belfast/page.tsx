        ...
        <div className="container-width relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Nearly 30 Years of Trusted{" "}
              <span className="text-gold-gradient">Financial Advice</span>
            </h1>

            <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
              Independent financial advice from a firm you can trust.
              Financial planning, investments, mortgages, equity release,
              retirement planning and tax advice in Belfast and Northern Ireland.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link
                href="/moneyhelp-belfast/contact"
                className="btn-accent text-lg"
              >
                Schedule Consultation
              </Link>
              <Link
                href="/moneyhelp-belfast/services"
        ...
        <div className="container-width">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-4">
              ...
              <p className="text-xs text-gray-500 mt-1">Ref: 175588</p>
            </div>
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-xs text-gray-500 mt-1">Nearly 30 years experience</p>
            </div>
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center p-4">
              ...
              <p className="font-bold text-primary text-sm">Belfast Based</p>
              <p className="text-xs text-gray-500 mt-1">Serving Northern Ireland</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                For nearly 30 years, MoneyHelp has been providing
                independent financial advice to families and businesses in Belfast
                and across Northern Ireland. We understand that trust is
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                ...
                financial planning, investments, mortgages, equity release, retirement planning, or tax advice,
                our experienced team is here to guide you every step of the way.
              </p>
              <Link
                href="/moneyhelp-belfast/about"
            ...
            <div className="relative h-80 rounded-sm overflow-hidden shadow-xl">
              <Image
                ...
                alt="MoneyHelp - Trusted since 1995"
                fill
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-premium p-8">
              ...
              <Link href="/moneyhelp-belfast/services" className="text-accent font-semibold hover:text-accent-700 inline-flex items-center gap-2">
                Learn More
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
          ...
          <div className="text-center mt-12">
            <Link href="/moneyhelp-belfast/services" className="btn-primary">
              View All Services
            </Link>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Founded in 1995, MoneyHelp has been providing
                independent financial advice to clients across
                Belfast and Northern Ireland for nearly three decades. We pride ourselves on building lasting relationships
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      (Ref: 175588), providing you with complete peace of mind and FSCS protection.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Nearly 30 years serving the Belfast community,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="testimonial-card">
              <p className="text-gray-600 mb-6 italic">
                &quot;MoneyHelp have managed our pensions and investments
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Retired Teacher, Belfast</p>
                </div>
              </div>
            </div>
            ...
            <div className="testimonial-card">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">NHS Professional, Belfast</p>
                </div>
              </div>
            </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <div className="gold-line-center mb-6"></div>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our Belfast office provides a welcoming environment for
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="location-card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-primary">Belfast, Northern Ireland</h3>
                </div>
              </div>
              <address className="not-italic text-gray-700 mb-4">
                <strong>MoneyHelp</strong>
                <br />
                66-68 Holywood Road, Belfast, BT4 1NT
              </address>
              <div className="space-y-3 mb-6">
                ...
                >
                  ...
                  <span className="font-semibold">028 9065 6999</span>
                </a>
                <a
                ...
                >
                  ...
                  <span className="font-semibold">info@moneyhelp.co.uk</span>
                </a>
              </div>
              <Link
                href="/moneyhelp-belfast/contact"
            ...
            <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2312.0!2d-5.9301!3d54.5973!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTTCsDM1JzUwLjMiTiA1wrA1NSc0OC40Ilc!5e0!3m2!1sen!2suk!4v1"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="MoneyHelp - Belfast, Northern Ireland"
              ></iframe>
            </div>
          </div>
        </div>
        ...
        <div className="container-width">
          <div className="bg-white rounded-sm shadow-2xl p-8 lg:p-16 text-center border-t-4 border-accent">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Book a complimentary initial consultation at our Belfast office or
              by phone. We&apos;ll discuss your goals and how our experienced
              team can help you achieve them.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/moneyhelp-belfast/contact" className="btn-accent">
        ...
        <div className="container-width">
          <div className="fca-notice">
            <div className="flex items-start gap-4">
              ...
              />
              <p>
                <strong>Important Notice:</strong> Buchanan Johnston Flynn Limited trading as MoneyHelp is
                authorised and regulated by the Financial Conduct Authority (FCA
                Reference: 175588). The value of investments can go down as well as
