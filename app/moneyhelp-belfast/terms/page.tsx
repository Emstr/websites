...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Buchanan Johnston Flynn Limited trading as MoneyHelp in Belfast. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Buchanan Johnston Flynn Limited trading as MoneyHelp is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              office is in 66-68 Holywood Road, Belfast, BT4 1NT.
            </p>
            <p className="text-gray-600 mb-6">
