...
export const metadata: Metadata = {
  ...
  description:
    "Contact MoneyHelp for independent financial advice. Visit our Belfast office or call 028 9065 6999 for a free consultation.",
  openGraph: {
    title: "Contact Us | MoneyHelp",
    description:
      "Book a free consultation with our experienced financial advisers. Call 028 9065 6999 or visit our Belfast office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Belfast office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Belfast, BT4 1NT</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to MoneyHelp contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/moneyhelp-belfast/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Belfast, Northern Ireland</h3>
                  </div>
                </div>
                ...
                <p className="text-sm text-gray-500">
                  Serving clients across Belfast and Northern Ireland
                  since 1995. We also offer telephone and video consultations.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">028 9065 6999</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">info@moneyhelp.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> MoneyHelp is
              authorised and regulated by the Financial Conduct Authority (FCA
              Reference: 175588). Initial consultations are provided free of charge
