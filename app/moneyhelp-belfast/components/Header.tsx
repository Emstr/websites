...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/moneyhelp-belfast" },
    { name: "Services", href: "/moneyhelp-belfast/services" },
    { name: "About", href: "/moneyhelp-belfast/about" },
    { name: "FAQ", href: "/moneyhelp-belfast/faq" },
    { name: "Contact", href: "/moneyhelp-belfast/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              <span className="flex items-center gap-1">
                ...
                FCA Regulated (Ref: 175588)
              </span>
              <span className="hidden sm:block">|</span>
              <span className="hidden sm:block">Est. 1995 | Belfast</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/moneyhelp-belfast" className="flex items-center gap-3">
