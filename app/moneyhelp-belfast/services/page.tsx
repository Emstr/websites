...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive independent financial advice including financial planning, investments, mortgages, equity release, retirement planning and tax advice from MoneyHelp in Belfast.",
  openGraph: {
    title: "Financial Services | MoneyHelp Belfast",
    description:
      "Independent financial advice from FCA regulated advisers. Financial planning, investments, mortgages, equity release, retirement planning and tax advice in Belfast.",
  },
};
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              in Belfast and Northern Ireland since 1995.
            </p>
          </div>
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:02890656999" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 028 9065 6999
            </a>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Buchanan Johnston Flynn Limited trading as
              MoneyHelp is authorised and regulated by the Financial
