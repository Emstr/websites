...
export const metadata: Metadata = {
  title: "About Us | Independent Financial Advisers Since 1995",
  description:
    "Learn about MoneyHelp (Buchanan Johnston Flynn Limited) - an independent financial advisory firm serving Belfast and Northern Ireland since 1995. Nearly 30 years experience, FCA regulated.",
  openGraph: {
    title: "About Us | MoneyHelp Belfast",
    description:
      "Independent financial advisers providing trusted advice from Belfast since 1995. Nearly 30 years of guidance.",
  },
};
        ...
        <div className="container-width relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6">
              Your Trusted Financial Partners Since 1995
            </h1>
            <p className="text-xl text-gray-200 leading-relaxed">
              Nearly 30 years of independent financial advice from a trusted firm
              in Belfast, Northern Ireland. Expertise you can trust.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                MoneyHelp was founded in 1995 with a clear
                mission: to provide honest, independent financial advice that puts
                clients first. Over nearly three decades, we have grown into one of
                Belfast&apos;s most trusted financial advisory practices,
                while maintaining the personal values that have been
            ...
            <div>
              <div className="relative h-80 rounded-sm overflow-hidden shadow-xl mb-8">
                <Image
                  ...
                  alt="MoneyHelp - Established since 1995"
                  fill
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                We treat every client like family. We take time to
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Belfast office has been our home since 1995. Conveniently
              located for clients across Belfast and wider Northern Ireland.
            </p>
          </div>
            ...
            <div className="bg-gray-50 p-8 lg:p-12 rounded-sm border-t-4 border-accent">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Established firm since 1995
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-accent" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  Serving Belfast &amp; Northern Ireland
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              MoneyHelp is authorised and regulated by the
              Financial Conduct Authority (FCA Reference: 175588). This means we
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how MoneyHelp
