...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Stiles & Company Financial Services Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Stiles & Company Financial Services Ltd is authorised and regulated
              by the Financial Conduct Authority (FCA). Our registered office is at
              2 Amber House, St John&apos;s Road, Hove BN3 2EZ. We also maintain an
              office in Taplow, Maidenhead.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Stiles & Company Financial Services Ltd
              <br />
              2 Amber House, St John&apos;s Road
              <br />
              Hove BN3 2EZ
              <br />
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Stiles & Company Financial Services Ltd
              <br />
              2 Amber House, St John&apos;s Road, Hove BN3 2EZ
              <br />
              Taplow, Maidenhead
              <br />
              Phone: 01273 736713
