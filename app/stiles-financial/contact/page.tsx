...
export const metadata: Metadata = {
  ...
  description:
    "Contact Stiles & Company Financial Services for expert financial advice. Visit our offices in Hove or Maidenhead. Call 01273 736713 for a free consultation.",
  openGraph: {
    title: "Contact Us | Stiles & Company Financial Services",
    description:
      "Book a free consultation with our expert financial advisers at our Hove or Maidenhead offices. Call 01273 736713.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              Hove or Maidenhead office, or reach out to discuss your financial
              planning needs.
            </p>
          </div>
        </div>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Hove, Brighton & Hove</h3>
                  </div>
                </div>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Maidenhead</h3>
                  </div>
                </div>
                <address className="not-italic text-gray-700 mb-4">
                  <strong>Stiles & Company Financial Services Ltd</strong>
                ...
                <p className="text-sm text-gray-500">
                  Our Maidenhead office serves clients across Berkshire and the
                  Thames Valley area.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01273 736713</p>
                      <p className="text-sm text-gray-500">
                  ...
                  <a
                    href="mailto:advice@stilesfinancial.co.uk"
                    className="flex items-center gap-3 text-gray-700 hover:text-accent transition-colors"
                  >
                    <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center">
                      <svg
                    ...
                    <div>
                      <p className="font-semibold">advice@stilesfinancial.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
