...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/stiles-financial" },
    { name: "Services", href: "/stiles-financial/services" },
    { name: "About", href: "/stiles-financial/about" },
    { name: "FAQ", href: "/stiles-financial/faq" },
    { name: "Contact", href: "/stiles-financial/contact" },
  ];
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Hove & Maidenhead</span>
            </div>
          </div>
        </div>
      </div>
