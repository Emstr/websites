...
export const metadata: Metadata = {
  title: "Financial Services | Life Assurance, Pensions, Investments & Financial Planning",
  description:
    "Comprehensive financial services including life assurance, pensions, investments, and financial planning from Stiles & Company Financial Services in Hove and Maidenhead.",
  openGraph: {
    title: "Financial Services | Stiles & Company Financial Services",
    description:
      "Expert financial advice from FCA regulated advisers. Life assurance, pensions, investments, and financial planning in Hove and Maidenhead.",
  },
};
...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      subtitle: "Holistic Financial Guidance",
      description:
        "Our financial planning service brings together all aspects of your financial life into one cohesive strategy. From cash flow modelling to estate planning, we help you see the full picture and plan for every eventuality.",
      features: [
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              From life assurance to financial planning, we provide expert advice
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              At Stiles & Company, we provide professional financial advice across
              four core areas. All our advice is delivered by FCA regulated advisers
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01273736713" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 01273 736713
            </a>
          </div>
        </div>
