...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/it-support-canary-wharf" },
    { name: "Services", href: "/it-support-canary-wharf/services" },
    { name: "About", href: "/it-support-canary-wharf/about" },
    { name: "FAQ", href: "/it-support-canary-wharf/faq" },
    { name: "Contact", href: "/it-support-canary-wharf/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Cyber Essentials Certified</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/it-support-canary-wharf" className="flex items-center gap-3">
          ...
          <div className="hidden lg:block">
            <Link
              href="/it-support-canary-wharf/contact"
