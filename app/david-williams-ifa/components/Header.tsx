...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/david-williams-ifa" },
    { name: "Services", href: "/david-williams-ifa/services" },
    { name: "About", href: "/david-williams-ifa/about" },
    { name: "FAQ", href: "/david-williams-ifa/faq" },
    { name: "Contact", href: "/david-williams-ifa/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">FCA Regulated</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/david-williams-ifa" className="flex items-center gap-3">
          ...
          <div className="hidden lg:block">
            <Link
              href="/david-williams-ifa/contact"
