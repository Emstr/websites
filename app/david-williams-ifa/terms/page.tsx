...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for David Williams IFA Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              David Williams IFA is a trading name of David Williams IFA Ltd, which
              is authorised and regulated by the Financial Conduct Authority (FCA No.
              530750). Company Registration No. 04638076. Our registered office is at
              5 Waterside Way, Northampton, NN4 7XD.
            </p>
            <p className="text-gray-600 mb-6">
              You can check our regulatory status on the FCA Register at
              register.fca.org.uk or by contacting the FCA on 0800 111 6768. We hold
              Chartered Financial Planner status, the gold standard professional
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Trust planning and administration</li>
              <li>Cashflow modelling</li>
              <li>Mortgage services (residential and investment)</li>
              <li>Protection (life, critical illness, income protection)</li>
              <li>Corporate services (group protection, company pensions)</li>
              <li>Charity financial advice</li>
            </ul>
            <p className="text-gray-600 mb-6">
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li><strong>Research and analysis:</strong> We analyse your situation, run cashflow models where appropriate, and research suitable options from the whole market</li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              reviews, portfolio monitoring, cashflow modelling updates, and access
              to your adviser throughout the year.
            </p>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              ...
              Email: info@dwifa.co.uk
              <br />
              FCA No. 530750 | Company No. 04638076
            </address>
          </div>
        </div>
      </section>
