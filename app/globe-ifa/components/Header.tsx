...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/globe-ifa" },
    { name: "Services", href: "/globe-ifa/services" },
    { name: "About", href: "/globe-ifa/about" },
    { name: "FAQ", href: "/globe-ifa/faq" },
    { name: "Contact", href: "/globe-ifa/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Est. 1994 - Twickenham</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/globe-ifa" className="flex items-center gap-3">
