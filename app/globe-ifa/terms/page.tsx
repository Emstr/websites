...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Globe Independent Financial Advisors. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Globe Independent Financial Advisors is authorised and regulated
              by the Financial Conduct Authority (FCA). Company number 03503096.
              Our registered office is at Globe House, 1 Chertsey Road, St Margarets,
              Twickenham, Middlesex, TW1 1LR.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Retirement planning (pre-retirement, active retirement, later life)</li>
              <li>Pension planning, consolidation and transfer analysis</li>
              <li>Estate planning and inheritance tax mitigation</li>
              <li>Protection (life, critical illness, income protection)</li>
              <li>Mortgages (residential, buy-to-let, investment)</li>
              <li>Corporate services (group pensions, key man protection, shareholder protection)</li>
              <li>US citizen tax compliance and cross-border planning</li>
              <li>Financial planning for business owners</li>
            </ul>
            <p className="text-gray-600 mb-6">
              As independent financial advisors, we are not restricted in the range
            ...
            <p className="text-gray-600 mb-6">
              ...
              reviews, portfolio monitoring, and access to your advisor throughout
              the year.
            </p>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Globe Independent Financial Advisors
              <br />
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              ...
              Globe House, 1 Chertsey Road
              <br />
              St Margarets, Twickenham, Middlesex, TW1 1LR
              <br />
              Phone: 020 8891 0711
              <br />
              Email: hello@globeifa.co.uk
