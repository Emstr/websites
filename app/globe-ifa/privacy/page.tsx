...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Globe Independent Financial Advisors. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Globe Independent Financial Advisors (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              Globe Independent Financial Advisors is the data controller for
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>US tax identification numbers (where applicable for US citizen clients)</li>
            </ul>
