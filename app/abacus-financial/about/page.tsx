...
export const metadata: Metadata = {
  title: "About Us | Independent Financial Advisers Since 2011",
  description:
    "Learn about Abacus Financial Options - an independent financial advisory firm serving Dorset and the South West since 2011. Whole-of-market advice, FCA regulated.",
  openGraph: {
    title: "About Us | Abacus Financial Options",
    description:
      "Independent financial advisers providing whole-of-market advice from Ferndown, Dorset since 2011. Over 14 years of trusted guidance.",
  },
};
        ...
        <div className="container-width relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6">
              Your Trusted Financial Partners Since 2011
            </h1>
            <p className="text-xl text-gray-200 leading-relaxed">
              Independent financial advice from a trusted firm
              in Ferndown, Dorset. Whole-of-market expertise you can rely on.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Abacus Financial Options was established in 2011 with a clear
                mission: to provide honest, independent financial advice that puts
                clients first. Over the years, we have grown into one of
                Dorset&apos;s most trusted financial advisory practices,
                with personal values at the heart of everything we do.
              </p>
            ...
            <div>
              <div className="relative h-80 rounded-sm overflow-hidden shadow-xl mb-8">
                <Image
                  ...
                  alt="Abacus Financial Options - Established since 2011"
                  fill
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                We treat every client as an individual. We take time to
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                ...
                built on doing the right thing for our clients,
                every time.
              </p>
            </div>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">
              Based in Ferndown, Dorset
            </h2>
            <div className="gold-line-center mb-6"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Ferndown office has been our home since 2011. Conveniently
              located for clients across Dorset, Wiltshire, Somerset, Hampshire, London and Cornwall.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-gray-50 p-8 lg:p-12 rounded-sm border-t-4 border-accent">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Our established office has been serving clients since 2011. We offer a welcoming, professional environment for
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Abacus Financial Options is authorised and regulated by the
              Financial Conduct Authority. This means we
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how Abacus Financial
            Options can help you achieve your financial goals.
          </p>
