...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Abacus Financial Options Ltd. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Abacus Financial Options Ltd is the
