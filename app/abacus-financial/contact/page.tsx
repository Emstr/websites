...
export const metadata: Metadata = {
  ...
  description:
    "Contact Abacus Financial Options for independent financial advice. Visit our Ferndown office or call 01202 646960 for a free consultation.",
  openGraph: {
    title: "Contact Us | Abacus Financial Options",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01202 646960 or visit our Ferndown office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Ferndown office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Ferndown, Dorset</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Abacus Financial Options contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/abacus-financial/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Ferndown, Dorset</h3>
                  </div>
                </div>
                ...
                <p className="text-sm text-gray-500">
                  Serving clients across Dorset and the South West
                  since 2011. We also offer telephone and video consultations.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01202 646960</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">enquiries@abacusfinancialoptions.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
