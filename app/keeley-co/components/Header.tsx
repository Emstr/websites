...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/keeley-co" },
    { name: "Services", href: "/keeley-co/services/" },
    { name: "About", href: "/keeley-co/about/" },
    { name: "FAQ", href: "/keeley-co/faq/" },
    { name: "Contact", href: "/keeley-co/contact/" },
  ];
    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      ...
      <div className="bg-navy text-white py-2">
        <div className="container-custom flex flex-wrap justify-between items-center text-sm px-4">
          ...
          <div className="hidden md:flex items-center gap-2 text-xs">
            ...
            <span>Chartered Financial Planners &bull; FCA Regulated &bull; Est. 1928</span>
          </div>
        </div>
      </div>
      ...
      <div className="container-custom px-4">
        <div className="flex justify-between items-center py-4">
          {/* Logo */}
          <Link href="/keeley-co" className="flex items-center gap-3">
            ...
            <div>
              <span className="text-2xl font-bold text-navy">Keeley</span>
          ...
          <div className="hidden lg:flex items-center gap-4">
            <Link href="/keeley-co/contact/" className="btn-accent text-sm py-3 px-6">
              Free Consultation
            </Link>
          </div>
