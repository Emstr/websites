...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Primavera Financial Partners LLP. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Primavera Financial Partners LLP is authorised and regulated
              by the Financial Conduct Authority (FCA). We hold Chartered Status,
              the highest professional designation in financial planning, awarded by
              the Chartered Insurance Institute (CII). Our registered office is at
              87a High Street, Wanstead, London E11 2AE.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Mortgage advice (purchases, remortgages, and buy-to-let)</li>
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>
                ...
                and research suitable options from the market using our Chartered expertise
              </li>
              <li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              steps to identify and manage any conflicts that may arise. As a
              Chartered firm, we hold ourselves to the highest ethical standards.
              If a conflict cannot be managed, we will disclose it to you before
            ...
            <p className="text-gray-600 mb-6">
              We are committed to providing the highest standard of Chartered service.
              If you are unhappy with any aspect of our service, please contact us in
              writing:
            </p>
