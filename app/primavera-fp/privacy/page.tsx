...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Primavera Financial Partners LLP. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Primavera Financial Partners LLP (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              As a Chartered firm authorised and regulated by the Financial Conduct
            ...
            <p className="text-gray-600 mb-6">
              Primavera Financial Partners LLP is the data controller for
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>
                Financial information (assets, liabilities, investments, pensions, mortgages)
              </li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                To provide Chartered financial advice and services tailored to your needs
              </li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                providers, mortgage lenders) to implement our recommendations
              </li>
