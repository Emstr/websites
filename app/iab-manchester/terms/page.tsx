...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for The Independent Advice Bureau Limited. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              The Independent Advice Bureau Limited is authorised and regulated
              by the Financial Conduct Authority (FCA). Our registered office is at
              109 Burnage Lane, Manchester M19 2WH.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                <strong>Free initial consultation (45 minutes):</strong> We gather
                information about your financial circumstances, objectives, and
                attitude to risk. This meeting is free and without obligation.
              </li>
              <li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              Your initial 45-minute consultation is provided free of charge and
              without obligation. Our charges may include:
            </p>
