...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for The Independent Advice Bureau Limited. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              The Independent Advice Bureau Limited (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              The Independent Advice Bureau Limited is the data controller for
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              The Independent Advice Bureau Limited
              <br />
              109 Burnage Lane
              <br />
              Manchester M19 2WH
