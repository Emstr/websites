...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Aspire Independent Financial Planners LLP. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Aspire Independent Financial Planners LLP is authorised and regulated
              by the Financial Conduct Authority (FCA). Our registered office is at
              17 Station Road, Finchley, London N3 2SB.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Wealth management and investment planning</li>
              <li>Pension planning, including retirement income strategies</li>
              <li>Mortgage advice for purchases, remortgages and buy-to-let</li>
              <li>Insurance and protection planning (life assurance, critical illness, income protection)</li>
              <li>Equity release for homeowners aged 55 and over</li>
              <li>Will writing and Lasting Powers of Attorney</li>
            </ul>
            <p className="text-gray-600 mb-6">
              As independent financial planners, we are not restricted in the range
              of products we can recommend. We will assess your needs and objectives
              and recommend suitable solutions from the whole of the market. Our
              comprehensive service means we can coordinate all areas of your financial
              plan to work together effectively.
            </p>
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                financial circumstances, objectives and attitude to risk across all
                relevant areas of your financial life
              </li>
              <li>
                <strong>Research and analysis:</strong> We analyse your situation
                and research suitable options from across the market
              </li>
              <li>
                ...
                you, with a coordinated plan across all service areas
              </li>
              <li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              reviews, portfolio monitoring, and access to your planner throughout
              the year.
            </p>

            <h3 className="text-xl font-semibold text-primary mb-3">
              6.3 Mortgage and Insurance Fees
            </h3>
            <p className="text-gray-600 mb-6">
              For mortgage advice, we may charge an arrangement fee or receive a
              commission from the lender, or a combination of both. For insurance
              products, we typically receive commission from the provider. All fees
              and commissions will be disclosed in full before you proceed.
            </p>

            <h3 className="text-xl font-semibold text-primary mb-3">
              6.4 Will Writing and LPA Fees
            </h3>
            <p className="text-gray-600 mb-6">
              Will writing and Lasting Power of Attorney services are charged at a
              fixed fee, which will be quoted to you before work begins.
            </p>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <li>
                  Equity release will reduce the value of your estate and may affect
