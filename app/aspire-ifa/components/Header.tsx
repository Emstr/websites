...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/aspire-ifa" },
    { name: "Services", href: "/aspire-ifa/services" },
    { name: "About", href: "/aspire-ifa/about" },
    { name: "FAQ", href: "/aspire-ifa/faq" },
    { name: "Contact", href: "/aspire-ifa/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/aspire-ifa" className="flex items-center gap-3">
