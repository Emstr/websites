...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Aspire Independent Financial Planners LLP. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Aspire Independent Financial Planners LLP (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              Aspire Independent Financial Planners LLP is the data controller for
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>
                ...
                mortgage details, existing insurance policies)
              </li>
              <li>Bank account and payment details</li>
              <li>Health information (where relevant to insurance or equity release advice)</li>
              <li>Family circumstances and dependants</li>
              <li>Property details (for mortgage and equity release services)</li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                To provide financial planning services including wealth management,
                pension advice, mortgage advice, insurance, equity release and will
                writing
              </li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                financial planning services to you
              </li>
              <li>
              ...
              <li>
                ...
                of special category data (such as health information for insurance
                or equity release advice)
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                Product providers (mortgage lenders, insurance companies, investment
                platforms, pension providers, equity release providers) to implement
                our recommendations
              </li>
              <li>Will writing and legal services partners</li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              the advice relates to pensions, mortgages, equity release or other
              long-term products.
            </p>
