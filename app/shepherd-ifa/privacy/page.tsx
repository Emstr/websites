...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Shepherd Independent Financial Advisers Limited. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Shepherd Independent Financial Advisers Limited (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              Shepherd Independent Financial Advisers Limited is the data controller for
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              ...
              <br />
              Hill Top House, 302 Ringinglow Road
              <br />
              Sheffield S11 7PX
              <br />
              Phone: 0114 250 5260
            ...
            <p className="text-gray-600 mb-6">
              ...
              the advice relates to pensions, mortgages, or other long-term products.
            </p>
