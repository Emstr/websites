...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Shepherd Independent Financial Advisers Limited. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              and regulated by the Financial Conduct Authority (FCA). Our registered
              office is at Hill Top House, 302 Ringinglow Road, Sheffield S11 7PX.
            </p>
            <p className="text-gray-600 mb-6">
