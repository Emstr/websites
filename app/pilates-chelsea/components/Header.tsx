...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/pilates-chelsea" },
    { name: "Classes", href: "/pilates-chelsea/services" },
    { name: "About", href: "/pilates-chelsea/about" },
    { name: "FAQ", href: "/pilates-chelsea/faq" },
    { name: "Contact", href: "/pilates-chelsea/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            <div className="flex items-center gap-6">
              ...
              <a
                href="mailto:hello@chelseapilates.co.uk"
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/pilates-chelsea" className="flex items-center gap-3">
