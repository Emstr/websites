...
export const metadata: Metadata = {
  ...
  description: 'Professional notary public services in Camden, London. Business and individual document authentication, apostille and legalisation services.',
};
      ...
      <section id="business" className="py-20 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#1e3a5f]">Business Services</h2>
          </div>
      ...
      <section id="individual" className="py-20 bg-gray-50 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#1e3a5f]">Individual Services</h2>
          </div>
