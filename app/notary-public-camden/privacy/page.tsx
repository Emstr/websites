...
export const metadata: Metadata = {
  ...
  description: 'Privacy notice for Notary Public Camden. How we collect, use, and protect your personal data.',
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-8">
              <strong>Notary Public Camden</strong> (part of Kuddus Solicitors) is committed to protecting your privacy
            ...
            <address className="text-gray-600 not-italic mb-6">
              Notary Public Camden<br />
              Kuddus Solicitors<br />
              Camden, London NW1<br />
