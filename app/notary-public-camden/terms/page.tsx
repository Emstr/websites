...
export const metadata: Metadata = {
  ...
  description: 'Terms of business and complaints procedure for Notary Public Camden.',
};
            ...
            <div id="complaints" className="scroll-mt-24">
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#1e3a5f]">
                  <h3 className="font-semibold text-[#1e3a5f] mb-2">Step 1: Contact Us</h3>
                ...
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#0d2137]">
                ...
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#c9a227]">
