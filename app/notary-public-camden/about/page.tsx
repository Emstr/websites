...
export const metadata: Metadata = {
  title: 'About',
  description: 'Learn about Notary Public Camden, part of Kuddus Solicitors. Professional notarial services in Camden, London.',
};

const areas = [
  { name: 'Camden Town', primary: true },
...
export default function AboutPage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-gradient-to-br from-[#1e3a5f] to-[#0d2137] text-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Professional notary public services in Camden, London
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Notary Public Camden is part of Kuddus Solicitors, providing professional
                  notarial services to businesses and individuals across North London and beyond.
                </p>

                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Our convenient Camden location offers excellent transport links, making us
                  easily accessible for clients from King&apos;s Cross, Kentish Town, Hampstead,
            ...
            <div className="lg:col-span-1">
              {/* Areas Served */}
              <div className="bg-gradient-to-br from-[#1e3a5f] to-[#0d2137] rounded-xl p-6 text-white mb-8">
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#1e3a5f] mb-6">Our Fees</h2>
