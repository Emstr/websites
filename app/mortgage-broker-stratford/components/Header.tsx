...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/mortgage-broker-stratford" },
    { name: "Services", href: "/mortgage-broker-stratford/services" },
    { name: "About", href: "/mortgage-broker-stratford/about" },
    { name: "FAQ", href: "/mortgage-broker-stratford/faq" },
    { name: "Contact", href: "/mortgage-broker-stratford/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Whole of Market</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/mortgage-broker-stratford" className="flex items-center gap-3">
