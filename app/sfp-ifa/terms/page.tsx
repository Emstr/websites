...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Structured Financial Planning Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Structured Financial Planning Ltd is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              office is in 3 Lyon's Den, 28 Low Street, Banff, AB45 1AS.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <p className="text-gray-600 mb-6">
              ...
              be subject to the exclusive jurisdiction of the Scottish courts, without
