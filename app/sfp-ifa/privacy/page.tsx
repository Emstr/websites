...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Structured Financial Planning Ltd. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Structured Financial Planning Ltd is the
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Structured Financial Planning Ltd
              <br />
              3 Lyon's Den, 28 Low Street, Banff, AB45 1AS
              <br />
