...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about financial planning, investments, pensions, mortgages and our services. Get answers from Structured Financial Planning.",
  openGraph: {
    title: "FAQ | Structured Financial Planning",
    description:
  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Independent financial advisers (IFAs) like Structured Financial Planning are not tied to any product provider. This means we can recommend the best solutions from the entire market, rather than being limited to a specific company's products. Our whole-of-market access ensures our advice is based solely on what's best for you.",
        },
        {
          question: "Are you regulated?",
          answer:
            "Yes, Structured Financial Planning Ltd is authorised and regulated by the Financial Conduct Authority (FCA). This means we adhere to strict professional standards, and you're protected by the Financial Services Compensation Scheme (FSCS) and have access to the Financial Ombudsman Service if needed.",
        },
        {
        ...
        {
          question: "How long has Structured Financial Planning been operating?",
          answer:
            "With over 25 years of experience providing independent financial advice across North East Scotland, Structured Financial Planning has offices in Banff, Banchory and Fraserburgh, serving clients throughout Aberdeenshire and beyond.",
        },
      ],
    },
    {
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              and how Structured Financial Planning can help you achieve your financial goals.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            our experienced advisers at one of our offices across North East Scotland or by phone.
          </p>
          <Link href="/sfp-ifa/contact" className="btn-accent">
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              authorised and regulated by the Financial Conduct Authority. The information on this page is for general guidance
