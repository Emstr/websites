...
export const metadata: Metadata = {
  title: "About Us | Independent Financial Advisers in North East Scotland",
  description:
    "Learn about Structured Financial Planning - an independent financial advisory firm serving Banff, Banchory, Aberdeen and North East Scotland. 25+ years experience, whole-of-market advice, FCA regulated.",
  openGraph: {
    title: "About Us | Structured Financial Planning",
    description:
      "Independent financial advisers providing whole-of-market advice across North East Scotland. Over 25 years of trusted guidance.",
  },
};
        ...
        <div className="container-width relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6">
              Your Trusted Financial Partners in North East Scotland
            </h1>
            <p className="text-xl text-gray-200 leading-relaxed">
              Over 25 years of independent financial advice across Banff, Banchory,
              Aberdeen and Aberdeenshire. Whole-of-market expertise you can trust.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Structured Financial Planning was established with a clear
                mission: to provide honest, independent financial advice that puts
                clients first. With over 25 years of experience, we have grown into one of
                North East Scotland&apos;s most trusted financial advisory practices,
                with offices in Banff, Banchory and Fraserburgh serving clients
                throughout Aberdeenshire and beyond.
              </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-premium p-8">
              ...
              <p className="text-gray-600">
                ...
                built over 25 years on doing the right thing for our clients,
                every time.
              </p>
            </div>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">
              Based in Banff, Aberdeenshire
            </h2>
            <div className="gold-line-center mb-6"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our main office is in Banff, with additional offices in Banchory
              and Fraserburgh, conveniently serving clients across North East Scotland.
            </p>
          </div>
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Structured Financial Planning is authorised and regulated by the
              Financial Conduct Authority (FCA Reference: 440742). This means we
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Book a complimentary consultation and discover how Structured
