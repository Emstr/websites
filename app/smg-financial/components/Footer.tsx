        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              Harewood and West Yorkshire since 1994. Over 30 years of trusted
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/smg-financial/services" className="footer-link">
                  Pensions
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/smg-financial/about" className="footer-link">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/smg-financial/contact" className="footer-link">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/smg-financial/faq" className="footer-link">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/smg-financial/privacy" className="footer-link">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/smg-financial/terms" className="footer-link">
                  Terms of Business
                </Link>
              </li>
            </ul>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>
              &copy; {currentYear} SMG Financial Services. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link href="/smg-financial/privacy" className="hover:text-accent transition-colors">
                Privacy Policy
              </Link>
              <Link href="/smg-financial/terms" className="hover:text-accent transition-colors">
                Terms of Business
              </Link>
            </div>
          </div>
