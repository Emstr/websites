...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/smg-financial" },
    { name: "Services", href: "/smg-financial/services" },
    { name: "About", href: "/smg-financial/about" },
    { name: "FAQ", href: "/smg-financial/faq" },
    { name: "Contact", href: "/smg-financial/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Est. 1994 | Harewood</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/smg-financial" className="flex items-center gap-3">
