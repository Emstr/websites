...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/tattoo-shoreditch" },
    { name: "Services", href: "/tattoo-shoreditch/services" },
    { name: "About", href: "/tattoo-shoreditch/about" },
    { name: "FAQ", href: "/tattoo-shoreditch/faq" },
    { name: "Contact", href: "/tattoo-shoreditch/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Tue-Sat 11am-8pm</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/tattoo-shoreditch" className="flex items-center gap-3">
