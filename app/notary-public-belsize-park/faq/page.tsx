...
export const metadata: Metadata = {
  ...
  description: 'Common questions about notary public services in Belsize Park, London. Learn about costs, the notarisation process, and more.',
};
...
const faqs = [
  {
    ...
    answer: `The cost of notarising a document varies depending on the complexity of the work and time required. I offer competitive, transparent pricing with no hidden fees.
...
For an accurate quote, please use my instant quote calculator or contact me with details of your specific requirements.`,
  },
  {
...
Some countries require embassy or consulate legalisation instead of an Apostille. I can assist with both processes.`,
  },
  {
    id: 'id-requirements',
              ...
              <article key={faq.id} id={faq.id} className="scroll-mt-24">
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <span className="flex items-center justify-center w-10 h-10 rounded-full bg-[#3d5a80] text-white font-bold">
                      {index + 1}
                    </span>
                  </div>
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-[#3d5a80] mb-4">
                      {faq.question}
                    </h2>
                    <div className="prose prose-lg max-w-none text-gray-600">
                      {faq.answer.split('\n\n').map((paragraph, pIndex) => {
                        if (paragraph.startsWith('**') && paragraph.endsWith('**')) {
                          return (
                            <h3 key={pIndex} className="text-lg font-semibold text-[#3d5a80] mt-6 mb-2">
                              {paragraph.replace(/\*\*/g, '')}
                            </h3>
                          );
                        }
