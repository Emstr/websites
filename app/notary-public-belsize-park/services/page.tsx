...
export const metadata: Metadata = {
  ...
  description: 'Professional notary public services in Belsize Park, London. Business and individual document authentication, apostille and legalisation services.',
};
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              ...
              to personal certifications, I provide professional authentication services.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="business" className="py-20 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#3d5a80]">Business Services</h2>
          </div>

          <div className="grid md:grid-cols-2 gap-4">
            {businessServices.map((service, index) => (
              <div key={index} className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                <svg className="w-5 h-5 text-[#ee6c4d] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
      ...
      <section id="individual" className="py-20 bg-gray-50 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#3d5a80]">Individual Services</h2>
          </div>
      ...
      <section id="apostille" className="py-20 scroll-mt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-[#ee6c4d] rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              I provide a complete apostille and legalisation service for all documents
      ...
      <section className="py-16 bg-[#3d5a80] text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Contact me to discuss your specific requirements. I can notarise most documents
