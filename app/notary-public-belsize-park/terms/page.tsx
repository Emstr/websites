...
export const metadata: Metadata = {
  ...
  description: 'Terms of business and complaints procedure for Notary Public Belsize Park.',
};
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl font-bold text-[#3d5a80] mt-6 mb-4">Fees & Charges</h2>
            <p className="text-gray-600 mb-4">
              My fees are based on the time engaged and complexity of the work. I provide
            ...
            <h2 className="text-2xl font-bold text-[#3d5a80] mt-10 mb-4">Notary Responsibilities</h2>
            <p className="text-gray-600 mb-6">
              As a Notary Public, I must be satisfied as to your identity, your legal capacity,
              your authority and your understanding and approval of the documents being notarised.
              I will verify these matters before completing any notarial act.
            </p>

            <h2 className="text-2xl font-bold text-[#3d5a80] mt-10 mb-4">Legal Advice Limitations</h2>
            <p className="text-gray-600 mb-6">
              I do not provide legal advice on documents being notarised. I recommend that you
            ...
            <h2 className="text-2xl font-bold text-[#3d5a80] mt-10 mb-4">Payment Terms</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#3d5a80] mt-10 mb-4">Regulatory Authority</h2>
            <p className="text-gray-600 mb-6">
            ...
            <div id="complaints" className="scroll-mt-24">
              <h2 className="text-2xl font-bold text-[#3d5a80] mt-10 mb-4">Complaints Procedure</h2>
              <p className="text-gray-600 mb-4">
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#3d5a80]">
                  <h3 className="font-semibold text-[#3d5a80] mb-2">Step 1: Contact Me</h3>
                ...
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#293241]">
                  <h3 className="font-semibold text-[#3d5a80] mb-2">Step 2: The Notaries Society</h3>
                  <p className="text-gray-600">
                ...
                <div className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#ee6c4d]">
                  <h3 className="font-semibold text-[#3d5a80] mb-2">Step 3: Legal Ombudsman</h3>
                  <p className="text-gray-600">
