...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/tutor-kensington" },
    { name: "Services", href: "/tutor-kensington/services" },
    { name: "About", href: "/tutor-kensington/about" },
    { name: "FAQ", href: "/tutor-kensington/faq" },
    { name: "Contact", href: "/tutor-kensington/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Kensington, W8</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/tutor-kensington" className="flex items-center gap-3">
