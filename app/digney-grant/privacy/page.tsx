...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Digney Grant Financial Planning Ltd. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Digney Grant Financial Planning Ltd (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              ...
              (FCA), FCA Number 702579, we are also subject to additional data
            ...
            <p className="text-gray-600 mb-6">
              Digney Grant Financial Planning Ltd is the data controller for
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Health information (where relevant to insurance or protection advice)</li>
              <li>Family circumstances and dependants</li>
              <li>Identification documents</li>
              <li>Property details (for mortgage advice)</li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                To provide financial advice, mortgage advice, and insurance services tailored to your needs
              </li>
              <li>To assess your suitability for financial products and mortgages</li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                financial advice, mortgage, and insurance services to you
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                Product providers (insurance companies, mortgage lenders, investment platforms, pension
