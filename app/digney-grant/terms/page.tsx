...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Digney Grant Financial Planning Ltd. Understand our client agreement, services, and regulatory information. FCA Number 702579.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Digney Grant Financial Planning Ltd is authorised and regulated
              by the Financial Conduct Authority (FCA). Our FCA Number is 702579.
              Our registered office is at 41-43 Downshire Court, Newry, BT34 1FD.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <p className="text-gray-600 mb-4">
              We provide independent financial advice and services in the following areas:
            </p>
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Financial planning and wealth management</li>
              <li>Mortgage advice (whole-of-market)</li>
              <li>Personal insurance (life, critical illness, income protection, home, motor)</li>
              <li>Commercial insurance (public liability, employer&apos;s liability, property, fleet)</li>
              <li>Pension planning and retirement income strategies</li>
            ...
            <h3 className="text-xl font-semibold text-primary mb-3">
              6.3 Insurance and Mortgage Fees
            </h3>
            <p className="text-gray-600 mb-6">
              For insurance and mortgage services, we may receive commission from the
              product provider or charge a separate fee. The payment method will be
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Digney Grant Financial Planning Ltd
              <br />
            ...
            <p className="text-gray-600 mb-6">
              ...
              Any disputes will be subject to the jurisdiction of the Northern Ireland
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Digney Grant Financial Planning Ltd
              <br />
              41-43 Downshire Court, Newry BT34 1FD
              <br />
              Phone: 028 3082 8880
              <br />
              Email: info@digneygrant.co.uk
