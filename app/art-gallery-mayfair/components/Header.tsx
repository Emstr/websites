...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/art-gallery-mayfair" },
    { name: "Services", href: "/art-gallery-mayfair/services" },
    { name: "About", href: "/art-gallery-mayfair/about" },
    { name: "FAQ", href: "/art-gallery-mayfair/faq" },
    { name: "Contact", href: "/art-gallery-mayfair/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Since 2010</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/art-gallery-mayfair" className="flex items-center gap-3">
