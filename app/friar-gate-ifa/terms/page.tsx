...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Friar Gate Independent Financial Services Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              regulated by the Financial Conduct Authority (FCA). Our registered
              office is at 5 Prospect Place, Millennium Way, Pride Park, Derby
              DE24 8HG.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <p className="text-gray-600 mb-4">
              We provide independent, whole-of-market financial advice on the
              following areas:
            </p>
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Investment advice and portfolio management</li>
              <li>Retirement planning, including pension consolidation and drawdown strategies</li>
              <li>Inheritance tax planning, including trusts and estate planning</li>
              <li>Cost reduction reviews for existing financial products</li>
              <li>Independent financial reviews of your complete financial position</li>
            </ul>
            <p className="text-gray-600 mb-6">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Client&quot;, which affords you the highest level of protection under
              the FCA rules. This means you have access to the Financial Ombudsman
              Service and may be eligible for compensation under the Financial
              Services Compensation Scheme (FSCS) if we are unable to meet our
              obligations.
            </p>
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>
                ...
                and research suitable options from across the whole market
              </li>
              <li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              steps to identify and manage any conflicts that may arise. As
              independent, whole-of-market advisers, our structure minimises
              conflicts as we are not tied to any product provider. If a conflict
              cannot be managed, we will disclose it to you before proceeding. You
              may request a copy of our conflicts policy at any time.
            </p>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <li>
                  Investments in smaller companies or emerging markets may carry
                  higher risk
                </li>
              </ul>
            </div>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Friar Gate Independent Financial Services Ltd
              <br />
