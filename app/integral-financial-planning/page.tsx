        ...
        <div className="container-width relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
              Personal independent financial advice from an experienced adviser in Nottingham. Expert guidance on investments, pensions, and tax planning — tailored to your individual goals.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link href="/integral-financial-planning/contact" className="btn-accent text-lg">Book Free Consultation</Link>
              <Link href="/integral-financial-planning/services" className="btn-outline border-white text-white hover:bg-white hover:text-primary text-lg">Our Services</Link>
            </div>
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card-premium p-8">
              ...
              <Link href="/integral-financial-planning/services" className="text-accent font-semibold hover:text-accent-700 inline-flex items-center gap-2">Learn More <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></Link>
            </div>
          ...
          <div className="text-center mt-12">
            <Link href="/integral-financial-planning/services" className="btn-primary">View All Services</Link>
          </div>
        </div>
      </section>
        ...
        <div className="container-width">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">Based in Nottingham, we provide personal, independent financial advice that puts your interests first. As an independent adviser, we have access to the whole of the market, ensuring you receive the best possible recommendations.</p>
            ...
            <div className="bg-gray-50 p-8 lg:p-12 rounded-sm">
              <div className="grid grid-cols-2 gap-8">
                ...
                <div className="text-center"><div className="stat-number">200+</div><p className="text-gray-600 mt-2">Satisfied Clients</p></div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="testimonial-card">
              ...
              <div className="flex items-center gap-3">
                ...
                <div><p className="font-semibold text-primary">David M.</p><p className="text-sm text-gray-500">Retired Teacher, Nottingham</p></div>
              </div>
            </div>
            <div className="testimonial-card">
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p><strong>Important Notice:</strong> Integral Financial Planning is authorised and regulated by the Financial Conduct Authority (FCA). The value of investments can go down as well as up, and you may get back less than you invested. Past performance is not a reliable indicator of future results. Tax treatment depends on individual circumstances and may change in the future.</p>
          </div>
        </div>
      </section>
    </>
