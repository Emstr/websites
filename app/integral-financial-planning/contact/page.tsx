...
export const metadata: Metadata = {
  ...
  description: "Contact Integral Financial Planning for expert financial advice. Based in Nottingham. Call 0115 953 2359 for a free consultation.",
  openGraph: {
    title: "Contact Us | Integral Financial Planning",
    description: "Book a free consultation with our expert financial adviser in Nottingham. Call 0115 953 2359.",
  },
};
            ...
            <div>
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">I consent to Integral Financial Planning contacting me regarding my enquiry. I understand my data will be processed in accordance with the <a href="/integral-financial-planning/privacy" className="text-accent hover:underline">Privacy Policy</a>. *</label>
                </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  <a href="tel:01159532359" className="flex items-center gap-3 text-gray-700 hover:text-accent transition-colors">
                    <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center">
                      <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                    </div>
                    <div><p className="font-semibold">0115 953 2359</p><p className="text-sm text-gray-500">Call us during office hours</p></div>
                  </a>
                  <a href="mailto:info@integral-ifa.co.uk" className="flex items-center gap-3 text-gray-700 hover:text-accent transition-colors">
                    <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center">
                    ...
                    <div><p className="font-semibold">info@integral-ifa.co.uk</p><p className="text-sm text-gray-500">Email us anytime</p></div>
                  </a>
                </div>
              </div>
            </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p><strong>Important Notice:</strong> Integral Financial Planning is authorised and regulated by the Financial Conduct Authority. Initial consultations are provided free of charge and without obligation.</p>
          </div>
        </div>
      </section>
    </>
