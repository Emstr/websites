...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/pest-control-wandsworth" },
    { name: "Services", href: "/pest-control-wandsworth/services" },
    { name: "About", href: "/pest-control-wandsworth/about" },
    { name: "FAQ", href: "/pest-control-wandsworth/faq" },
    { name: "Contact", href: "/pest-control-wandsworth/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            <div className="flex items-center gap-6">
              ...
              <a
                href="mailto:info@wandsworthpest.co.uk"
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          <Link href="/pest-control-wandsworth" className="flex items-center gap-3">
          ...
          <div className="hidden lg:block">
            <Link
              href="/pest-control-wandsworth/contact"
