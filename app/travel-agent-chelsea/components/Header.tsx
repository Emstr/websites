...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/travel-agent-chelsea" },
    { name: "Services", href: "/travel-agent-chelsea/services" },
    { name: "About", href: "/travel-agent-chelsea/about" },
    { name: "FAQ", href: "/travel-agent-chelsea/faq" },
    { name: "Contact", href: "/travel-agent-chelsea/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            <div className="flex items-center gap-6">
              ...
              <a
                href="mailto:holidays@chelseatravel.co.uk"
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">King&apos;s Road, Chelsea</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          <Link href="/travel-agent-chelsea" className="flex items-center gap-3">
          ...
          <div className="hidden lg:block">
            <Link
              href="/travel-agent-chelsea/contact"
