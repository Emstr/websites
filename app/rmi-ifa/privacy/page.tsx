...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Readymoney Investments Limited (trading as RMI Independent Financial Advisers). Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Readymoney Investments Limited, trading as RMI Independent Financial
              Advisers (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is committed to protecting your
            ...
            <p className="text-gray-600 mb-6">
              ...
              (FCA), FCA Register Number 925064, we are also subject to additional
            ...
            <p className="text-gray-600 mb-6">
              Readymoney Investments Limited is the data controller for personal
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Readymoney Investments Limited
              <br />
              71 Burnmill Road
              <br />
              Market Harborough
