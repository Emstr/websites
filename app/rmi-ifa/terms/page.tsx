...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Readymoney Investments Limited (trading as RMI Independent Financial Advisers). Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Advisers, is authorised and regulated by the Financial Conduct
              Authority (FCA). Our FCA Register Number is 925064. Our registered
              office is at 71 Burnmill Road, Market Harborough, Leicestershire
              LE16 7JG.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>
                ...
                and research suitable options from across the whole of the market
              </li>
              <li>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Readymoney Investments Limited
              <br />
              71 Burnmill Road, Market Harborough
              <br />
              Leicestershire LE16 7JG
              <br />
              Phone: 01858 322101
