...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/dales-ifa" },
    { name: "Services", href: "/dales-ifa/services" },
    { name: "About", href: "/dales-ifa/about" },
    { name: "FAQ", href: "/dales-ifa/faq" },
    { name: "Contact", href: "/dales-ifa/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Nottingham & Newark</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/dales-ifa" className="flex items-center gap-3">
