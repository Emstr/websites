...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/gym-camden" },
    { name: "Services", href: "/gym-camden/services" },
    { name: "About", href: "/gym-camden/about" },
    { name: "FAQ", href: "/gym-camden/faq" },
    { name: "Contact", href: "/gym-camden/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Chalk Farm Road, Camden</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/gym-camden" className="flex items-center gap-3">
