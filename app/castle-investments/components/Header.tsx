...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/castle-investments" },
    { name: "Services", href: "/castle-investments/services" },
    { name: "About", href: "/castle-investments/about" },
    { name: "FAQ", href: "/castle-investments/faq" },
    { name: "Contact", href: "/castle-investments/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              <span className="flex items-center gap-1">
                ...
                FCA Regulated (Ref: 171661)
              </span>
              <span className="hidden sm:block">|</span>
              <span className="hidden sm:block">Est. 1994 | Southampton</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/castle-investments" className="flex items-center gap-3">
