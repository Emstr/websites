...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Widelist Investments Ltd trading as Castle Investment Consultants. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
