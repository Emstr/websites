...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Retirement & Investment Solutions Ltd (Retinvest). Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Retirement &amp; Investment Solutions Ltd, trading as Retinvest, is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              registered office is at Lomond Court, Castle Business Park, Stirling
              FK9 4TU.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Divorce financial planning and pension sharing</li>
              <li>Pension transfers, including defined benefit transfers</li>
              <li>Investment planning and portfolio management</li>
              <li>Tax and trust planning</li>
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>
                <strong>Research and analysis:</strong> We analyse your situation and
                research suitable options from the market
              </li>
              <li>
                <strong>Recommendations:</strong> We provide a written suitability
                report explaining our recommendations and why they are suitable for you
              </li>
              <li>
                <strong>Implementation:</strong> With your authority, we implement the
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <li>Transferring a defined benefit pension involves giving up a guaranteed income for life</li>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Retirement &amp; Investment Solutions Ltd
              <br />
            ...
            <p className="text-gray-600 mb-6">
              ...
              be subject to the jurisdiction of the Scottish courts, without prejudice
              to your right to refer complaints to the Financial Ombudsman Service.
            </p>
