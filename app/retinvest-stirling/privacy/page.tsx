...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Retirement & Investment Solutions Ltd (Retinvest). Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Retirement &amp; Investment Solutions Ltd, trading as Retinvest (&quot;we&quot;,
              &quot;us&quot;, &quot;our&quot;) is committed to protecting your privacy and handling your
              personal data responsibly. This Privacy Policy explains how we collect,
            ...
            <p className="text-gray-600 mb-6">
              Retirement &amp; Investment Solutions Ltd is the data controller for
              personal information collected through our services and website. Our
              contact details are:
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Marital status and divorce proceedings information</li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>To provide divorce financial planning advice and expert reports</li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Product providers (insurance companies, investment platforms, pension providers) to implement our recommendations</li>
              <li>Our professional network and compliance support services</li>
              <li>Regulatory bodies (FCA, HMRC) as required by law</li>
              <li>Professional advisers (solicitors, accountants, mediators) where necessary, particularly in divorce cases</li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              our services and comply with our legal obligations. Under FCA regulations,
              we are required to keep records of financial advice for a minimum of five
            ...
            <p className="text-gray-600 mb-6">
              ...
              or destruction. This includes encryption, secure servers, access controls,
