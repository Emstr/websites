...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Holder & Combes. Understand our client agreement, Chartered financial planning services and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              status, awarded by the Chartered Insurance Institute (CII). Our
              registered office is at 20 Little Britain, St Paul&apos;s, City of
              London EC1A 7DH.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <p className="text-gray-600 mb-4">
              We provide independent Chartered financial advice on the following areas:
            </p>
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Investment and wealth management</li>
              <li>Retirement planning</li>
              <li>Pensions, including workplace pensions and SIPPs</li>
              <li>Estate planning and Inheritance Tax mitigation</li>
              <li>Wills and estate administration</li>
              <li>Tax planning and tax-efficient investing</li>
            </ul>
            <p className="text-gray-600 mb-6">
            ...
            <p className="text-gray-600 mb-4">Our Chartered advice process includes:</p>
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>
                <strong>Research and analysis:</strong> Our Chartered planners analyse
                your situation and research suitable options from the market
              </li>
              <li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              reviews, portfolio monitoring and access to your Chartered planner
              throughout the year.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              ...
              steps to identify and manage any conflicts that may arise. As holders
              of Chartered status, we are bound by the CII&apos;s code of ethics
              which requires us to act with integrity at all times. If a conflict
              cannot be managed, we will disclose it to you before proceeding.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              We are committed to providing a high standard of Chartered service. If
              you are unhappy with any aspect of our service, please contact us in
              writing:
            </p>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Holder &amp; Combes
              <br />
              20 Little Britain, St Paul&apos;s, City of London EC1A 7DH
              <br />
              Phone: 020 7101 2817
              <br />
              Email: info@holderandcombes.co.uk
