...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/sushi-soho" },
    { name: "Menu", href: "/sushi-soho/services" },
    { name: "About", href: "/sushi-soho/about" },
    { name: "FAQ", href: "/sushi-soho/faq" },
    { name: "Contact", href: "/sushi-soho/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Wardour Street, Soho</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/sushi-soho" className="flex items-center gap-3">
