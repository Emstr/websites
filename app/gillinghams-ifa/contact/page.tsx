...
export const metadata: Metadata = {
  ...
  description:
    "Contact Gillinghams Independent Financial Advisers for independent financial advice. Visit our Bridport office or call 01308 425962 for a free consultation.",
  openGraph: {
    title: "Contact Us | Gillinghams Independent Financial Advisers",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01308 425962 or visit our Bridport office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Bridport office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Bridport</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Gillinghams Independent Financial Advisers contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/gillinghams-ifa/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Bridport, Dorset</h3>
                  </div>
                </div>
                <address className="not-italic text-gray-700 mb-4">
                  <strong>Gillinghams Independent Financial Advisers</strong>
                  <br />
                  Bridport, Dorset
                </address>
                ...
                <p className="text-sm text-gray-500">
                  Family-run firm serving clients across Bridport and Dorset
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01308 425962</p>
                      <p className="text-sm text-gray-500">
                  ...
                  <a
                    href="mailto:info@gillinghamsifa.co.uk"
                    className="flex items-center gap-3 text-gray-700 hover:text-accent transition-colors"
                  >
                    <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center">
                      <svg
                    ...
                    <div>
                      <p className="font-semibold">info@gillinghamsifa.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width py-8">
          ...
          <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden">
            <iframe
              ...
              title="Gillinghams Independent Financial Advisers - Bridport, Dorset"
            ></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Gillinghams Independent Financial Advisers is
              authorised and regulated by the Financial Conduct Authority (FCA
              Reference: 609295). Initial consultations are provided free of charge
