...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Gillinghams Independent Financial Advisers Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Gillinghams Independent Financial Advisers Ltd is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              office is in Bridport, Dorset.
            </p>
            <p className="text-gray-600 mb-6">
