...
export const metadata: Metadata = {
  ...
  description:
    "Contact AFS Limited for independent financial advice. Visit our Chesterfield office or call 01246 293 858 for a free consultation.",
  openGraph: {
    title: "Contact Us | AFS Limited",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01246 293 858 or visit our Chesterfield office.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              our Chesterfield office or reach out by phone or email to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="office">Office Visit - Chesterfield</option>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to AFS Limited contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/afs-chesterfield/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Chesterfield, Derbyshire</h3>
                  </div>
                </div>
                ...
                <p className="text-sm text-gray-500">
                  Family-run firm serving clients across Chesterfield and Derbyshire
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01246 293 858</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">info@afs.ltd.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width">
          <div className="fca-notice">
            <p>
              ...
              Reference: 196880). Initial consultations are provided free of charge
