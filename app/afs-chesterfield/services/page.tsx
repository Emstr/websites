...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive whole-of-market financial advice including pensions, investments, mortgages, protection and estate planning from AFS Limited in Chesterfield.",
  openGraph: {
    title: "Financial Services | AFS Limited",
    description:
      "Whole-of-market independent financial advice from FCA regulated advisers. Pensions, investments, mortgages, protection and estate planning in Chesterfield.",
  },
};
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              in Chesterfield and Derbyshire since 1994.
            </p>
          </div>
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01246293858" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 01246 293 858
            </a>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> AFS Limited trading as
              AFS Limited is authorised and regulated by the Financial
