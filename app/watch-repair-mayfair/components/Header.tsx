...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/watch-repair-mayfair" },
    { name: "Services", href: "/watch-repair-mayfair/services" },
    { name: "About", href: "/watch-repair-mayfair/about" },
    { name: "FAQ", href: "/watch-repair-mayfair/faq" },
    { name: "Contact", href: "/watch-repair-mayfair/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              <span className="flex items-center gap-1">
                ...
                Swiss-Trained Master Horologist
              </span>
              <span className="hidden sm:block">|</span>
              <span className="hidden sm:block">Burlington Arcade, Mayfair</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/watch-repair-mayfair" className="flex items-center gap-3">
