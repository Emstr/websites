...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Financial Professionals (NI) Ltd. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Financial Professionals (NI) Ltd (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              Financial Professionals (NI) Ltd is the data controller for personal
