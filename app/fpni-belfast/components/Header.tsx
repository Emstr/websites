...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/fpni-belfast" },
    { name: "Services", href: "/fpni-belfast/services" },
    { name: "About", href: "/fpni-belfast/about" },
    { name: "FAQ", href: "/fpni-belfast/faq" },
    { name: "Contact", href: "/fpni-belfast/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Belfast & Lisburn</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link href="/fpni-belfast" className="flex items-center gap-3">
