...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Financial Professionals (NI) Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Financial Conduct Authority (FCA). We operate from two offices in
              Northern Ireland: our Belfast office (028 9036 4477) and our Lisburn
              office (028 9261 0536).
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <p className="text-gray-600 mb-4">
              We provide financial advice on the following areas:
            </p>
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Personal pensions, including retirement income strategies</li>
              <li>Auto enrolment and workplace pension solutions for businesses</li>
              <li>Savings and investment planning</li>
              <li>Corporate financial services including group pensions and employee benefits</li>
            </ul>
            <p className="text-gray-600 mb-6">
              We will assess your needs and objectives and recommend suitable
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                ...
                financial circumstances, objectives, and attitude to risk at our
                Belfast or Lisburn office
              </li>
              <li>
                <strong>Research and analysis:</strong> We analyse your situation
                and research suitable options from the market
              </li>
              <li>
                <strong>Recommendations:</strong> We provide a written suitability
                report explaining our recommendations and why they are suitable
                for you
              </li>
              <li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              &pound;85,000 per person. Further information is available from the
              FSCS at fscs.org.uk or 0800 678 1100.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              These Terms of Business are governed by the laws of Northern Ireland.
              Any disputes will be subject to the jurisdiction of the Northern
              Ireland courts, without prejudice to your right to refer complaints
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Financial Professionals (NI) Ltd
              <br />
              Belfast Office: 028 9036 4477
              <br />
              Lisburn Office: 028 9261 0536
              <br />
              Email: info@fpni.co.uk
            </address>
          </div>
