          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <span className="text-xl font-bold text-accent">Finance</span>
              </div>
            </div>
            <p className="text-gray-300 mb-6">
              Your trusted independent financial advisers providing expert
              guidance on mortgages, protection, and pension planning across
              Bromley and Greater London.
            </p>
        ...
        <div className="container-custom px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} Total Finance (UK) Ltd. All rights reserved.
            </p>
