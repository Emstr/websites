...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Westside Independent Financial Services LLP. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Westside Independent Financial Services LLP (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              Westside Independent Financial Services LLP is the data controller for
