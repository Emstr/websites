...
export const metadata: Metadata = {
  title: "Financial Services | Pensions, Investments, Estate Planning & Mortgages",
  description:
    "Comprehensive independent financial advice including pensions, investments, estate planning, wealth protection, and mortgages. Whole-of-market advice from FCA regulated advisers in Sheffield.",
  openGraph: {
    title: "Financial Services | Westside Independent Financial Services LLP",
    description:
      "Expert independent financial advice from FCA regulated advisers. Pensions, investments, estate planning, wealth protection, and mortgages in Sheffield.",
  },
};
  ...
  const services = [
    {
      ...
      description:
        "Whether you are just starting to save for retirement or approaching pension age, our expert advisers can help you make the most of your pension savings. We provide clear, jargon-free advice on all aspects of pension planning, ensuring you have the income you need in retirement.",
      features: [
        ...
        "Workplace pension and auto-enrolment guidance",
      ],
      icon: (
    ...
    },
    {
      ...
      description:
        "Effective estate planning ensures your wealth is passed on to your loved ones as efficiently as possible. Our advisers work with you to develop strategies that minimise inheritance tax and protect your assets for future generations, giving you peace of mind that your family is provided for.",
      features: [
    ...
    },
    {
      ...
      description:
        "Wealth protection planning ensures your family and lifestyle are financially secure, whatever life brings. We help you understand your protection needs and find the right cover at the right price, so you can face the future with confidence.",
      features: [
    ...
    },
    {
      id: "mortgages",
      title: "Mortgages",
      subtitle: "Find the Right Home Finance",
      description:
        "Whether you are a first-time buyer, moving home, or looking to remortgage, our whole-of-market mortgage advice ensures you get the best deal available. We search across the entire market to find mortgage solutions that suit your circumstances and budget.",
      features: [
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01142336000" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 0114 233 6000
            </a>
          </div>
        </div>
