...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about financial planning, investments, pensions, and our services. Get answers from Westside Independent Financial Services LLP.",
  openGraph: {
    title: "FAQ | Westside Independent Financial Services LLP",
    description:
      "Common questions about financial advice, investments, pensions, and working with an independent financial adviser in Sheffield.",
  },
};
      ...
      questions: [
        {
          ...
          answer:
            "A financial adviser helps you make informed decisions about your money. We analyse your current financial situation, understand your goals, and create personalised strategies for pensions, investments, estate planning, wealth protection, and mortgages. We also provide ongoing support and adjust your plan as your circumstances change.",
        },
        {
          question: "Why should I use an independent financial adviser?",
          answer:
            "Independent financial advisers (IFAs) like Westside IFS are not tied to any product provider. This means we can recommend the best solutions from the entire market, rather than being limited to a specific company's products. Our advice is based solely on what is best for you.",
        },
        {
          question: "Are you regulated?",
          answer:
            "Yes, Westside Independent Financial Services LLP is authorised and regulated by the Financial Conduct Authority (FCA). This means we adhere to strict professional standards, and you are protected by the Financial Services Compensation Scheme (FSCS) and have access to the Financial Ombudsman Service if needed.",
        },
        {
      ...
      questions: [
        {
          ...
          answer:
            "We work with clients across a range of investment levels. We are happy to discuss your situation as every client is different. Contact us to arrange an initial consultation where we can understand your needs and advise accordingly.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "We typically conduct formal annual reviews, though we monitor portfolios continuously. You are welcome to contact us at any time if your circumstances change or you have questions about your investments.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Yes, Inheritance Tax (IHT) planning is a key part of our estate planning service. We can help you structure your assets and make use of exemptions and reliefs to potentially reduce the IHT liability on your estate.",
        },
      ],
    },
    {
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            our expert advisers at our Sheffield office.
          </p>
          <Link href="/westside-ifa/contact" className="btn-accent">
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Westside Independent Financial Services
