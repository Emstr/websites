...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Westside Independent Financial Services LLP. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Westside Independent Financial Services LLP (Company Number OC308642) is
              authorised and regulated by the Financial Conduct Authority (FCA). Our
              registered office is at 302 South Road, Walkley, Sheffield S6 3TE.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Pensions, including retirement income strategies and workplace pensions</li>
              <li>Investment planning and portfolio management</li>
              <li>Estate planning and inheritance tax mitigation</li>
              <li>Wealth protection, including life assurance and critical illness cover</li>
              <li>Mortgages, including residential, remortgage, and buy-to-let</li>
            </ul>
            <p className="text-gray-600 mb-6">
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Westside Independent Financial Services LLP
              <br />
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Westside Independent Financial Services LLP
              <br />
              302 South Road, Walkley, Sheffield S6 3TE
              <br />
              Phone: 0114 233 6000
            </address>
          </div>
