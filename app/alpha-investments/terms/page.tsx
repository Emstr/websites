...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Alpha Investments & Financial Planning Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Alpha Investments & Financial Planning Ltd is authorised and regulated
              by the Financial Conduct Authority (FCA). Our registered office is at
              79 College Road, Harrow HA1 1BD. We also maintain an office at 17
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Wealth management for high-net-worth individuals</li>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Alpha Investments & Financial Planning Ltd
              <br />
              79 College Road
              <br />
              Harrow HA1 1BD
