        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Premium wealth management and financial planning services from our
              offices in Mayfair and Harrow. Building wealth, securing futures.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <p className="text-accent font-semibold mb-1">Harrow Office</p>
              ...
              <div>
                <p className="text-accent font-semibold mb-1">Mayfair Office</p>
                <address className="not-italic text-gray-300 text-sm">
                  17 Hanover Square
                  <br />
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="bg-primary/50 rounded-sm p-4 text-sm text-gray-300">
            <p className="mb-2">
              <strong className="text-white">Important Information:</strong> Alpha
              Investments & Financial Planning Ltd is authorised and regulated by the
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>
              &copy; {currentYear} Alpha Investments & Financial Planning Ltd. All
              rights reserved.
            </p>
