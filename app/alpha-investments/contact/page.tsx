...
export const metadata: Metadata = {
  ...
  description:
    "Contact Alpha Investments & Financial Planning for expert financial advice. Visit our offices in Harrow or Mayfair, London. Call 020 3397 7730 for a free consultation.",
  openGraph: {
    title: "Contact Us | Alpha Investments & Financial Planning",
    description:
      "Book a free consultation with our expert financial advisers at our Harrow or Mayfair offices. Call 020 3397 7730.",
  },
};
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              of our prestigious London locations or reach out to discuss your
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="harrow">Harrow - 79 College Road</option>
                    <option value="mayfair">Mayfair - 17 Hanover Square</option>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Harrow</h3>
                  </div>
                </div>
                <address className="not-italic text-gray-700 mb-4">
                  <strong>Alpha Investments & Financial Planning Ltd</strong>
                  <br />
                  79 College Road
                  <br />
                  Harrow
                ...
                <p className="text-sm text-gray-500">
                  Conveniently located near Harrow-on-the-Hill station. Limited parking
                  available nearby.
                </p>
              </div>
              ...
              <div className="location-card mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-primary">Mayfair, London</h3>
                  </div>
                </div>
                <address className="not-italic text-gray-700 mb-4">
                  <strong>Alpha Investments & Financial Planning Ltd</strong>
                ...
                <p className="text-sm text-gray-500">
                  Located in prestigious Hanover Square. Nearest stations: Oxford Circus
                  and Bond Street.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">020 3397 7730</p>
                      <p className="text-sm text-gray-500">
                  ...
                  <a
                    href="mailto:info@alpha4u.co.uk"
                    className="flex items-center gap-3 text-gray-700 hover:text-accent transition-colors"
                  >
                    <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center">
                      <svg
                    ...
                    <div>
                      <p className="font-semibold">info@alpha4u.co.uk</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
      ...
      <section className="bg-gray-100">
        <div className="container-width py-8">
          <h2 className="text-2xl font-bold text-primary mb-6 text-center">
            Find Our Harrow Office
          </h2>
          <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2479.8!2d-0.3371!3d51.5800!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTHCsDM0JzQ4LjAiTiAwwrAyMCcxMy42Ilc!5e0!3m2!1sen!2suk!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Alpha Investments Harrow Office Location"
            ></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Alpha Investments & Financial Planning
