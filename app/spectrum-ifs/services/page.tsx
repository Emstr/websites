...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive independent financial services including pensions, investments, mortgages, protection, retirement planning, and wealth management in South Liverpool and Merseyside.",
  openGraph: {
    title: "Financial Services | Spectrum Independent Financial Services",
    description:
      "Expert independent financial advice from FCA regulated advisers. Pensions, investments, mortgages, and protection in South Liverpool.",
  },
};
...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      id: "mortgages",
      title: "Mortgages",
      subtitle: "Find the Right Mortgage for You",
      description:
        "Whether you are a first-time buyer, moving home, remortgaging, or looking at buy-to-let, we search the whole of the market to find the mortgage that best suits your circumstances and budget.",
      features: [
    ...
    },
    {
      ...
      description:
        "Retirement planning goes beyond pensions. We take a holistic view of your finances to create a comprehensive plan that ensures you can enjoy the lifestyle you want throughout your retirement years.",
      features: [
        "Retirement income forecasting and cash flow modelling",
    ...
    },
    {
      ...
      description:
        "Our wealth management service brings together all aspects of your financial life into one cohesive strategy. Ideal for individuals and families seeking comprehensive, ongoing financial oversight and planning.",
      features: [
        ...
        <div className="container-width">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              From pensions and investments to mortgages and protection, we provide
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01514482777" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 0151 448 2777
            </a>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Spectrum Independent Financial Services Ltd
