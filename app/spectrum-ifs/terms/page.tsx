...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Spectrum Independent Financial Services Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Spectrum Independent Financial Services Ltd is authorised and regulated
              by the Financial Conduct Authority (FCA). Our office is located in
              South Liverpool, Merseyside, and we serve clients across the region
              and beyond.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Protection planning including life assurance and critical illness</li>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              Spectrum Independent Financial Services Ltd
              <br />
              South Liverpool
              <br />
              Merseyside
