        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Independent financial advisers serving South Liverpool and
              Merseyside since 2002. Whole-of-market advice you can trust.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/spectrum-ifs/services" className="footer-link">
                  Pension Planning
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/spectrum-ifs/about" className="footer-link">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/spectrum-ifs/contact" className="footer-link">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/spectrum-ifs/faq" className="footer-link">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/spectrum-ifs/privacy" className="footer-link">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/spectrum-ifs/terms" className="footer-link">
                  Terms of Business
                </Link>
              </li>
            </ul>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="bg-primary/50 rounded-sm p-4 text-sm text-gray-300">
            <p className="mb-2">
              <strong className="text-white">Important Information:</strong> Spectrum
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>
              &copy; {currentYear} Spectrum Independent Financial Services Ltd. All
              rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link href="/spectrum-ifs/privacy" className="hover:text-accent transition-colors">
                Privacy Policy
              </Link>
              <Link href="/spectrum-ifs/terms" className="hover:text-accent transition-colors">
                Terms of Business
              </Link>
            </div>
          </div>
