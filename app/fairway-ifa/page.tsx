        ...
        <div className="container-width relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
              ...
              planning in East Molesey and Surrey.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link
                href="/fairway-ifa/contact"
                className="btn-accent text-lg"
              >
                Schedule Consultation
              </Link>
              <Link
                href="/fairway-ifa/services"
        ...
        <div className="container-width">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-4">
              ...
              <p className="text-xs text-gray-500 mt-1">Ref: 737373</p>
            </div>
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center p-4">
              ...
              <p className="font-bold text-primary text-sm">East Molesey Based</p>
              <p className="text-xs text-gray-500 mt-1">Serving Surrey</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                For over 30 years, Fairway Independent Financial Advisers has been providing
                independent financial advice to families and businesses in East Molesey
                and across Surrey. As a family-run firm, we understand that trust is
            ...
            <div className="relative h-80 rounded-sm overflow-hidden shadow-xl">
              <Image
                ...
                alt="Fairway Independent Financial Advisers - Trusted since 1994"
                fill
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-premium p-8">
              ...
              <Link href="/fairway-ifa/services" className="text-accent font-semibold hover:text-accent-700 inline-flex items-center gap-2">
                Learn More
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
          ...
          <div className="text-center mt-12">
            <Link href="/fairway-ifa/services" className="btn-primary">
              View All Services
            </Link>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Founded in 1994, Fairway Independent Financial Advisers has been providing
                whole-of-market independent financial advice to clients across
                East Molesey and Surrey for over three decades. As a family-run
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      (Ref: 737373), providing you with complete peace of mind and FSCS protection.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Over 30 years serving the East Molesey community as a family business,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="testimonial-card">
              <p className="text-gray-600 mb-6 italic">
                &quot;Fairway IFA have managed our pensions and investments
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Retired Teacher, East Molesey</p>
                </div>
              </div>
            </div>
            ...
            <div className="testimonial-card">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">NHS Professional, Surrey</p>
                </div>
              </div>
            </div>
            ...
            <div className="testimonial-card">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Business Owner, Surrey</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary mt-4 mb-4">
              Visit Us in East Molesey
            </h2>
            <div className="gold-line-center mb-6"></div>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our East Molesey office provides a welcoming environment for
            ...
            <div className="location-card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-primary">East Molesey, Surrey</h3>
                </div>
              </div>
              <address className="not-italic text-gray-700 mb-4">
                <strong>Fairway Independent Financial Advisers</strong>
                <br />
                East Molesey, Surrey
              </address>
              <div className="space-y-3 mb-6">
                <a
                  href="tel:02089414175"
                ...
                >
                  ...
                  <span className="font-semibold">020 8941 4175</span>
                </a>
                <a
                  href="mailto:Info@fairway-ifa.com"
                  className="flex items-center gap-2 text-gray-700 hover:text-accent transition-colors"
                >
                  <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span className="font-semibold">Info@fairway-ifa.com</span>
                </a>
              </div>
              <Link
                href="/fairway-ifa/contact"
        ...
        <div className="container-width">
          <div className="bg-white rounded-sm shadow-2xl p-8 lg:p-16 text-center border-t-4 border-accent">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Book a complimentary initial consultation at our East Molesey office or
        ...
        <div className="container-width">
          <div className="fca-notice">
            <div className="flex items-start gap-4">
              ...
              />
              <p>
                <strong>Important Notice:</strong> Fairway Independent Financial Advisers is
                authorised and regulated by the Financial Conduct Authority (FCA
                Reference: 737373). The value of investments can go down as well as
