...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Fairway Independent Financial Advisers Ltd. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Fairway Independent Financial Advisers Ltd
            ...
            <p className="text-gray-600 mb-6">
              Fairway Independent Financial Advisers Ltd is the
