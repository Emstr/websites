...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive whole-of-market financial advice including pensions, investments, mortgages, protection and estate planning from Fairway Independent Financial Advisers in East Molesey.",
  openGraph: {
    title: "Financial Services | Fairway Independent Financial Advisers",
    description:
      "Whole-of-market independent financial advice from FCA regulated advisers. Pensions, investments, mortgages, protection and estate planning in East Molesey.",
  },
};
  ...
  const services = [
    {
      ...
      description:
        "Whether you're just starting to save for retirement or approaching pension age, our experienced consultants can help you make the most of your pension savings. We provide clear, jargon-free advice on all aspects of pension planning, with access to the whole of the market.",
      features: [
    ...
    },
    {
      ...
      description:
        "Our investment advice is designed to help you build and grow your wealth in line with your financial goals and risk tolerance. As whole-of-market advisers, we have access to the widest range of investment options to construct a portfolio that works for you.",
      features: [
    ...
    },
    {
      ...
      description:
        "Protection planning ensures your loved ones are financially secure, whatever life brings. We help you understand your protection needs and find the right cover at the right price, searching the whole market for the best solutions.",
      features: [
    ...
    },
    {
      ...
      subtitle: "Plan for Future Generations",
      description:
        "Effective estate planning can make a significant difference to how your wealth is passed on to future generations. Our consultants work with you to develop strategies that protect your assets and minimise inheritance tax liability.",
      features: [
        "Inheritance Tax mitigation strategies",
        "Trust planning and administration",
        "Will planning coordination with solicitors",
        "Gifting strategies and allowances",
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              in East Molesey and Surrey since 1994.
            </p>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  ...
                  <Link href="/fairway-ifa/contact" className="btn-accent">
                    Discuss Your Needs
                  </Link>
                </div>
                <div
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:02089414175" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 020 8941 4175
            </a>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Fairway Independent Financial Advisers Ltd trading as
              Fairway Independent Financial Advisers is authorised and regulated by the Financial
              Conduct Authority. The value of investments can go down as well as up, and
              you may get back less than you invested. Past performance is not a reliable
              indicator of future results. Tax treatment depends on individual
              circumstances and may change in the future. Your home may be repossessed if
