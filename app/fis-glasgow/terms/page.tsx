...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for Financial Independent Solutions Ltd. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Financial Independent Solutions Ltd (Company Number: SC218279,
              incorporated 2001) is authorised and regulated by the Financial
              Conduct Authority (FCA). Our registered office is at Castle
              Chambers, 67 Main Street, Bothwell, Glasgow G71 8ER.
            </p>
            <p className="text-gray-600 mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              ...
              <li>Investment advice, including ISAs and tax-efficient investing</li>
              <li>Business financial advice, including auto-enrolment</li>
              <li>Protection planning (life assurance, critical illness, income protection)</li>
              <li>Estate planning and inheritance tax considerations</li>
            </ul>
            <p className="text-gray-600 mb-6">
              As an independent financial adviser, Mark McLair is not restricted in
              the range of products he can recommend. He will assess your needs and
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                <strong>Initial meeting:</strong> Mark gathers information about your
                financial circumstances, objectives, and attitude to risk
              </li>
              <li>
                <strong>Research and analysis:</strong> He analyses your situation
                and researches suitable options from across the entire market
              </li>
              <li>
                <strong>Recommendations:</strong> He provides a written suitability
                report explaining his recommendations and why they are suitable for
                you
              </li>
              <li>
                <strong>Implementation:</strong> With your authority, he implements
                the agreed recommendations
              </li>
              <li>
                <strong>Ongoing service:</strong> He provides regular reviews and
            ...
            <p className="text-gray-600 mb-6">
              ...
              reviews, portfolio monitoring, and access to Mark throughout the year.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              ...
              &pound;85,000 per person. Further information is available from the FSCS at
