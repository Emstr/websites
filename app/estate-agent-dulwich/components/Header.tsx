...
export default function Header() {
  ...
  const navigation = [
    { name: "Home", href: "/estate-agent-dulwich" },
    { name: "Services", href: "/estate-agent-dulwich/services" },
    { name: "About", href: "/estate-agent-dulwich/about" },
    { name: "FAQ", href: "/estate-agent-dulwich/faq" },
    { name: "Contact", href: "/estate-agent-dulwich/contact" },
  ];
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container-width">
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
            <div className="flex items-center gap-6">
              ...
              <a
                href="mailto:info@dulwichproperty.co.uk"
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <span className="hidden sm:block">Dulwich, SE21</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="container-width py-4">
        <div className="flex justify-between items-center">
          <Link href="/estate-agent-dulwich" className="flex items-center gap-3">
