...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Business for MFS Independent Financial Advisers. Understand our client agreement, services, and regulatory information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              MFS Independent Financial Advisers is authorised and regulated
              by the Financial Conduct Authority (FCA). Our registered office is at
              235 The Broadway, Wimbledon, London SW19 1SD. We hold the Chartered
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li>Investment planning (income and growth strategies)</li>
              <li>Pension planning, including SIPPs, trustee wind-ups, and group pensions</li>
              <li>Tax-efficient investing and tax planning</li>
              <li>Life assurance and critical illness protection</li>
              <li>Inheritance tax mitigation</li>
              <li>Corporate services (employee benefits, group pensions, key man protection)</li>
              <li>Mortgage and commercial loans</li>
              <li>Lifetime financial planning with cash flow modelling</li>
            </ul>
            <p className="text-gray-600 mb-6">
            ...
            <ol className="list-decimal pl-6 text-gray-600 mb-6 space-y-2">
              <li>
                <strong>Complimentary initial meeting:</strong> We gather information
                about your financial circumstances, objectives, and attitude to risk
              </li>
              <li>
                <strong>Research and analysis:</strong> Our specialist advisers
                analyse your situation and research suitable options from across the
                market
              </li>
              <li>
              ...
              <li>
                ...
                ongoing support as agreed, with your dedicated adviser always available
              </li>
            </ol>
            ...
            <p className="text-gray-600 mb-6">
              ...
              reviews, portfolio monitoring, and access to your dedicated adviser
              throughout the year.
            </p>
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              Complaints Manager
              <br />
              MFS Independent Financial Advisers
              <br />
              235 The Broadway
              <br />
            ...
            <address className="not-italic text-gray-600 mb-6 bg-gray-50 p-4 rounded-sm">
              MFS Independent Financial Advisers
              <br />
              235 The Broadway, Wimbledon, London SW19 1SD
              <br />
              Phone: 020 8543 6244
              <br />
              Email: info@mfs-group.co.uk
