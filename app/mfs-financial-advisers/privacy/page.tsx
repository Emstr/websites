...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for MFS Independent Financial Advisers. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              MFS Independent Financial Advisers (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is
            ...
            <p className="text-gray-600 mb-6">
              MFS Independent Financial Advisers is the data controller for
