...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Beckworth Financial Services Ltd. Learn how we collect, use, and protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Beckworth Financial Services Ltd
            ...
            <p className="text-gray-600 mb-6">
              Beckworth Financial Services Ltd is the
