...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive whole-of-market financial advice including pensions, investments, mortgages, protection and estate planning from Beckworth Financial Services in Exeter.",
  openGraph: {
    title: "Financial Services | Beckworth Financial Services",
    description:
      ...
      <section className="section-padding bg-primary">
        <div className="container-width text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:01392678555" className="btn-outline border-white text-white hover:bg-white hover:text-primary">
              Call 01392 678 555
            </a>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Beckworth Financial Services Ltd trading as
              Beckworth Financial Services is authorised and regulated by the Financial
