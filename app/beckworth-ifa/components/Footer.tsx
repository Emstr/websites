        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              Exeter and Devon since 2001. Over 25 years of trusted
              guidance for your financial future, with specialist expertise
              in care home fees planning.
            </p>
            <div className="flex items-center gap-2 text-sm text-gray-400">
              ...
              <span>FCA Regulated (Ref: 430007)</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/beckworth-ifa/services" className="footer-link">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/beckworth-ifa/about" className="footer-link">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/beckworth-ifa/contact" className="footer-link">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/beckworth-ifa/faq" className="footer-link">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/beckworth-ifa/privacy" className="footer-link">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/beckworth-ifa/terms" className="footer-link">
                  Terms of Business
                </Link>
              </li>
            </ul>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="bg-primary/50 rounded-sm p-4 text-sm text-gray-300">
            <p className="mb-2">
              <strong className="text-white">Important Information:</strong> Beckworth
              Financial Services Limited is authorised and regulated by the Financial Conduct
              Authority (FCA Reference: 430007). Company Registration: 4145306.
            </p>
            <p>
      ...
      <div className="border-t border-gray-700">
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>
              &copy; {currentYear} Beckworth Financial Services Limited. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link href="/beckworth-ifa/privacy" className="hover:text-accent transition-colors">
                Privacy Policy
              </Link>
              <Link href="/beckworth-ifa/terms" className="hover:text-accent transition-colors">
                Terms of Business
              </Link>
            </div>
          </div>
