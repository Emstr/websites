...
export const metadata: Metadata = {
  ...
  description:
    "Contact Beckworth Financial Services for independent financial advice. Visit our Exeter office or call 01392 678 555 for a free consultation.",
  openGraph: {
    title: "Contact Us | Beckworth Financial Services",
    description:
      "Book a free consultation with our experienced financial advisers. Call 01392 678 555 or visit our Exeter office.",
  },
};
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="consent" className="text-sm text-gray-600">
                    I consent to Beckworth Financial Services contacting me
                    regarding my enquiry. I understand my data will be processed in
                    accordance with the{" "}
                    <a href="/beckworth-ifa/privacy" className="text-accent hover:underline">
                      Privacy Policy
                    </a>
                    . *
                  </label>
              ...
              <div className="bg-gray-50 p-6 rounded-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">01392 678 555</p>
                      <p className="text-sm text-gray-500">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">enquiries@ifahelpline.com</p>
                      <p className="text-sm text-gray-500">
                        Email us anytime
                      </p>
                    </div>
        ...
        <div className="container-width py-8">
          ...
          <div className="aspect-video bg-gray-200 rounded-sm overflow-hidden">
            <iframe
              ...
              title="Beckworth Financial Services - Exeter, Devon"
            ></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container-width">
          <div className="fca-notice">
            <p>
              <strong>Important Notice:</strong> Beckworth Financial Services is
              authorised and regulated by the Financial Conduct Authority (FCA
              Reference: 430007). Initial consultations are provided free of charge
